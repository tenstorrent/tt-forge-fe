...
def get_failure_details(failure_reason_lines):
    ...
    for line in failure_reason_lines:
        ...
        if line.startswith("E  ") or "[XPASS(strict)]" in line:
...
if __name__ == "__main__":
    runner1_log_path = "path to pytest.log"  # Runner 1 Log path
    runner2_log_path = "path to pytest 2.log"  # Runner 2 Log path
    runner3_log_path = "path to pytest 3.log"  # Runner 3 Log path
    runner4_log_path = "path to pytest 4.log"  # Runner 4 Log path
    log_path_list = [runner1_log_path, runner2_log_path, runner3_log_path, runner4_log_path]
    ...
    for log_file in log_path_list:
        ...
        for line in lines:
            ...
            if ("XFAIL" in line) and (test_log_status == "started"):
                ...
                test_log_status = add_testcase(test_case_name[0], "XFAIL")
