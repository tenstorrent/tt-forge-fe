                ...
                if "==== FAILURES ====" in line:
                    ...
                    if len(test_case_func) == 0:
                        ...
                        if line.startswith("E  "):
                            ...
                            if all(error_line.startswith("E  ") for error_line in lines[current_line: current_line + maximum_error_lines]):
                            ...
                            error_message = error_message_updater.update(error_message, lines[current_line+10])
...
def main():
    ...
    failed_models_ops_tests = extract_failed_models_ops_tests_with_failure_reason(
        log_files=log_files, 
        models_ops_test_dir_path=models_ops_test_dir_path
    )
