...
- **result** (`Tensor`): Output tensor with the same shape as the input. Each element is the result of applying the tanh function to the corresponding input element.
