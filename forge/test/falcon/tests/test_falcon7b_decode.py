...
def test_decode_padded(num_layers, sequence_length):
    ...
    # using padded model
    with open("forge/test/falcon/models/falcon7b/config_padded.json", "r") as f:
...
@pytest.mark.parametrize("num_layers,sequence_length,prompts_file", [(32,512,'forge/test/falcon/data/two_cities.json')])
