...
class ForgeGPT2MLP(ForgeModule):
...
class ForgeGPT2MHA(ForgeModule):
    def __init__(self, name, parameters, config, prefix=None):
        super().__init__(name)
        self.parameters = parameters
        self.config = config
...
class ForgeGPT2Block(ForgeModule):
    def __init__(self, name, parameters, config):
        super().__init__(name)
        self.parameters = parameters
        self.config = config

        self.attn = ForgeGPT2MHA("attn", parameters, config, prefix="attn")
        self.mlp = ForgeGPT2MLP("mlp", parameters, config, prefix="mlp")
...
class ForgeGPT2LayerNorm(ForgeModule):
    def __init__(self, name, parameters, config):
        super().__init__(name)
        self.parameters = parameters
        self.config = config
