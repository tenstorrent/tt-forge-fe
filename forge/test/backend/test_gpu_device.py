...
def test_training_pipeline_read_back():
    ...
    tt0 = forge.TTDevice("tt0", module=ForgeTestModule("stage0"), devtype=BackendType.Golden)
    cpu1 = forge.GPUDevice("gpu1", module=forge.PyTorchModule("stage1", PyTorchTestModuleOneOut().cuda()))
    cpu1.place_loss_module(forge.PyTorchModule("l1loss", torch.nn.L1Loss().cuda()))
