...
ci_files = {
    ...
    "eval_script": "forge/test/galaxy/bert/squad_preprocessing/evaluate-v1.1.py",
...
def intermediate_dram_queues_galaxy():
    ...
    forge.config._get_global_compiler_config().insert_queues = []

    for i in range(len(buffer_list)-1):
        forge.config._get_global_compiler_config().insert_queues.append((buffer_list[i], buffer_list[i+1], 0))

    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0_input_1_matmul_2", "add_37", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_8_matmul_55", "add_90", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_17_matmul_108", "add_143", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_26_matmul_161", "add_196", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_35_matmul_214", "add_249", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_44_matmul_267", "add_302", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_53_matmul_320", "add_355", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_62_matmul_373", "add_408", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_71_matmul_426", "add_461", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_80_matmul_479", "add_514", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_89_matmul_532", "add_567", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_98_matmul_585", "add_620", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_107_matmul_638", "add_673", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_116_matmul_691", "add_726", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_125_matmul_744", "add_779", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_134_matmul_797", "add_832", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_143_matmul_850", "add_885", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_152_matmul_903", "add_938", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_161_matmul_956", "add_991", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_170_matmul_1009", "add_1044", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_179_matmul_1062", "add_1097", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_188_matmul_1115", "add_1150", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_197_matmul_1168", "add_1203", 1))
    forge.config._get_global_compiler_config().insert_queues.append(("buffer_0__fused_op_206_matmul_1221", "add_1256", 1))

def df_overrides():
    compiler_cfg = _get_global_compiler_config()

    compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            op_type="matmul",
            name_regex_match="matmul_2",
            math_fidelity=forge.MathFidelity.LoFi,
            output_df=forge._C.DataFormat.Bfp8_b,
            accumulate_df=forge._C.DataFormat.Float16_b,
            intermediate_df=forge._C.DataFormat.Bfp8_b,
            input_df= {0: [forge._C.DataFormat.Bfp8_b, True], 1: [forge._C.DataFormat.Bfp8_b, True], 2: [forge._C.DataFormat.Bfp8_b, True]}
        ))
    compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
        op_type="matmul",
    ...
    compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            ...
            math_fidelity=forge.MathFidelity.HiFi3,
            output_df=forge._C.DataFormat.Float16_b,
            accumulate_df=forge._C.DataFormat.Float16_b,
            intermediate_df=forge._C.DataFormat.Float16_b,
            input_df= {0: [forge._C.DataFormat.Bfp8_b, True], 1: [forge._C.DataFormat.Bfp8_b, True]}
        ))
    ...
    for i in range(24):
        ...
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            ...
            accumulate_df=forge._C.DataFormat.Float16_b,
            intermediate_df=forge._C.DataFormat.Bfp8_b,
            input_df= {0: [forge._C.DataFormat.Float16_b, True], 1: [forge._C.DataFormat.Bfp8_b, True], 2: [forge._C.DataFormat.Bfp8_b, True]}
        ))
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            op_type="matmul",
        ...
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            ...
            accumulate_df=forge._C.DataFormat.Float16_b,
            intermediate_df=forge._C.DataFormat.Float16_b,
            input_df= {0: [forge._C.DataFormat.Bfp8_b, True], 1: [forge._C.DataFormat.Float16_b, True]}
        ))
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            op_type="add",
        ...
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            ...
            accumulate_df=forge._C.DataFormat.Float16_b,
            intermediate_df=forge._C.DataFormat.Bfp8_b,
            input_df= {0: [forge._C.DataFormat.Bfp8_b, True], 1: [forge._C.DataFormat.Float16_b, True], 2: [forge._C.DataFormat.Float16_b, True]}
        ))
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            op_type="fused_op",
        ...
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            ...
            accumulate_df=forge._C.DataFormat.Float16_b,
            intermediate_df=forge._C.DataFormat.Float16_b,
            input_df= {0: [forge._C.DataFormat.Float16_b, True], 1: [forge._C.DataFormat.Float16_b, True], 2: [forge._C.DataFormat.Float16_b, True]}
        ))
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            op_type="fused_op",
        ...
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            ...
            accumulate_df=forge._C.DataFormat.Float16_b,
            intermediate_df=forge._C.DataFormat.Float16_b,
            input_df= {0: [forge._C.DataFormat.Bfp8_b, True], 1: [forge._C.DataFormat.Float16_b, True], 2: [forge._C.DataFormat.Float16_b, True], 3: [forge._C.DataFormat.Float16_b, True]}
        ))
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            op_type="fused_op",
        ...
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            ...
            accumulate_df=forge._C.DataFormat.Float16_b,
            intermediate_df=forge._C.DataFormat.Float16_b,
            input_df= {0: [forge._C.DataFormat.Float16_b, True], 1: [forge._C.DataFormat.Float16_b, True]}
        ))
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
            op_type="matmul",
    ...
    compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
                ...
                accumulate_df=forge._C.DataFormat.Float16_b,
                intermediate_df=forge._C.DataFormat.Float16_b,
                input_df= {0: [forge._C.DataFormat.Bfp8_b, True]}
            ))
    ...
    for i in range(24):
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
                ...
                output_df=forge._C.DataFormat.Bfp8_b,
                accumulate_df=forge._C.DataFormat.Bfp8_b,
                intermediate_df=forge._C.DataFormat.Bfp8_b,
                input_df= {0: [forge._C.DataFormat.Bfp8_b, True]}
            ))
    ...
    for buffer in encoder_output_list:
        compiler_cfg.amp_properties.append(forge._C.AMPNodeProperties(
                ...
                accumulate_df=forge._C.DataFormat.Float16_b,
                intermediate_df=forge._C.DataFormat.Float16_b,
                input_df= {0: [forge._C.DataFormat.Float16_b, True]}
            ))
...
def apply_overrides(parameters):
    forge.set_configuration_options(
            ...
            accumulate_df=forge._C.DataFormat.Float16_b,
            #performance_trace=forge.PerfTraceLevel.LIGHT
            )
...
def main(parameters):
    ...
    os.environ['FORGE_FUSE_OPS'] = '1'
    os.environ['FORGE_NLP_MANUAL_TARGET'] = '185000'
    os.environ['FORGE_DISABLE_DRAM0'] = '1'
    os.environ['FORGE_FORCE_INTERMED_TO_OUTPUT_DF'] = '1'
    os.environ['FORGE_EXTRA_L1_MARGIN'] = '131072'
    os.environ['FORGE_DISABLE_FORK_JOIN_NOPS'] = '1'
    ...
    os.environ['FORGE_MIN_MATMUL_BUFFER_ALLOW_IN1'] = '1'
    os.environ['FORGE_FUSE_STOP_ON_RECIPROCAL'] = '1'
    os.environ['FORGE_FUSE_MATMUL_GELU'] = '1'
    os.environ['FORGE_DISABLE_STABLE_SOFTMAX'] = '1'
    os.environ['FORGE_DISABLE_DYNAMIC_DRAM'] = '1'
    ...
    if parameters["num_chips"] >= 32:
        os.environ['FORGE_MICROBATCH_LOOPING'] = '1'

    if parameters["num_chips"] > 1 and parameters["num_chips"] % 2 != 0:
        os.environ['FORGE_NEBULA_GALAXY_PLACER'] = '1'
    ...
    tt0 = forge.TTDevice('tt0',
                          module=forge.PyTorchModule("bert_squad", model),
                          chip_ids=galaxy_chips,
                          fp32_fallback=forge.DataFormat.Float16,
                          devtype=forge.BackendType.Silicon,
                          arch=forge.BackendDevice.Wormhole_B0)

    compiler_cfg = _get_global_compiler_config()

    forge.config.set_configuration_options(default_df_override=forge.DataFormat.Float16_b)

    # Apply overrides
    apply_overrides(parameters)

    output_queue = forge.initialize_pipeline(training=False,
    ...
    while True:
                ...
                for i in range(num_batches):
                    while True:
                        try:
                            ...
                            latency_str = f"{mean_latency_ms:3.0f} ms " if parameters["forge_latency"] else " "
        ...
        forge.run_forward(input_count=(num_batches * (parameters["loops"] + 1)))
...
def test_bert_squad(data_type, seq_max_length, batch_size, n_best_size, max_answer_length, loops, num_chips, encoders):
    ...
    parameters["forge_latency"] = False
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--forge_latency",
        help="Show latency including time through forge queues (higher than hw latency).",
        action="store_true"
        )
    parser.add_argument(
        "--num_chips",
