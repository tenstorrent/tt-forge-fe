...
def test_resnet_hf_config(training, batch_size, data_format, input_size, channel_size, loop_count, variant, task):
    ...
    mlir_config.set_enable_consteval(True)
...
def resnet_hf_config_benchmark(config: dict):
    """
