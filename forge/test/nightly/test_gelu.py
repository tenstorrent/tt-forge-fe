...
forge_modules_and_shapes_dtypes_list = [
    (
        ...
        {"model_name": ["pt_albert_xlarge_v1_token_cls", "pt_albert_xlarge_v1_masked_lm"], "pcc": 0.99},
    ),
    (
        Gelu1,
        [((1, 128, 8192), torch.float32)],
        {"model_name": ["pt_albert_xlarge_v2_masked_lm", "pt_albert_xlarge_v2_token_cls"], "pcc": 0.99},
    ),
    (
        Gelu0,
        [((1, 128, 3072), torch.float32)],
        {"model_name": ["pt_albert_base_v1_masked_lm", "pt_albert_base_v1_token_cls"], "pcc": 0.99},
    ),
    (
        Gelu1,
        [((1, 128, 3072), torch.float32)],
        {"model_name": ["pt_albert_base_v2_masked_lm", "pt_albert_base_v2_token_cls"], "pcc": 0.99},
    ),
    (
        Gelu0,
    ...
    (
        ...
        {"model_name": ["pt_albert_xxlarge_v2_masked_lm", "pt_albert_xxlarge_v2_token_cls"], "pcc": 0.99},
    ),
    (
        Gelu0,
        [((1, 128, 16384), torch.float32)],
        {"model_name": ["pt_albert_xxlarge_v1_token_cls", "pt_albert_xxlarge_v1_masked_lm"], "pcc": 0.99},
    ),
    (
        Gelu1,
        [((1, 128, 4096), torch.float32)],
        {"model_name": ["pt_albert_large_v2_masked_lm", "pt_albert_large_v2_token_cls"], "pcc": 0.99},
    ),
    (
        Gelu0,
        [((1, 128, 4096), torch.float32)],
        {"model_name": ["pt_albert_large_v1_token_cls", "pt_albert_large_v1_masked_lm"], "pcc": 0.99},
    ),
]
