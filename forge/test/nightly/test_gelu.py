...
forge_modules_and_shapes_dtypes_list = [
    (Gelu0, [((1, 128, 3072), torch.float32)], {"model_name": ["albert_pt_albert_base_v1_masked_lm"]}),
    (Gelu1, [((1, 128, 3072), torch.float32)], {"model_name": ["albert_pt_albert_base_v2_masked_lm"]}),
    (Gelu0, [((1, 128, 128), torch.float32)], {"model_name": ["albert_pt_albert_base_v1_masked_lm"]}),
    (Gelu1, [((1, 128, 128), torch.float32)], {"model_name": ["albert_pt_albert_base_v2_masked_lm"]}),
]
