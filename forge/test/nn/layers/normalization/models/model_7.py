...
class LayernormTest(ForgeModule):
    ...
    def forward(self, x1, x2, x3):
        ...
        # Layer 3
        mul1 = forge.op.Multiply("mul1", ln1, self.train_param1)
        mul2 = forge.op.Multiply("mul2", ln2, self.train_param2)
        mul3 = forge.op.Multiply("mul3", ln3, self.train_param3)
        ...
        # Layer 5
        add1 = forge.op.Add("add1", ln4, ln2)
        add2 = forge.op.Add("add2", ln5, ln3)
        add3 = forge.op.Add("add3", ln6, self.train_param3)
        ...
        # Layer 7
        mul4 = forge.op.Multiply("mul4", ln1, ln7)
        mul5 = forge.op.Multiply("mul5", ln2, ln8)
        add4 = forge.op.Add("add4", ln3, ln9)
        ...
        # Layer 9
        mul6 = forge.op.Multiply("mul6", ln10, ln4)
        mul7 = forge.op.Multiply("mul7", ln11, ln5)
        mul8 = forge.op.Multiply("mul8", ln12, ln6)

        # Layer 10
        mul9 = forge.op.Multiply("mul9", mul6, ln5)
        mul10 = forge.op.Multiply("mul10", ln2, mul8)
        add5 = forge.op.Add("add5", ln4, mul7)
        ...
        # Layer 12
        add6 = forge.op.Add("add6", mul6, ln13)
        mul11 = forge.op.Multiply("mul11", ln11, ln14)
        mul12 = forge.op.Multiply("mul12", ln9, ln15)
        ...
        # Layer 14
        mul13 = forge.op.Multiply("mul13", ln16, ln17)
        add7 = forge.op.Add("add7", ln17, ln18)
        ...
        # Layer 16
        add8 = forge.op.Add("add8", ln19, ln20)
