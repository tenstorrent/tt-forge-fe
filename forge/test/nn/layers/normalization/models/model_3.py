...
class LayernormTest(ForgeModule):
    ...
    def forward(self, x1, x2):
        ...
        mul2 = forge.op.Multiply("mul2", ln1, ln2)

        # Layer 4
        add1 = forge.op.Add("add1", ln3, x2)
        add2 = forge.op.Add("add2", ln3, self.train_param2)
        add3 = forge.op.Add("add3", x1, mul2)
        add4 = forge.op.Add("add4", self.train_param2, mul2)
        ...
        # Layer 6
        mul3 = forge.op.Multiply("mul3", ln4, ln5)
        mul4 = forge.op.Multiply("mul4", ln6, ln7)
        ...
        # Layer 8
        mul5 = forge.op.Multiply("mul5", ln8, ln6)
        add5 = forge.op.Add("add5", ln5, ln9)
