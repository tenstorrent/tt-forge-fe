...
class LayernormTest(ForgeModule):
    ...
    def forward(self, x1, x2):
        ...
        mul4 = forge.op.Multiply("mul4", x2, self.train_param2)
        ...
        # Layer 4
        mul5 = forge.op.Multiply("mul5", ln1, x1)
        add1 = forge.op.Add("add1", ln2, self.train_param1)
        add2 = forge.op.Add("add2", ln3, x2)
        mul6 = forge.op.Multiply("mul6", ln4, self.train_param2)
        ...
        # Layer 6
        add3 = forge.op.Add("add3", ln5, ln2)
        add4 = forge.op.Add("add4", ln6, ln3)
        add5 = forge.op.Add("add5", ln7, ln4)
        add6 = forge.op.Add("add6", ln3, ln8)
        ...
        # Layer 8
        mul7 = forge.op.Multiply("mul7", ln1, ln9)
        mul8 = forge.op.Multiply("mul8", ln2, ln10)
        mul9 = forge.op.Multiply("mul9", ln7, ln11)
        mul10 = forge.op.Multiply("mul10", ln8, ln12)
        ...
        # Layer 10
        mul11 = forge.op.Multiply("mul11", ln13, ln14)
        mul12 = forge.op.Multiply("mul12", ln15, ln16)
        ...
        # Layer 12
        mul13 = forge.op.Multiply("mul13", ln14, ln15)
        add7 = forge.op.Add("add7", mul7, ln17)
        add8 = forge.op.Add("add8", add6, ln18)
        ...
        # Layer 14
        add9 = forge.op.Add("add9", mul13, ln19)
