...
class LayernormTest(ForgeModule):
    ...
    def forward(self, x1, x2):
        ...
        mul3 = forge.op.Multiply("mul3", self.train_param1, self.train_param2)
        ...
        # Layer 5
        mul5 = forge.op.Multiply("mul5", ln5, ln2)
        mul6 = forge.op.Multiply("mul6", ln6, ln4)

        # Layer 6
        add1 = forge.op.Add("add1", mul5, mul6)
        add2 = forge.op.Add("add2", ln1, ln4)
