...
class LayernormTest(ForgeModule):
    ...
    def forward(self, x1, x2):
        ...
        mul3 = forge.op.Multiply("mul3", ln_layer3[2], ln_layer3[4])
        mul4 = forge.op.Multiply("mul4", ln_layer3[5], ln_layer3[8])
        mul5 = forge.op.Multiply("mul5", ln_layer3[6], ln_layer3[9])
        add1 = forge.op.Add("add1", ln_layer3[7], ln20)
        add2 = forge.op.Add("add2", ln19, ln21)
        ...
        # Layer 6
        mul6 = forge.op.Multiply("mul6", ln_layer5[0], ln_layer5[2])
        add3 = forge.op.Add("add3", ln_layer5[1], ln_layer5[3])
        mul7 = forge.op.Multiply("mul7", ln_layer5[4], ln_layer5[7])
        add4 = forge.op.Add("add4", ln_layer5[5], ln_layer5[8])
        mul8 = forge.op.Multiply("mul8", ln_layer5[6], ln_layer5[9])
        add5 = forge.op.Add("add5", ln_layer5[10], ln_layer5[12])
        mul9 = forge.op.Multiply("mul9", ln_layer5[11], ln_layer5[13])
        ...
        # Layer 8
        add6 = forge.op.Add("add6", ln_layer7[0], ln_layer7[1])
        add7 = forge.op.Add("add7", ln_layer7[2], ln_layer7[3])
        mul10 = forge.op.Multiply("mul10", ln_layer7[4], ln_layer7[5])
        mul11 = forge.op.Multiply("mul11", ln_layer7[5], ln_layer7[6])
        ...
        # Layer 10
        mul12 = forge.op.Multiply("mul12", ln_layer9[0], ln_layer9[2])
        mul13 = forge.op.Multiply("mul13", ln_layer9[1], ln_layer9[3])
        mul14 = forge.op.Multiply("mul14", ln_layer9[4], ln_layer9[6])
        mul15 = forge.op.Multiply("mul15", ln_layer9[5], ln_layer9[7])
        mul16 = forge.op.Multiply("mul16", ln_layer7[1], ln_layer7[4])
        ...
        # Layer 12
        add8 = forge.op.Add("add8", ln_layer11[1], ln_layer11[2])
        mul17 = forge.op.Multiply("mul17", ln_layer9[4], ln_layer7[6])
        add9 = forge.op.Add("add9", ln_layer11[3], ln_layer11[4])
