...
class TestMaxPool1d:
    ...
    def test_maxpool1d_kernel_size_1(self, opset_version):
        ...
        input_data = {"input_0": np.random.randn(1, 3, 32).astype(np.float32)}
    ...
    def test_maxpool1d_stride_larger_than_kernel(self, opset_version):
        ...
        input_data = {"input_0": np.random.randn(1, 3, 16).astype(np.float32)}
    ...
    def test_maxpool1d_small_input(self, opset_version):
        ...
        input_data = {"input_0": np.random.randn(1, 1, 4).astype(np.float32)}
...
class TestMaxPool2d:
    ...
    def test_maxpool2d_kernel_size_1(self, opset_version):
        ...
        input_data = {"input_0": np.random.randn(1, 3, 32, 32).astype(np.float32)}
    ...
    def test_maxpool2d_stride_larger_than_kernel(self, opset_version):
        ...
        input_data = {"input_0": np.random.randn(1, 3, 16, 16).astype(np.float32)}
    ...
    def test_maxpool2d_small_input(self, opset_version):
        ...
        input_data = {"input_0": np.random.randn(1, 1, 4, 4).astype(np.float32)}
    ...
    def test_maxpool2d_input_equals_kernel(self, opset_version):
        ...
        input_data = {"input_0": np.random.randn(1, 3, 5, 5).astype(np.float32)}
    ...
    def test_maxpool2d_input_smaller_than_kernel_with_padding(self, opset_version):
        ...
        input_data = {"input_0": np.random.randn(1, 3, 3, 3).astype(np.float32)}
...
class TestMaxPool3d:
    ...
    def test_maxpool3d_kernel_size_1(self, opset_version):
        ...
        input_data = {"input_0": np.random.randn(1, 3, 8, 8, 8).astype(np.float32)}
    ...
    def test_maxpool3d_stride_larger_than_kernel(self, opset_version):
        ...
        input_data = {"input_0": np.random.randn(1, 3, 4, 4, 4).astype(np.float32)}
    ...
    def test_maxpool3d_small_input(self, opset_version):
        ...
        input_data = {"input_0": np.random.randn(1, 1, 4, 4, 4).astype(np.float32)}
