...
def main():
    ...
    #         output_df=forge.DataFormat.Bfp8_b,
    #         name_regex=f"fractured_{f}_matmul_86",
    #         input_df={0: [forge.DataFormat.Bfp8_b, True]},
    #         )

    # forge.config.configure_mixed_precision(
    #     output_df=forge.DataFormat.Bfp2_b,
    #     accumulate_df=forge.DataFormat.Bfp2_b,
    #     name_regex="fractured_gather_n0_matmul_86.dc.concatenate.0",
    #     intermediate_df=forge.DataFormat.Bfp2_b,
    #     input_df={0: [forge.DataFormat.Bfp2_b, True]},
    #     )
    ...
    if not args.no_kv_cache:
        ...
        for i, (k, v) in enumerate(past_key_values):
            ...
            # merge heads for forge loopback
            def merge(tensor):
