...
def test_convnext_tiny(test_kind, test_device):
    ...
    # import os
    # os.environ["FORGE_PRINT_GRAPH_VIZ_FORMAT_AT"] = "PRE_PLACER"
    # os.environ["FORGE_PRINT_GRAPH_VIZ_FORMAT_DIR"] = "forward_only"
    # os.environ["FORGE_PRINT_GRAPH_VIZ_FORMAT_DIR"] = "backward_only"
