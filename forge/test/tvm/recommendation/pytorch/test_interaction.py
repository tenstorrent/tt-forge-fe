...
# TODO: This test remains as a forge_compile test rather than verify_module test because batch_size > 1 fails for verify_module
def test_bilinear_interaction(training):
    ...
    evaluate_framework_vs_forge(model, ret, inp)
