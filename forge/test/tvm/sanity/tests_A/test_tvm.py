...
def test_tvm_all_and_cast_fallback(test_kind, test_device):
    ...
    forge_module = PyTorchModule("pt_all_and_cast_fallback", framework_module)
...
def test_tvm_broadcast_fallback(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_broadcast_fallback", framework_module)
...
def test_tvm_reshape_fallback(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_reshape_fallback", framework_module)
...
def test_tvm_cumsum_fallback(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_cumsum_fallback", framework_module)
...
def test_tvm_softmax_fallback(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_softmax_fallback", framework_module)
...
def test_tvm_scatter_add_fallback(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_scatter_add_fallback", framework_module)
...
def test_tvm_max_fallback(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_max_fallback", framework_module)
...
def test_tvm_cat_fallback(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_cat_fallback", framework_module)
...
def test_reshape_transpose_into_hslice(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_reshape_transpose_into_hslice", framework_module)
...
def test_transpose_reshape_into_hstack(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_transpose_reshape_into_hstack", framework_module)
...
def test_reshape_into_vslice(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_reshape_into_vslice", framework_module)
...
def test_cpu_fallback_when_more_performant(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_cpu_fallback_when_more_performant", framework_module)
...
def test_extended_tm_cpu_fallback_concat_variation(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_test_extended_tm_cpu_fallback_concat_variation", framework_module)
...
def test_extended_tm_cpu_fallback_matmul_variation(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_test_extended_tm_cpu_fallback_matmul_variation", framework_module)
...
def test_tvm_batch_matmul_with_1d_op1(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_batch_matmul_with_1d_op1", framework_module)
...
def test_neg_inf_const_pt(test_kind, test_device):   
    ...
    forge_module = PyTorchModule("pt_neg_inf_const_onnx", framework_module)
...
def test_maximum_bwd(test_kind, test_device):
    ...
    forge_module = PyTorchModule("pt_maximum_bwd", framework_module)
...
def test_minimum_bwd(test_kind, test_device):
    ...
    framework_module = Model()
    forge_module = PyTorchModule("pt_minimum_bwd", framework_module)
...
def test_tvm_scatter_nd(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_tvm_scatter_nd", framework_module)
...
def test_tvm_invalid_dtype(test_kind, test_device):
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_tvm_invalid_dtype", framework_module)
    ...
    framework_module = Module()
    forge_module = PyTorchModule("pt_tvm_where", framework_module)
