...
def test_tvm_linear(test_kind, test_device):
    ...
    forge_module = JaxModule("linear", framework_module)
    verify_module(
        forge_module,
        (input_shape,),
...
def test_tvm_multiple_outputs(test_kind, test_device):
    ...
    forge_module = JaxModule("jax_multiple_output", framework_module)
    verify_module(
        forge_module,
        (input_shape,),
        verify_cfg=VerifyConfig(
...
def test_tvm_scaled_dot_product_attention(test_kind, test_device):
    ...
    forge_module = JaxModule("jax_scaled_dot_product_attention", framework_module)
    verify_module(
        forge_module,
...
def test_tvm_layer_norm(test_kind, test_device):
    ...
    forge_module = JaxModule("jax_layer_norm", framework_module)
    verify_module(
        forge_module,
        (input_shape,),
        verify_cfg=VerifyConfig(
...
def test_tvm_conv2d(test_kind, test_device):
    ...
    forge_module = JaxModule("jax_conv2d_test", framework_module)
    verify_module(
        forge_module,
        (input_shape,),
        verify_cfg=VerifyConfig(
...
def test_tvm_xla_gather(test_kind, test_device, slice_module):
    ...
    forge_module = JaxModule("jax_xla_gather", framework_module)
    verify_module(
        forge_module,
        (input_shape,),
        verify_cfg=VerifyConfig(
...
def test_tvm_dense(test_kind, test_device):
    ...
    forge_module = JaxModule("JAX_dense", framework_module)
    verify_module(
        forge_module,
        (input_shape,),
        verify_cfg=VerifyConfig(
...
def test_tvm_conv2d_transpose(test_kind, test_device):
    ...
    forge_module = JaxModule("jax_conv2d_transpose_test", framework_module)
    verify_module(
        forge_module,
        (input_shape,),
        verify_cfg=VerifyConfig(
...
def test_tvm_conv2d_dilated(test_kind, test_device):
    ...
    forge_module = JaxModule("jax_conv2d_dilated_test", framework_module)
    verify_module(
        forge_module,
        (input_shape1,),
        verify_cfg=VerifyConfig(
