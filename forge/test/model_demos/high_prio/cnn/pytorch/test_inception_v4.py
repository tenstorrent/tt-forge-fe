...
def test_inception_v4_osmr_pytorch():
    model, inputs = generate_model_inceptionV4_imgcls_osmr_pytorch(
        "inceptionv4"
    )
...
def test_inception_v4_timm_pytorch():
    model, inputs = generate_model_inceptionV4_imgcls_timm_pytorch(
        'inception_v4'
    )
