...
@pytest.mark.parametrize(
    ...
    [
        0.5, 2.6, 3.0, 6.5, (9, 5), (3, 11), (7, 9), (3, 5), (11,), (15,), (19,), (22,),
    ],
)
@pytest.mark.parametrize(
    "input_shape",
...
def test_resize2d_nearest_interpolation(input_shape, scale_factor_or_size):
    ...
    if isinstance(scale_factor_or_size, tuple) and ((len(scale_factor_or_size) == 2 and len(input_shape) != 4) or (len(scale_factor_or_size) == 1 and len(input_shape) != 3)):
