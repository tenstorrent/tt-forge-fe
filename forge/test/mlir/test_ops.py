...
@pytest.mark.xfail(reason="Unsupported Ops at: RUN_MLIR_COMPILER stage: adv_index")
@pytest.mark.parametrize("img", [(1, 2, 4, 4), (1, 32, 50, 50), (1, 3, 8, 8), (1, 3, 16, 16)])
@pytest.mark.parametrize("grid", [(1, 6, 2, 2), (1, 2500, 4, 2), (1, 3, 3, 2), (1, 8, 8, 2)])
