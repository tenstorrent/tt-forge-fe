...
def test_adagrad(shape, lr_decay, weight_decay):
    torch.manual_seed(0)
    num_epochs = 10
    # Large learning rate to propagate possible errors faster
    learning_rate = 1
    ...
    tt_optimizer = forge.optimizers.Adagrad(learning_rate=learning_rate, lr_decay=lr_decay, weight_decay=weight_decay)
    golden_optimizer = torch.optim.Adagrad(golden_model.parameters(), lr=learning_rate, lr_decay=lr_decay, weight_decay=weight_decay)
