...
def pytest_addoption(parser):
    # model
    parser.addoption(
        "--resh_model", action="store", default="model_1", help="The name of the file in which the model is located."
    )
    # training
    parser.addoption("--resh_train", action="store", default=True, help="Training or Inference.")
    # recompute
    parser.addoption("--resh_recompute", action="store", default=True, help="Recompute or not.")
    # old shape
    parser.addoption("--resh_oshape", action="store", default=[1, 16, 32, 64], help="Shape of the tensor.")
    # new shape
    parser.addoption("--resh_nshape", action="store", default=[1, 32, 32, 32], help="New shape of the tensor.")
