...
class PytestParamsUtils:
    ...
    def get_shape_params(*shape_dim: int, microbatch: bool = None, id_name: str = "shape") -> List[pytest.param]:
        ...
        return PytestParamsUtils.create_pytest_params(PytestParamsUtils.get_basic_shapes(*shape_dim, microbatch=microbatch), id_name=id_name)
    ...
    def generate_test_params_list(self, *input_list: list[pytest.param]):
        ...
        # TODO: check if test_list_fields is already set / empty
        ...
        self.test_list.extend(
            PytestParamsUtils.join_multiple_params_list(
                *input_list,
                ...
                PytestParamsUtils.create_pytest_params(PytestParamsUtils.get_forge_math_fidelities(), id_name="math_fidelity"),
            )
        )
        return self
    ...
    def add_df_test_params_list(self, *input_list: list[pytest.param]):
        self.test_list.extend(
            PytestParamsUtils.join_multiple_params_list(
                *input_list,
                PytestParamsUtils.create_pytest_params(PytestParamsUtils.get_forge_data_formats(), id_name="dev_data_format"),
