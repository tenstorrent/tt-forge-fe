...
class ExceptionCheck:
    ...
    component: Optional["FailingReasonDef"] = None
        ...
        checks=[
            ExceptionCheck(
                error_log=[
                    ...
                    M.any(
                        M.last_line(M.starts_with("third_party/tvm/python/tvm/relay/frontend/pytorch.py:2386")),
                        M.last_line(M.starts_with("third_party/tvm/python/tvm/relay/frontend/pytorch.py:2406")),
                        M.last_line(M.starts_with("third_party/tvm/python/tvm/relay/frontend/pytorch.py:1654")),
...
class FailingReasonsDefs(Enum):
    UNCLASSIFIED = FailingReasonDef(
        description="Unclassified error",
    )

    UNSUPPORTED_DATA_FORMAT = FailingReasonDef(
    ...
    DATA_MISMATCH = FailingReasonDef(
    ...
    SPECIAL_VALUES = FailingReasonDef(
    ...
    DTYPE_MISMATCH = FailingReasonDef(
    ...
    WRONG_SCALAR_TYPE = FailingReasonDef(
    ...
    UNSUPPORTED_SPECIAL_CASE = FailingReasonDef(
    ...
    NOT_IMPLEMENTED = FailingReasonDef(
    ...
    ALLOCATION_FAILED = FailingReasonDef(
    ...
    ALLOCATION_CIRCULAR_BUFFER = FailingReasonDef(
        ...
        checks=[
            ...
            ExceptionCheck(
                ...
                message=[
                    ...
                    M.any(
                        M.contains("tt-metal/tt_metal/impl/program/program.cpp:787: tt::exception"),
                        M.contains("tt-metal/tt_metal/impl/program/program.cpp:791: tt::exception"),
                    ),
                ],
                error_log=[
                    M.regex(
    ...
    ATTRIBUTE_ERROR = FailingReasonDef(
    ...
    COMPILATION_FAILED = FailingReasonDef(
    ...
    INFERENCE_FAILED = FailingReasonDef(
    ...
    MICROBATCHING_UNSUPPORTED = FailingReasonDef(
    ...
    UNSUPORTED_AXIS = FailingReasonDef(
    ...
    CONV2D_VALIDATE_ARGS = FailingReasonDef(
    ...
    UNSUPPORTED_DIMENSION = FailingReasonDef(
        ...
        checks=[
            ...
            # third_party/tvm/python/tvm/relay/frontend/pytorch.py:1654: AssertionError
            ExceptionCheck(
                class_name="AssertionError",
                component=ComponentChecker.TVM.value,
                message=[
    ...
    UNSUPPORTED_PARAMETER_VALUE = FailingReasonDef(
        description="Unsupported parameter value",
    )

    UNSUPPORTED_TYPE_FOR_VALIDATION = FailingReasonDef(
    ...
    SEMAPHORE_LEAK = FailingReasonDef(
        description="Semaphore leak",
    )

    INTERNAL_TVM_ERROR = FailingReasonDef(
        ...
        checks=[
            ...
            ExceptionCheck(
                ...
                message=[
                    M.starts_with("TT_THROW"),
                    M.any(
                        M.contains("tt-metal/src/tt-metal/ttnn/cpp/ttnn/operations/creation.hpp:182: tt::exception"),
                        M.contains("tt-metal/src/tt-metal/ttnn/cpp/ttnn/operations/creation.hpp:197: tt::exception"),
                    ),
                ],
                error_log=[
                    M.contains("Unsupported DataType!"),
            ...
            # >       self.runtime_model_state.run_program(ProgramType.Forward, self.inputs)
            # E       RuntimeError: TT_FATAL @ /proj_sw/user_dev/vbrkic/src_bgd/ttforge/tt-forge-fe/third_party/tt-mlir/third_party/tt-metal/src/tt-metal/ttnn/cpp/ttnn/operations/matmul/device/matmul_op.cpp:1482: a_shape[i] == b_shape[i]
            # E       info:
            ...
            ExceptionCheck(
                ...
                message=[
                    ...
                    M.any(
                        M.contains(
                            "tt-metal/ttnn/cpp/ttnn/operations/matmul/device/matmul_op.cpp:1482: a_shape[i] == b_shape[i]"
                        ),
                        M.contains(
                            "tt-metal/ttnn/cpp/ttnn/operations/matmul/device/matmul_op.cpp:1479: a_shape[i] == b_shape[i]"
                        ),
                    ),
                ],
                error_log=[
    ...
    FORGE_RUNTIME = FailingReasonDef(
