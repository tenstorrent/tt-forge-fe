...
class TestPlan:
    ...
    def _check_kwargs_matching_list (
        self,
        kwargs_def_list: List[KwargsType],
        kwargs: KwargsType,
    ):

        for kwargs_def in kwargs_def_list:
            if self._check_kwargs_matching(kwargs_def, kwargs):
    ...
    def _check_test_failing(
        ...
        for failing_rule in self.failing_rules:
            if (
                ...
                and (failing_rule.kwargs is None or self._check_kwargs_matching_list(failing_rule.kwargs, test_vector.kwargs)) \
