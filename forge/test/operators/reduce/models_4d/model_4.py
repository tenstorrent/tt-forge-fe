...
class ForgeReduceTest(ForgeModule):
    ...
    def forward(self, x1, x2):
        ...
        mm2 = forge.op.Matmul("mm2", self.train_param2, tr2)
                # (W, Z, R, C) x (W, Z, C, R) --> (W, Z, R, R)
        ...
        # Layer 5
        mm3 = forge.op.Matmul("mm3", red1, red2)
        ...
        # Layer 7
        tr3 = forge.op.Transpose("tr3", red3, 3, 2)
                # (W, Z, 1, R) --> (W, Z, R, 1)

        mm4 = forge.op.Matmul("mm4", mm3, tr3)
                # (W, Z, R, R) x (W, Z, R, 1) --> (W, Z, R, 1)
        mm5 = forge.op.Matmul("mm5", red3, self.train_param2)
                # (W, Z, 1, R) x (W, Z, R, C) --> (W, Z, 1, C)

        # Layer 8
        mm6 = forge.op.Matmul("mm6", mm4, mm5)
