...
class ForgeReduceTest(ForgeModule):
    ...
    def forward(self, x1, x2, x3):
        ...
        # (W, Z, R, C) --> (W, Z, C, R)
        tr2 = forge.op.Transpose("tr2", x2, 3, 2)
        # (W, Z, R, C) --> (W, Z, C, R)
        tr3 = forge.op.Transpose("tr3", self.train_param3, 3, 2)
        # (W, Z, R, C) --> (W, Z, C, R)
        tr4 = forge.op.Transpose("tr4", x3, 3, 2)
        # (W, Z, R, C) --> (W, Z, C, R)

        # Layer 3
        mm1 = forge.op.Matmul("mm1", x1, tr1)
        # (W, Z, R, C) x (W, Z, C, R) --> (W, Z, R, R)
        mm2 = forge.op.Matmul("mm2", tr2, self.train_param2)
        ...
        # Layer 5
        tr5 = forge.op.Transpose("tr5", red2, 3, 2)
        # (W, Z, 1, C) --> (W, Z, C, 1)
        mm4 = forge.op.Matmul("mm4", red1, red2)
        # (W, Z, R, 1) x (W, Z, 1, C) --> (W, Z, R, C)
        mm5 = forge.op.Matmul("mm5", tr5, red3)
        ...
        # Layer 7
        mm6 = forge.op.Matmul("mm6", red4, red7)
        # (W, Z, R, 1) x (W, Z, 1, C) --> (W, Z, R, C)
        mm7 = forge.op.Matmul("mm7", red5, red6)
        # (W, Z, C, 1) x (W, Z, 1, R) --> (W, Z, C, R)
        ...
        # Layer 9
        mm8 = forge.op.Matmul("mm8", red8, red9)
