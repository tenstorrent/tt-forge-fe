...
def pytest_addoption(parser):
    # model
    parser.addoption(
        "--red_model", action="store", default="model_1", help="The name of the file in which the model is located."
    )
    # training
    parser.addoption("--red_train", action="store", default=True, help="Training or Inference.")
    # recompute
    parser.addoption("--red_recompute", action="store", default=True, help="Recompute or not.")
    # shape
    parser.addoption("--red_shape", action="store", default=[1, 16, 32, 64], help="Shape of the tensor.")
    # operation
    parser.addoption("--red_op", action="store", default="ReduceSum", help="ReduceSum or ReduceAvg")
    # dimension
    parser.addoption("--red_dim", action="store", default=2, help="Shape of the tensor.")
    # keep dimensions
    parser.addoption("--red_keepdim", action="store", default=True, help="Shape of the tensor.")
