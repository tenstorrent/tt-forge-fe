...
def pytest_addoption(parser):
    # model
    parser.addoption(
        "--mm_model", action="store", default="model_1", help="The name of the file in which the model is located."
    )
    # training
    parser.addoption("--mm_train", action="store", default=True, help="Training or Inference.")
    # recompute
    parser.addoption("--mm_recompute", action="store", default=True, help="Recompute or not.")
    # shape
    parser.addoption("--mm_shape", action="store", default=[1, 16, 32, 64], help="Shape of the tensor.")
