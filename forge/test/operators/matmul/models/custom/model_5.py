...
class ForgeMatmulTest(ForgeModule):
    ...
    def forward(self, x1, x2, x3):
        ...
        # Layer 4
        mm6 = forge.op.Matmul("mm6", mm4, x3)
        # (1, 18, 32, 256) x (1, 18, 256, 100) -> (1, 18, 32, 100)
        inter1 = forge.op.Matmul("inter1", mm4, self.train_param4)
        # (1, 18, 32, 256) x (1, 18, 256, 128) -> (1, 18, 32, 128)
        mm7 = forge.op.Matmul("mm7", inter1, mm5)
        # (1, 18, 32, 128) x (1, 18, 128, 522) -> (1, 18, 32, 522)

        # Layer 5
        tr1 = forge.op.Transpose("tr1", mm6, 3, 2)
        # (1, 18, 32, 100) -> (1, 18, 100, 32)
        mm8 = forge.op.Matmul("mm8", tr1, mm7)
