...
class ForgeElementWiseUnaryTest(ForgeModule):
    ...
    def forward(self, x1, x2):
        ...
        # Layer 3
        mul1 = forge.op.Multiply("mul1", un1, un4)
        mul2 = forge.op.Multiply("mul2", un2, un3)
        ...
        # Layer 6
        mul3 = forge.op.Multiply("mul3", un7, un5)
        mul4 = forge.op.Multiply("mul4", un8, un8)

        # Layer 7
        mul5 = forge.op.Multiply("mul5", mul3, mul1)
        mul6 = forge.op.Multiply("mul6", mul4, mul2)
        ...
        # Layer 9
        mul7 = forge.op.Multiply("mul7", un9, mul2)
        mul8 = forge.op.Multiply("mul8", mul1, un10)
