...
class ForgeElementWiseUnaryTest(ForgeModule):
    ...
    def forward(self, x1, x2):
        ...
        # Layer 2
        mul1 = forge.op.Multiply("mul1", x1, x1)
        mul2 = forge.op.Multiply("mul2", self.train_param1, self.train_param1)
        mul3 = forge.op.Multiply("mul3", x2, x2)
        mul4 = forge.op.Multiply("mul4", self.train_param2, self.train_param2)
        ...
        # Layer 4
        mul5 = forge.op.Multiply("mul5", un1, un2)
        mul6 = forge.op.Multiply("mul6", un1, un2)
        mul7 = forge.op.Multiply("mul7", un1, un2)
        mul8 = forge.op.Multiply("mul8", un3, un4)
        mul9 = forge.op.Multiply("mul9", un3, un4)
        ...
        # Layer 6
        mul10 = forge.op.Multiply("mul10", un5, un6)
        mul11 = forge.op.Multiply("mul11", un6, un7)
        mul12 = forge.op.Multiply("mul12", un7, un8)
        mul13 = forge.op.Multiply("mul13", un8, un9)
        ...
        # Layer 8
        mul14 = forge.op.Multiply("mul14", un10, un6)
        mul15 = forge.op.Multiply("mul15", un11, un7)
        mul16 = forge.op.Multiply("mul16", un12, un13)
        ...
        # Layer 10
        mul17 = forge.op.Multiply("mul17", un14, un11)
        mul18 = forge.op.Multiply("mul18", un15, un12)
        ...
        # Layer 12
        mul19 = forge.op.Multiply("mul19", un17, un18)
