...
class BudaElementWiseUnaryTest(ForgeModule):
    ...
    def forward(self, x1, x2):
        ...
        # Layer 3
        mul1 = forge.op.Multiply("mul1", un1, un1)
        mul2 = forge.op.Multiply("mul2", un2, un2)
        mul3 = forge.op.Multiply("mul3", un3, un3)
        mul4 = forge.op.Multiply("mul4", un4, un4)
        ...
        # Layer 5
        mul5 = forge.op.Multiply("mul5", un5, un7)
        mul6 = forge.op.Multiply("mul6", un6, un8)
        ...
        # Layer 7
        mul7 = forge.op.Multiply("mul7", un9, un10)
