...
class TestVerification:
    ...
    def verify(
        ...
        verify_config = VerifyConfig(value_checker=AllCloseValueChecker(atol=1e-2, rtol=1e-2)) #todo: check if this is correct ValueError: Data mismatch -> AllCloseValueChecker (all_close):	rtol=0.000965	atol=1.597266e+01
