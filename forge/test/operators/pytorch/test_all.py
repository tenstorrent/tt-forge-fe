...
import os
from ..utils.forge import DataFormat
from ..utils.forge import MathFidelity
import textwrap
import json
...
class RunQueryParams:
    ...
    def from_env(cls):
        ...
        if math_fidelities:
            math_fidelities = [getattr(MathFidelity, math_fidelity) for math_fidelity in math_fidelities]
