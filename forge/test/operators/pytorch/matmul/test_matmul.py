...
# Then use this method to generate the test data.
...
utils.extend_shape_params_with_marks(
  # (((input_shape), model_type, dev_data_format, math_fidelity), pytest.mark), wildcard = None in filtering, if used instead of pytest.mark it will clear all marks
    ...
    (((1, 2, 3, 4),         ModelFromDramQueue, None, None),  pytest.mark.xfail(reason=FailingReasons.UNSUPPORTED_DIMENSION)),   # RuntimeError: TT_THROW @...
    (((1, 2, 3, 4),         ModelConstEvalPass, None, None),  pytest.mark.xfail(reason=FailingReasons.UNSUPPORTED_DIMENSION)),   # RuntimeError: TT_THROW @...
    (((1, 11, 45, 17),      ModelConstEvalPass, None, None),  pytest.mark.xfail(reason=FailingReasons.UNSUPPORTED_DIMENSION)),   # RuntimeError: TT_THROW @...
    (((1, 11, 1, 23),       ModelFromDramQueue, None, None),  pytest.mark.xfail(reason=FailingReasons.UNSUPPORTED_DIMENSION)),   # RuntimeError: TT_THROW @...
    (((1, 11, 1, 23),       ModelConstEvalPass, None, None),  pytest.mark.xfail(reason=FailingReasons.UNSUPPORTED_DIMENSION)),   # RuntimeError: TT_THROW @...
    (((1, 11, 64, 1),       ModelConstEvalPass, None, None),  pytest.mark.xfail(reason=FailingReasons.UNSUPPORTED_DIMENSION)),   # RuntimeError: TT_THROW @...
    (((1, 100, 100, 100),   ModelFromAnotherOp, None, None),  pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)),             # AssertionError
    (((1, 100, 100, 100),   ModelFromHost,      None, None),  pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)),             # AssertionError
    (((1, 100, 100, 100),   ModelConstEvalPass, None, None),  pytest.mark.xfail(reason=FailingReasons.UNSUPPORTED_DIMENSION)),   # RuntimeError: TT_THROW @...
    (((1, 10, 1000, 100),                 None, None, None),  pytest.mark.xfail(reason=FailingReasons.UNSUPPORTED_DIMENSION)),   # RuntimeError: TT_THROW @...
    (((1, 1, 10, 1000),     ModelConstEvalPass, None, None),  pytest.mark.xfail(reason=FailingReasons.UNSUPPORTED_DIMENSION)),   # RuntimeError: TT_THROW @...
    (((1, 1, 9920, 1),      ModelConstEvalPass, None, None),  pytest.mark.xfail(reason=FailingReasons.UNSUPPORTED_DIMENSION)),   # RuntimeError: TT_THROW @...
    (((1, 11, 17, 41),      ModelConstEvalPass, None, None),  pytest.mark.xfail(reason=FailingReasons.UNSUPPORTED_DIMENSION)),   # RuntimeError: TT_THROW @...
    ...
    (((2, 2, 3, 4),         ModelConstEvalPass, None, None),  pytest.mark.xfail(reason=FailingReasons.COMPILATION_FAILED)),      # RuntimeError: Unhandled attribute type
    (((4, 11, 1, 23),       ModelFromAnotherOp, None, None),  pytest.mark.xfail(reason=FailingReasons.COMPILATION_FAILED)),      # RuntimeError: Unhandled attribute type
    (((4, 11, 1, 23),       ModelFromDramQueue, None, None),  pytest.mark.xfail(reason=FailingReasons.COMPILATION_FAILED)),      # RuntimeError: Unhandled attribute type
    (((4, 11, 1, 23),       ModelConstEvalPass, None, None),  pytest.mark.xfail(reason=FailingReasons.COMPILATION_FAILED)),      # RuntimeError: Unhandled attribute type
    (((5, 11, 64, 1),       ModelFromAnotherOp, None, None),  pytest.mark.xfail(reason=FailingReasons.COMPILATION_FAILED)),      # RuntimeError: Unhandled attribute type
    (((5, 11, 64, 1),       ModelFromDramQueue, None, None),  pytest.mark.xfail(reason=FailingReasons.COMPILATION_FAILED)),      # RuntimeError: Unhandled attribute type
    (((5, 11, 64, 1),       ModelConstEvalPass, None, None),  pytest.mark.xfail(reason=FailingReasons.COMPILATION_FAILED)),      # RuntimeError: Unhandled attribute type
    (((6, 100, 100, 100),                 None, None, None),  pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)),             # AssertionError
    (((7, 10, 1000, 100),   ModelFromAnotherOp, None, None),  pytest.mark.xfail(reason=FailingReasons.COMPILATION_FAILED)),      # RuntimeError: Unhandled attribute type
    (((7, 10, 1000, 100),   ModelFromDramQueue, None, None),  pytest.mark.xfail(reason=FailingReasons.COMPILATION_FAILED)),      # RuntimeError: Unhandled attribute type
    (((7, 10, 1000, 100),   ModelConstEvalPass, None, None),  pytest.mark.xfail(reason=FailingReasons.COMPILATION_FAILED)),      # RuntimeError: Unhandled attribute type
    (((8, 1, 10, 1000),     ModelFromAnotherOp, None, None),  pytest.mark.xfail(reason=FailingReasons.COMPILATION_FAILED)),      # RuntimeError: Unhandled attribute type
    (((8, 1, 10, 1000),     ModelFromDramQueue, None, None),  pytest.mark.xfail(reason=FailingReasons.COMPILATION_FAILED)),      # RuntimeError: Unhandled attribute type
    (((8, 1, 10, 1000),     ModelConstEvalPass, None, None),  pytest.mark.xfail(reason=FailingReasons.COMPILATION_FAILED)),      # RuntimeError: Unhandled attribute type
    ...
    (((1, 3, 3), None, forge.DataFormat.Float16_b, forge.MathFidelity.LoFi ),  pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)),   # AssertionError
    (((1, 3, 3), None, forge.DataFormat.Float16_b, forge.MathFidelity.HiFi2),  pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)),   # AssertionError
    (((1, 3, 3), None, forge.DataFormat.Float16_b, forge.MathFidelity.HiFi4),  pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)),   # AssertionError
    (((1, 3, 3), None, forge.DataFormat.Bfp2,      forge.MathFidelity.HiFi4),  pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)),   # AssertionError
    (((1, 3, 3), None, forge.DataFormat.Bfp4,      forge.MathFidelity.HiFi4),  pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)),   # AssertionError
    (((1, 3, 3), None, forge.DataFormat.Bfp4_b,    forge.MathFidelity.HiFi4),  pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)),   # AssertionError
    (((1, 3, 3), None, forge.DataFormat.Bfp8_b,    forge.MathFidelity.HiFi4),  pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)),   # AssertionError
    (((1, 3, 3), None, forge.DataFormat.Float16,   forge.MathFidelity.HiFi4),  pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)),   # AssertionError
    (((1, 3, 3), None, forge.DataFormat.Lf8,       forge.MathFidelity.HiFi4),  pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)),   # AssertionError
...
utils.extend_shape_params_with_marks(
    ...
    (((7, 3), (3, 7)),         pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)),        # This test fails in case of running all tests,
                                                                                             # but passes when running just test_operator_special_cases
