...
def test_torch_select(input_dim_index):
...
def test_torch_split(input_tensor_sizes_dim):
...
def test_torch_chunk(input_tensor_chunks_dim):
...
def test_torch_take(input_tensor_indices):
...
def test_torch_nonzero(input_tensor_as_tuple):
...
def test_torch_narrow(input_dim_start_length):
