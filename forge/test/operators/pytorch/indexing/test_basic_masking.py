...
def test_torch_masking_greater_than(input_tensor, param):
...
def test_torch_masking_modulus(input_tensor, mod_value):
...
def test_torch_masking_combined_conditions(input_tensor, greater_param, mod_param):
