...
def test_torch_diagonal(input_tensor, offset, dim1, dim2):
...
def test_torch_diag(input_tensor, diagonal):
...
def test_torch_diag_embed(input_tensor, offset, dim1, dim2):
...
def test_torch_triu(input_tensor, diagonal):
...
def test_torch_tril(input_tensor, diagonal):
...
def test_torch_take_along_dim(input_tensor, indices, dim):
...
def test_torch_gather(input_tensor, index, dim, sparse_grad):
...
def test_torch_unravel_index(indices, shape):
...
def test_torch_put(input_tensor, indices, values):
...
def test_torch_unique(input_tensor, sorted, return_inverse, return_counts, dim):
...
def test_torch_unique_consecutive(input_tensor, return_inverse, return_counts, dim):
...
def test_torch_where(input_tensor1, input_tensor2):
...
def test_torch_argwhere(input_tensor):
