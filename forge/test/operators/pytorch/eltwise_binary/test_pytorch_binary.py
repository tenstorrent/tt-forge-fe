...
class TestVerification:
    ...
    def verify(
        ...
        if test_vector.operator in ("add",) or test_vector.dev_data_format in TestCollectionCommon.int.dev_data_formats:
...
TestParamsData.test_plan_implemented = TestPlan(
    ...
    failing_rules=[
        ...
        TestCollection(
            ...
            criteria=lambda test_vector: test_vector.kwargs is not None and "alpha" in test_vector.kwargs,
            failing_reason=FailingReasons.DATA_MISMATCH,
        ),
        TestCollection(
            operators=[
