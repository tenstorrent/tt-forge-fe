    ...
    failing_rules=[
        ...
        TestCollection(
            ...
            in TestPlanUtils.load_test_ids_from_file(
                f"{os.path.dirname(__file__)}/errors/test_reduce_ids_reshape1_error.txt"
            ),
        ...
        TestCollection(
            criteria=lambda test_vector: test_vector.get_id()
            in TestPlanUtils.load_test_ids_from_file(
                f"{os.path.dirname(__file__)}/errors/test_reduce_ids_reshape2_error.txt"
            ),
            failing_reason=FailingReasons.COMPILATION_FAILED,
        ),
        ...
        TestCollection(
            criteria=lambda test_vector: test_vector.get_id()
            in TestPlanUtils.load_test_ids_from_file(
                f"{os.path.dirname(__file__)}/errors/test_reduce_ids_z_dim_slice_error.txt"
            ),
