...
utils.generate_test_params_list(
 ...
 #   ((shape),               dim,          model_type,      df,   mf)
    ...
    (((32, 32, 64),            2, [ModelConstEvalPass  ], None, None), pytest.mark.xfail(reason=FailingReasons.BUGGY_SHAPE)), # AssertionError: PCC check failed
...
@pytest.mark.parametrize("input_shape, dim, model_type, dev_data_format, math_fidelity", get_test_params_sortmax_inconsistency())
