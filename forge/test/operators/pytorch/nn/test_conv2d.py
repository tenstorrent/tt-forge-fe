...
from test.operators.utils import InputSourceFlags, VerifyUtils, ValueRanges, InputSource, TestVector, TestPlan, FailingReasons, TestCollection, TestCollectionCommon
...
TestParamsData.test_plan = TestPlan(
    ...
    collections=[
        ...
        TestCollection(
            ...
            input_sources=TestCollectionData.all.input_sources,
            input_shapes=TestCollectionData.all.input_shapes,
            kwargs=lambda test_vector: TestParamsData.generate_kwargs_zero_padding_no_unit_strides_dilation(test_vector),
        ),
        TestCollection(
            operators=TestCollectionData.all.operators,
            input_sources=TestCollectionData.all.input_sources,
