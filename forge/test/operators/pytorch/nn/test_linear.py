...
class TestParamsData:
    ...
    def generate_kwargs(cls, test_vector: TestVector):
        kwarg_list = []
        in_features = test_vector.input_shape[len(test_vector.input_shape) - 1]
        out_features_list = [
            30,
            541,
            1000,
        ]
        if sum(test_vector.input_shape) < 10000:
            out_features_list.append(sum(test_vector.input_shape))
