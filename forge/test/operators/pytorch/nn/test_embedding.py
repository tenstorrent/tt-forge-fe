    ...
    def generate_kwargs(cls, test_vector: TestVector, weight_dtype: Type[torch.dtype]):
        ...
        match test_vector.dev_data_format:
            case forge.DataFormat.RawUInt8:
                ...
                num_embeddings = [cls.rng.randint(2, num_embedding_limit)]
            ...
            case forge.DataFormat.RawUInt32:
                ...
                num_embeddings = [cls.rng.randint(2, 32000)]
...
TestParamsData.test_plan = TestPlan(
    ...
    failing_rules=[
        ...
        # RuntimeError: TT_FATAL @ /home/kmilanovic/src/ttforge/tt-forge-fe/third_party/tt-mlir/third_party/tt-metal/src/tt-metal/ttnn/cpp/ttnn/operations/data_movement/repeat/repeat.cpp:41: repeat_dims.rank() == input_rank
        # info: Number of repeat dims must be equal to number of tensor dims
        TestCollection(
            input_sources=[
                InputSource.CONST_EVAL_PASS,
            ],
        ...
        TestCollection(
            ...
            input_shapes=[(45, 17), (9920, 1), (17, 41), (89, 3), (64, 1), (1, 11, 1, 23)],
            failing_reason=FailingReasons.DATA_MISMATCH,
        ),
        # ALLOCATION ERRORS:
        ...
        # RuntimeError: TT_FATAL @ /home/kmilanovic/src/ttforge/tt-forge-fe/third_party/tt-mlir/third_party/tt-metal/src/tt-metal/ttnn/cpp/ttnn/operations/eltwise/binary/binary.cpp:124: second_shape[-3] == 1
        TestCollection(
            input_sources=[
                InputSource.CONST_EVAL_PASS,
            ],
        ...
        # RuntimeError: TT_FATAL @ /home/kmilanovic/src/ttforge/tt-forge-fe/third_party/tt-mlir/third_party/tt-metal/src/tt-metal/ttnn/cpp/ttnn/tensor/types.cpp:192: normalized_index >= 0 and normalized_index < rank
        TestCollection(
            input_sources=[
                InputSource.CONST_EVAL_PASS,
            ],
