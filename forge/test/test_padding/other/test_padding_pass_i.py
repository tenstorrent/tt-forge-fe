...
class TestPaddingPassI(forge.ForgeModule):
    ...
    def forward(self, x1, x2, x3):
        ...
        mm5 = forge.op.Matmul("mm5", self.train_param1, mm2)
        mm6 = forge.op.Matmul("mm6", mm2, self.train_param3)
        mm7 = forge.op.Matmul("mm7", self.train_param2, mm3)

        # Layer 4
        mm8 = forge.op.Matmul("mm8", mm4, mm5)
        mm9 = forge.op.Matmul("mm9", mm6, mm7)

        # Layer 5
        mm10 = forge.op.Matmul("mm10", mm8, mm2)
        mm11 = forge.op.Matmul("mm11", mm2, mm9)

        # Layer 6
        mm12 = forge.op.Matmul("mm12", mm4, mm10)
        mm13 = forge.op.Matmul("mm13", mm10, mm11)
        mm14 = forge.op.Matmul("mm14", mm11, mm7)

        # Layer 7
        mm15 = forge.op.Matmul("mm15", mm12, mm13)
        mm16 = forge.op.Matmul("mm16", mm13, mm14)

        return mm15, mm16


class TestPaddingPassI_1(forge.ForgeModule):
    ...
    def forward(self, x1, x2):
        ...
        # Layer 3
        mm3 = forge.op.Matmul("mm3", mm1, mm2)
        
        return mm3


class TestPaddingPassI_2(forge.ForgeModule):
...
class TestPaddingPassI_3(forge.ForgeModule):
    ...
    def forward(self, x):
        ...
        # Layer 4
        mm6 = forge.op.Matmul("mm6", mm1, mm4)
        mm7 = forge.op.Matmul("mm7", mm5, mm3)

        # Layer 5
        mm8 = forge.op.Matmul("mm8", mm6, mm7)

        return mm8


class TestPaddingPassI_4(forge.ForgeModule):
