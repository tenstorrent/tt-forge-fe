...
class TestPaddingPassK(forge.ForgeModule):
...
class TestPaddingPassK_1(forge.ForgeModule):
    ...
    def forward(self, x):
        ...
        # pre-head
        exp = forge.op.Exp("exp", x)
        relu = forge.op.Relu("relu", x)

        mul = forge.op.Multiply("mul", exp, relu)
        sub = forge.op.Multiply("sub", exp, relu)
...
class TestPaddingPassK_2(forge.ForgeModule):
...
class TestPaddingPassK_3(forge.ForgeModule):
...
class TestPaddingPassK_4(forge.ForgeModule):
