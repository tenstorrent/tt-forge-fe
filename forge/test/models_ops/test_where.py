...
class Where0(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("where0_const_2", shape=(1, 256, 10, 32), dtype=torch.float32)
...
class Where2(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("where2_const_2", shape=(1, 256, 20, 64), dtype=torch.float32)
...
class Where3(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("where3_const_2", shape=(1, 128, 20, 64), dtype=torch.float32)
...
class Where4(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("where4_const_2", shape=(1, 128, 40, 128), dtype=torch.float32)
...
class Where5(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("where5_const_2", shape=(1, 64, 40, 128), dtype=torch.float32)
...
class Where6(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("where6_const_2", shape=(1, 64, 80, 256), dtype=torch.float32)
...
class Where7(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("where7_const_2", shape=(1, 32, 80, 256), dtype=torch.float32)
...
class Where8(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("where8_const_2", shape=(1, 32, 160, 512), dtype=torch.float32)
...
class Where9(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("where9_const_2", shape=(1, 16, 160, 512), dtype=torch.float32)
...
class Where10(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("where10_const_2", shape=(1, 16, 320, 1024), dtype=torch.float32)
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        Where1,
        [((1, 32, 480, 640), torch.bool), ((1, 32, 480, 640), torch.float32), ((1, 32, 480, 640), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Where1,
        [((1, 64, 240, 320), torch.bool), ((1, 64, 240, 320), torch.float32), ((1, 64, 240, 320), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Where1,
        [((1, 32, 240, 320), torch.bool), ((1, 32, 240, 320), torch.float32), ((1, 32, 240, 320), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Where1,
        [((1, 128, 120, 160), torch.bool), ((1, 128, 120, 160), torch.float32), ((1, 128, 120, 160), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Where1,
        [((1, 64, 120, 160), torch.bool), ((1, 64, 120, 160), torch.float32), ((1, 64, 120, 160), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Where1,
        [((1, 256, 60, 80), torch.bool), ((1, 256, 60, 80), torch.float32), ((1, 256, 60, 80), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Where1,
        [((1, 128, 60, 80), torch.bool), ((1, 128, 60, 80), torch.float32), ((1, 128, 60, 80), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Where1,
        [((1, 512, 30, 40), torch.bool), ((1, 512, 30, 40), torch.float32), ((1, 512, 30, 40), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Where1,
        [((1, 256, 30, 40), torch.bool), ((1, 256, 30, 40), torch.float32), ((1, 256, 30, 40), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Where1,
        [((1, 1024, 15, 20), torch.bool), ((1, 1024, 15, 20), torch.float32), ((1, 1024, 15, 20), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Where1,
        [((1, 512, 15, 20), torch.bool), ((1, 512, 15, 20), torch.float32), ((1, 512, 15, 20), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Where1,
