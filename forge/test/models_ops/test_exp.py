...
forge_modules_and_shapes_dtypes_list = [
    (Exp0, [((1, 12, 11, 11), torch.float32)], {"model_names": ["pd_albert_chinese_tiny_mlm_padlenlp"], "pcc": 0.99}),
    (
        Exp0,
    ...
    (Exp0, [((3, 1, 1), torch.float32)], {"model_names": ["pt_swin_swin_v2_t_img_cls_torchvision"], "pcc": 0.99}),
    (Exp0, [((6, 1, 1), torch.float32)], {"model_names": ["pt_swin_swin_v2_t_img_cls_torchvision"], "pcc": 0.99}),
    (Exp0, [((12, 1, 1), torch.float32)], {"model_names": ["pt_swin_swin_v2_t_img_cls_torchvision"], "pcc": 0.99}),
    (Exp0, [((24, 1, 1), torch.float32)], {"model_names": ["pt_swin_swin_v2_t_img_cls_torchvision"], "pcc": 0.99}),
    (
        Exp0,
