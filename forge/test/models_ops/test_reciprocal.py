...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Reciprocal0, [((1, 588, 1), torch.float32)], {"model_names": ["pt_deepseek_1_3b_instruct_qa_hf"], "pcc": 0.99}),
    (
        Reciprocal0,
    ...
    (Reciprocal0, [((1, 6, 1), torch.float32)], {"model_names": ["pt_qwen1_5_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Reciprocal0,
        [((4, 31, 1), torch.bfloat16)],
        {
            "model_names": [
    ...
    (
        Reciprocal0,
        [((1, 128, 16, 1), torch.float32)],
        {"model_names": ["pt_qwen_v3_0_6b_clm_hf", "pt_qwen_v3_1_7b_clm_hf"], "pcc": 0.99},
    ),
    (
        Reciprocal0,
        [((1, 128, 8, 1), torch.float32)],
        {"model_names": ["pt_qwen_v3_0_6b_clm_hf", "pt_qwen_v3_1_7b_clm_hf", "pt_qwen_v3_4b_clm_hf"], "pcc": 0.99},
    ),
    (Reciprocal0, [((1, 39, 1), torch.float32)], {"model_names": ["pt_qwen_v2_0_5b_instruct_clm_hf"], "pcc": 0.99}),
    (Reciprocal0, [((1, 596, 1), torch.float32)], {"model_names": ["pt_llava_1_5_7b_cond_gen_hf"], "pcc": 0.99}),
    (
        Reciprocal0,
