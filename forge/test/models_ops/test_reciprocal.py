...
forge_modules_and_shapes_dtypes_list = [
    (Reciprocal0, [((1, 96, 54, 54), torch.float32)], {"model_names": ["pt_alexnet_base_img_cls_osmr"], "pcc": 0.99}),
    (Reciprocal0, [((1, 256, 27, 27), torch.float32)], {"model_names": ["pt_alexnet_base_img_cls_osmr"], "pcc": 0.99}),
]
