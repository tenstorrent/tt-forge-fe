...
class Multiply8(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply8_const_0", shape=(1, 1, 14, 20), dtype=torch.float32)
...
class Multiply9(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply9_const_1", shape=(8, 1), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply9_const_1"))
        return multiply_output_1
...
class Multiply15(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply15_const_0", shape=(1,), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply15_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply18(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply18.weight_1", forge.Parameter(*(96,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply47(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply47.weight_1", forge.Parameter(*(32,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply48(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply48.weight_1", forge.Parameter(*(16,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply49(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply49.weight_1", forge.Parameter(*(24,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply53(ForgeModule):
    ...
    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply53.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply54(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply54_const_0", shape=(2, 1, 1, 13), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply54_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply55(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply55_const_0", shape=(2, 1, 7, 7), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply55_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply57(ForgeModule):
    ...
    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply57.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply58(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply58_const_0", shape=(1, 1, 256, 256), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply58_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply59(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply59_const_0", shape=(16, 1), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply59_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply60(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply60_const_1", shape=(1, 256, 1, 32), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply60_const_1"))
        return multiply_output_1
...
class Multiply61(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply61_const_0", shape=(1, 12, 384, 384), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply61_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply62(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply62_const_0", shape=(1, 12, 128, 128), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply62_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply63(ForgeModule):
    ...
    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply63.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply64(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply64_const_0", shape=(1, 1, 32, 32), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply64_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply65(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply65_const_1", shape=(1, 1, 256, 96), dtype=torch.float32)
...
class Multiply66(ForgeModule):
    ...
    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply66.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply67(ForgeModule):
    ...
    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply67.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply68(ForgeModule):
    ...
    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply68.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply69(ForgeModule):
    ...
    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply69.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply70(ForgeModule):
    ...
    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply70.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply134(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply134.weight_1", forge.Parameter(*(8,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply163(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply163.weight_1",
            forge.Parameter(*(3024,), requires_grad=True, dev_data_format=forge.DataFormat.Float32),
        )

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_parameter("multiply163.weight_1"))
        return multiply_output_1
...
class Multiply164(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply164.weight_1",
            forge.Parameter(*(728,), requires_grad=True, dev_data_format=forge.DataFormat.Float32),
        )

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_parameter("multiply164.weight_1"))
        return multiply_output_1
...
class Multiply165(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply165_const_1", shape=(1, 255, 60, 60), dtype=torch.float32)
...
class Multiply166(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply166_const_1", shape=(1, 255, 30, 30), dtype=torch.float32)
...
class Multiply167(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply167_const_1", shape=(1, 255, 15, 15), dtype=torch.float32)
...
class Multiply168(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply168_const_1", shape=(1, 255, 40, 40), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply168_const_1"))
        return multiply_output_1
...
class Multiply169(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply169_const_1", shape=(1, 255, 20, 20), dtype=torch.float32)
...
class Multiply170(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply170_const_1", shape=(1, 255, 10, 10), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply170_const_1"))
        return multiply_output_1


class Multiply171(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply171_const_1", shape=(1, 255, 80, 80), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply171_const_1"))
        return multiply_output_1


class Multiply172(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply172_const_1", shape=(1, 255, 160, 160), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply172_const_1"))
        return multiply_output_1


class Multiply173(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply173_const_1", shape=(5880, 1), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply173_const_1"))
        return multiply_output_1
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Multiply0, [((1, 9216), torch.float32)], {"model_name": ["pd_alexnet_base_img_cls_paddlemodels"], "pcc": 0.99}),
    (Multiply0, [((1, 4096), torch.float32)], {"model_name": ["pd_alexnet_base_img_cls_paddlemodels"], "pcc": 0.99}),
    (
        Multiply15,
        [((64,), torch.float32)],
        {
    ...
    (Multiply59, [((1, 1, 32), torch.float32)], {"model_name": ["pt_bloom_bigscience_bloom_1b1_clm_hf"], "pcc": 0.99}),
    (
        Multiply0,
    ...
    (Multiply66, [((1, 6, 1024), torch.float32)], {"model_name": ["pt_qwen1_5_qwen_qwen1_5_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Multiply7,
    ...
    (Multiply56, [((1, 29, 2048), torch.float32)], {"model_name": ["pt_qwen_v2_qwen_qwen2_5_3b_clm_hf"], "pcc": 0.99}),
    (
        Multiply7,
    ...
    (Multiply69, [((1, 29, 896), torch.float32)], {"model_name": ["pt_qwen_v2_qwen_qwen2_5_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Multiply7,
    ...
    (Multiply68, [((1, 29, 3584), torch.float32)], {"model_name": ["pt_qwen_v2_qwen_qwen2_5_7b_clm_hf"], "pcc": 0.99}),
    (
        Multiply7,
    ...
    (
        ...
        {
            "model_name": ["pt_yolo_v5_yolov5s_imgcls_torchhub_320x320", "pt_yolo_v5_yolov5l_imgcls_torchhub_320x320"],
            "pcc": 0.99,
        },
    ),
    (
    ...
    (
        ...
        {"model_name": ["pt_yolo_v6_yolov6l_obj_det_torchhub", "pt_yolo_v6_yolov6s_obj_det_torchhub"], "pcc": 0.99},
    ),
    (
        Multiply7,
    ...
    (
        ...
        {"model_name": ["pt_yolox_yolox_darknet_obj_det_torchhub", "pt_yolox_yolox_l_obj_det_torchhub"], "pcc": 0.99},
    ),
    (
        Multiply7,
        [((1, 32, 320, 320), torch.float32), ((32, 1, 1), torch.float32)],
        {"model_name": ["pt_yolox_yolox_darknet_obj_det_torchhub", "pt_yolox_yolox_s_obj_det_torchhub"], "pcc": 0.99},
    ),
    (
        Multiply7,
