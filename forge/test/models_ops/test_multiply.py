...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Multiply1, [((1, 96, 54, 54), torch.float32)], {"model_names": ["pt_alexnet_base_img_cls_osmr"], "pcc": 0.99}),
    (
        Multiply0,
        [((1, 256, 27, 27), torch.float32), ((1, 256, 27, 27), torch.float32)],
        {"model_names": ["pt_alexnet_base_img_cls_osmr"], "pcc": 0.99},
    ),
    (Multiply1, [((1, 256, 27, 27), torch.float32)], {"model_names": ["pt_alexnet_base_img_cls_osmr"], "pcc": 0.99}),
]
