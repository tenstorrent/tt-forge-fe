...
class Multiply2(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply2.weight_1", forge.Parameter(*(768,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply3(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply3_const_0", shape=(1,), dtype=torch.float32)
...
class Multiply6(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply6.weight_1", forge.Parameter(*(128,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply7(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply7.weight_1", forge.Parameter(*(512,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply10(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply10.weight_1", forge.Parameter(*(16,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply11(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply11.weight_1", forge.Parameter(*(32,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply12(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply12.weight_1", forge.Parameter(*(24,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply15(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply15.weight_1", forge.Parameter(*(48,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply17(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply17.weight_1", forge.Parameter(*(96,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply30(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply30.weight_1", forge.Parameter(*(30,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply31(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply31.weight_1", forge.Parameter(*(60,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply36(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply36_const_0", shape=(1, 1, 32, 32), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply36_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply37(ForgeModule):
    ...
    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply37.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply44(ForgeModule):
    ...
    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply44.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply47(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply47_const_1", shape=(1, 255, 40, 40), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply47_const_1"))
        return multiply_output_1
...
class Multiply48(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply48_const_1", shape=(1, 255, 20, 20), dtype=torch.float32)
...
class Multiply49(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply49_const_1", shape=(1, 255, 10, 10), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply49_const_1"))
        return multiply_output_1
...
class Multiply50(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply50_const_1", shape=(1, 255, 80, 80), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply50_const_1"))
        return multiply_output_1
...
class Multiply51(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply51_const_1", shape=(16,), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply51_const_1"))
        return multiply_output_1
...
class Multiply52(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply52_const_1", shape=(32,), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply52_const_1"))
        return multiply_output_1
...
class Multiply53(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply53_const_1", shape=(64,), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply53_const_1"))
        return multiply_output_1
...
class Multiply54(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply54_const_1", shape=(128,), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply54_const_1"))
        return multiply_output_1
...
class Multiply55(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply55_const_1", shape=(256,), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply55_const_1"))
        return multiply_output_1
...
class Multiply56(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply56_const_1", shape=(5880, 1), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply56_const_1"))
        return multiply_output_1
...
class Multiply63(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply63_const_0", shape=(1, 1, 256, 256), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply63_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply64(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply64.weight_1", forge.Parameter(*(40,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply65(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply65.weight_1", forge.Parameter(*(80,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply68(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply68.weight_1", forge.Parameter(*(56,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply71(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply71.weight_1", forge.Parameter(*(8,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply72(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply72.weight_1", forge.Parameter(*(12,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply73(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply73.weight_1", forge.Parameter(*(36,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply74(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply74.weight_1", forge.Parameter(*(72,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply75(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply75.weight_1", forge.Parameter(*(20,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply77(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply77.weight_1", forge.Parameter(*(92,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply83(ForgeModule):
    ...
    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply83.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply84(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply84_const_1", shape=(512,), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply84_const_1"))
        return multiply_output_1
...
class Multiply86(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply86_const_0", shape=(1, 1, 14, 20), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply86_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply87(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply87_const_1", shape=(8, 1), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply87_const_1"))
        return multiply_output_1
...
class Multiply93(ForgeModule):
    ...
    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply93.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply94(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply94.weight_1", forge.Parameter(*(44,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply95(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply95.weight_1", forge.Parameter(*(88,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Multiply99(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply99_const_1", shape=(1, 255, 60, 60), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply99_const_1"))
        return multiply_output_1
...
class Multiply100(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply100_const_1", shape=(1, 255, 30, 30), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply100_const_1"))
        return multiply_output_1
...
class Multiply101(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply101_const_1", shape=(1, 255, 15, 15), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply101_const_1"))
        return multiply_output_1
...
class Multiply102(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply102_const_1", shape=(1, 8400), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply102_const_1"))
        return multiply_output_1
...
class Multiply103(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply103.weight_0", forge.Parameter(*(1,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply103.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply115(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply115_const_0", shape=(1, 12, 128, 128), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply115_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply118(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply118.weight_0",
            forge.Parameter(*(2048,), requires_grad=True, dev_data_format=forge.DataFormat.Float32),
        )

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply118.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply123(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply123_const_0", shape=(2, 1, 1, 13), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply123_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply124(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply124_const_1", shape=(1, 48), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply124_const_1"))
        return multiply_output_1
...
class Multiply125(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply125_const_0", shape=(16, 1), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply125_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply126(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply126_const_1", shape=(1, 256, 1, 32), dtype=torch.float32)
...
class Multiply142(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply142_const_0", shape=(1, 12, 384, 384), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply142_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply143(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply143_const_1", shape=(1, 2048, 16), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply143_const_1"))
        return multiply_output_1
...
class Multiply155(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply155_const_1", shape=(1, 3072, 16), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply155_const_1"))
        return multiply_output_1
...
class Multiply156(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply156_const_0", shape=(1, 1, 7, 7), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply156_const_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply158(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply158.weight_0",
            forge.Parameter(*(896,), requires_grad=True, dev_data_format=forge.DataFormat.Float32),
        )

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply158.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply161(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply161.weight_1",
            forge.Parameter(*(216,), requires_grad=True, dev_data_format=forge.DataFormat.Float32),
        )

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_parameter("multiply161.weight_1"))
        return multiply_output_1
...
class Multiply162(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply162.weight_1",
            forge.Parameter(*(1512,), requires_grad=True, dev_data_format=forge.DataFormat.Float32),
        )

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_parameter("multiply162.weight_1"))
        return multiply_output_1


class Multiply163(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply163_const_1", shape=(48,), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply163_const_1"))
        return multiply_output_1


class Multiply164(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply164_const_1", shape=(96,), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply164_const_1"))
        return multiply_output_1


class Multiply165(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply165_const_1", shape=(192,), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply165_const_1"))
        return multiply_output_1


class Multiply166(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply166_const_1", shape=(384,), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply166_const_1"))
        return multiply_output_1


class Multiply167(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply167_const_1", shape=(768,), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply167_const_1"))
        return multiply_output_1


class Multiply168(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply168_const_0", shape=(2, 1, 7, 7), dtype=torch.float32)

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_constant("multiply168_const_0"), multiply_input_1)
        return multiply_output_1


class Multiply169(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply169_const_1", shape=(1, 1, 14, 20), dtype=torch.float32)

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_constant("multiply169_const_1"))
        return multiply_output_1


class Multiply170(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply170.weight_1",
            forge.Parameter(*(400,), requires_grad=True, dev_data_format=forge.DataFormat.Float32),
        )

    def forward(self, multiply_input_0):
        multiply_output_1 = forge.op.Multiply("", multiply_input_0, self.get_parameter("multiply170.weight_1"))
        return multiply_output_1
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Multiply51, [((16,), torch.float32)], {"model_names": ["pt_yolo_v6_yolov6n_obj_det_torchhub"], "pcc": 0.99}),
    (
        Multiply1,
    ...
    (
        ...
        {"model_names": ["pt_yolo_v6_yolov6s_obj_det_torchhub", "pt_yolo_v6_yolov6l_obj_det_torchhub"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        ...
        {"model_names": ["pt_yolox_yolox_x_obj_det_torchhub"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        ...
        {"model_names": ["jax_resnet_50_img_cls_hf", "pt_perceiverio_deepmind_language_perceiver_mlm_hf"], "pcc": 0.99},
    ),
    (
        Multiply0,
    ...
    (
        ...
        {"model_names": ["pt_efficientnet_efficientnet_b0_img_cls_torchvision"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (Multiply3, [((44,), torch.float32)], {"model_names": ["pt_hrnet_hrnetv2_w44_pose_estimation_osmr"], "pcc": 0.99}),
    (Multiply94, [((44,), torch.float32)], {"model_names": ["pt_hrnet_hrnetv2_w44_pose_estimation_osmr"], "pcc": 0.99}),
    (
        Multiply1,
    ...
    (Multiply3, [((176,), torch.float32)], {"model_names": ["pt_hrnet_hrnetv2_w44_pose_estimation_osmr"], "pcc": 0.99}),
    (
        Multiply96,
        [((176,), torch.float32)],
        {"model_names": ["pt_hrnet_hrnetv2_w44_pose_estimation_osmr"], "pcc": 0.99},
    ...
    (
        Multiply1,
        [((1, 288, 28, 28), torch.float32), ((1, 288, 1, 1), torch.float32)],
        {"model_names": ["pt_regnet_facebook_regnet_y_064_img_cls_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((1, 576, 14, 14), torch.float32), ((1, 576, 1, 1), torch.float32)],
        {"model_names": ["pt_regnet_facebook_regnet_y_064_img_cls_hf"], "pcc": 0.99},
    ),
    (
        Multiply3,
    ...
    (
        Multiply1,
        [((1, 1296, 7, 7), torch.float32), ((1, 1296, 1, 1), torch.float32)],
        {"model_names": ["pt_regnet_facebook_regnet_y_064_img_cls_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        ...
        {"model_names": ["pt_yolov8_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        ...
        {
            "model_names": ["pt_yolov8_default_obj_det_github", "pt_efficientnet_efficientnet_b4_img_cls_timm"],
            "pcc": 0.99,
        },
    ),
    (
        ...
        {"model_names": ["pt_yolov8_default_obj_det_github", "pt_yolov9_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (Multiply103, [((1, 16, 240, 240), torch.float32)], {"model_names": ["TranslatedLayer"], "pcc": 0.99}),
    ...
    (Multiply103, [((1, 32, 240, 240), torch.float32)], {"model_names": ["TranslatedLayer"], "pcc": 0.99}),
    ...
    (Multiply103, [((1, 32, 120, 120), torch.float32)], {"model_names": ["TranslatedLayer"], "pcc": 0.99}),
    (Multiply103, [((1, 48, 120, 120), torch.float32)], {"model_names": ["TranslatedLayer"], "pcc": 0.99}),
    (Multiply0, [((1, 48, 120, 120), torch.float32)], {"model_names": ["TranslatedLayer"], "pcc": 0.99}),
    (Multiply103, [((1, 48, 60, 60), torch.float32)], {"model_names": ["TranslatedLayer"], "pcc": 0.99}),
    (Multiply103, [((1, 96, 60, 60), torch.float32)], {"model_names": ["TranslatedLayer"], "pcc": 0.99}),
    (Multiply0, [((1, 96, 60, 60), torch.float32)], {"model_names": ["TranslatedLayer"], "pcc": 0.99}),
    (Multiply103, [((1, 96, 30, 30), torch.float32)], {"model_names": ["TranslatedLayer"], "pcc": 0.99}),
    (Multiply103, [((1, 192, 30, 30), torch.float32)], {"model_names": ["TranslatedLayer"], "pcc": 0.99}),
    (Multiply0, [((1, 192, 30, 30), torch.float32)], {"model_names": ["TranslatedLayer"], "pcc": 0.99}),
    (Multiply103, [((1, 192, 15, 15), torch.float32)], {"model_names": ["TranslatedLayer"], "pcc": 0.99}),
    (
        Multiply0,
    ...
    (Multiply103, [((1, 384, 15, 15), torch.float32)], {"model_names": ["TranslatedLayer"], "pcc": 0.99}),
    ...
    (
        Multiply1,
        [((1, 168, 56, 56), torch.float32), ((1, 168, 1, 1), torch.float32)],
        {"model_names": ["pt_regnet_facebook_regnet_y_080_img_cls_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((1, 448, 28, 28), torch.float32), ((1, 448, 1, 1), torch.float32)],
        {"model_names": ["pt_regnet_facebook_regnet_y_080_img_cls_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((1, 896, 14, 14), torch.float32), ((1, 896, 1, 1), torch.float32)],
        {"model_names": ["pt_regnet_facebook_regnet_y_080_img_cls_hf"], "pcc": 0.99},
    ),
    (
        Multiply3,
    ...
    (
        Multiply1,
        [((1, 2016, 7, 7), torch.float32), ((1, 2016, 1, 1), torch.float32)],
        {"model_names": ["pt_regnet_facebook_regnet_y_080_img_cls_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (Multiply0, [((1, 256, 2048), torch.float32)], {"model_names": ["pt_xglm_facebook_xglm_1_7b_clm_hf"], "pcc": 0.99}),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((1, 256, 160, 160), torch.float32), ((1, 256, 160, 160), torch.float32)],
        {"model_names": ["pt_yolov9_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        ...
        {"model_names": ["pd_blip_text_salesforce_blip_image_captioning_base_text_enc_padlenlp"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((1, 232, 56, 56), torch.float32), ((1, 232, 1, 1), torch.float32)],
        {"model_names": ["pt_regnet_facebook_regnet_y_320_img_cls_hf"], "pcc": 0.99},
    ),
    (
        Multiply3,
        [((696,), torch.float32)],
    ...
    (
        Multiply1,
        [((1, 696, 28, 28), torch.float32), ((1, 696, 1, 1), torch.float32)],
        {"model_names": ["pt_regnet_facebook_regnet_y_320_img_cls_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((1, 1392, 14, 14), torch.float32), ((1, 1392, 1, 1), torch.float32)],
        {"model_names": ["pt_regnet_facebook_regnet_y_320_img_cls_hf"], "pcc": 0.99},
    ),
    (
        Multiply3,
    ...
    (
        Multiply1,
        [((1, 3712, 7, 7), torch.float32), ((1, 3712, 1, 1), torch.float32)],
        {"model_names": ["pt_regnet_facebook_regnet_y_320_img_cls_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((1, 32, 480, 640), torch.float32), ((1, 32, 480, 640), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((1, 32, 240, 320), torch.float32), ((1, 32, 240, 320), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((1, 128, 120, 160), torch.float32), ((1, 128, 120, 160), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((1, 512, 30, 40), torch.float32), ((1, 512, 30, 40), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((1, 1024, 15, 20), torch.float32), ((1, 1024, 15, 20), torch.float32)],
        {"model_names": ["pt_yolo_v4_default_obj_det_github"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        ...
        {"model_names": ["pt_yolox_yolox_m_obj_det_torchhub"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (Multiply6, [((1, 11, 128), torch.float32)], {"model_names": ["pd_albert_chinese_tiny_mlm_padlenlp"], "pcc": 0.99}),
    (
        Multiply0,
    ...
    (
        Multiply1,
        [((1, 522, 2048), torch.float32), ((1, 522, 1), torch.float32)],
        {"model_names": ["pt_falcon3_tiiuae_falcon3_1b_base_clm_hf"], "pcc": 0.99},
    ),
    (
        Multiply118,
    ...
    (
        Multiply1,
        [((1, 8, 522, 256), torch.float32), ((1, 1, 522, 256), torch.float32)],
        {"model_names": ["pt_falcon3_tiiuae_falcon3_1b_base_clm_hf"], "pcc": 0.99},
    ),
    (
        Multiply0,
        [((1, 8, 522, 128), torch.float32)],
        {"model_names": ["pt_falcon3_tiiuae_falcon3_1b_base_clm_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
        [((1, 4, 522, 256), torch.float32), ((1, 1, 522, 256), torch.float32)],
        {"model_names": ["pt_falcon3_tiiuae_falcon3_1b_base_clm_hf"], "pcc": 0.99},
    ),
    (
        Multiply0,
        [((1, 4, 522, 128), torch.float32)],
        {"model_names": ["pt_falcon3_tiiuae_falcon3_1b_base_clm_hf"], "pcc": 0.99},
    ),
    (
        Multiply0,
    ...
    (
        Multiply1,
        [((1, 522, 8192), torch.float32), ((1, 522, 8192), torch.float32)],
        {"model_names": ["pt_falcon3_tiiuae_falcon3_1b_base_clm_hf"], "pcc": 0.99},
    ),
    (
        Multiply0,
    ...
    (
        Multiply1,
        [((1, 6, 1536), torch.float32), ((1, 6, 1), torch.float32)],
        {"model_names": ["pt_mamba_state_spaces_mamba_790m_hf_clm_hf"], "pcc": 0.99},
    ),
    (
        Multiply37,
    ...
    (
        Multiply1,
        [((1, 3072, 1, 16), torch.float32), ((1, 3072, 6, 1), torch.float32)],
        {"model_names": ["pt_mamba_state_spaces_mamba_790m_hf_clm_hf"], "pcc": 0.99},
    ),
    (
        Multiply155,
    ...
    (
        Multiply1,
        [((1, 3072, 6, 1), torch.float32), ((1, 1, 6, 16), torch.float32)],
        {"model_names": ["pt_mamba_state_spaces_mamba_790m_hf_clm_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
        [((1, 3072, 6, 16), torch.float32), ((1, 3072, 6, 1), torch.float32)],
        {"model_names": ["pt_mamba_state_spaces_mamba_790m_hf_clm_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((1, 3072, 6), torch.float32), ((1, 3072, 1), torch.float32)],
        {"model_names": ["pt_mamba_state_spaces_mamba_790m_hf_clm_hf"], "pcc": 0.99},
    ),
    (
        Multiply0,
    ...
    (Multiply0, [((1, 32, 7, 16), torch.float32)], {"model_names": ["pt_phi1_microsoft_phi_1_clm_hf"], "pcc": 0.99}),
    (Multiply0, [((1, 32, 7, 7), torch.float32)], {"model_names": ["pt_phi1_microsoft_phi_1_clm_hf"], "pcc": 0.99}),
    (Multiply156, [((1, 1, 7, 7), torch.float32)], {"model_names": ["pt_phi1_microsoft_phi_1_clm_hf"], "pcc": 0.99}),
    (
        Multiply1,
    ...
    (
        ...
        {"model_names": ["pt_unet_base_img_seg_torchhub"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        ...
        {"model_names": ["pt_mobilenetv3_mobilenetv3_small_100_img_cls_timm"], "pcc": 0.99},
    ),
    (
        Multiply0,
        [((1, 96, 28, 28), torch.float32)],
    ...
    (
        Multiply1,
        [((64, 4, 64, 64), torch.float32), ((4, 1, 1), torch.float32)],
        {"model_names": ["pt_swin_swin_v2_b_img_cls_torchvision"], "pcc": 0.99},
    ),
    (
        Multiply0,
    ...
    (
        Multiply1,
        [((16, 8, 64, 64), torch.float32), ((8, 1, 1), torch.float32)],
        {"model_names": ["pt_swin_swin_v2_b_img_cls_torchvision"], "pcc": 0.99},
    ),
    (
        Multiply0,
    ...
    (
        Multiply1,
        [((4, 16, 64, 64), torch.float32), ((16, 1, 1), torch.float32)],
        {"model_names": ["pt_swin_swin_v2_b_img_cls_torchvision"], "pcc": 0.99},
    ),
    (
        Multiply0,
    ...
    (
        Multiply1,
        [((1, 32, 64, 64), torch.float32), ((32, 1, 1), torch.float32)],
        {"model_names": ["pt_swin_swin_v2_b_img_cls_torchvision"], "pcc": 0.99},
    ),
    (
        Multiply0,
    ...
    (Multiply163, [((48,), torch.float32)], {"model_names": ["pt_yolo_v6_yolov6m_obj_det_torchhub"], "pcc": 0.99}),
    (
        Multiply1,
        [((1, 48, 224, 320), torch.float32), ((48, 1, 1), torch.float32)],
        {"model_names": ["pt_yolo_v6_yolov6m_obj_det_torchhub"], "pcc": 0.99},
    ),
    (Multiply164, [((96,), torch.float32)], {"model_names": ["pt_yolo_v6_yolov6m_obj_det_torchhub"], "pcc": 0.99}),
    (
        Multiply1,
        [((1, 96, 112, 160), torch.float32), ((96, 1, 1), torch.float32)],
        {"model_names": ["pt_yolo_v6_yolov6m_obj_det_torchhub"], "pcc": 0.99},
    ),
    (Multiply165, [((192,), torch.float32)], {"model_names": ["pt_yolo_v6_yolov6m_obj_det_torchhub"], "pcc": 0.99}),
    (
        Multiply1,
        [((1, 192, 56, 80), torch.float32), ((192, 1, 1), torch.float32)],
        {"model_names": ["pt_yolo_v6_yolov6m_obj_det_torchhub"], "pcc": 0.99},
    ),
    (Multiply166, [((384,), torch.float32)], {"model_names": ["pt_yolo_v6_yolov6m_obj_det_torchhub"], "pcc": 0.99}),
    (
        Multiply1,
        [((1, 384, 28, 40), torch.float32), ((384, 1, 1), torch.float32)],
        {"model_names": ["pt_yolo_v6_yolov6m_obj_det_torchhub"], "pcc": 0.99},
    ),
    (Multiply167, [((768,), torch.float32)], {"model_names": ["pt_yolo_v6_yolov6m_obj_det_torchhub"], "pcc": 0.99}),
    (
        Multiply1,
    ...
    (
        ...
        {"model_names": ["pt_yolox_yolox_s_obj_det_torchhub"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((100, 8, 33, 280), torch.float32), ((100, 8, 33, 280), torch.float32)],
        {"model_names": ["pt_detr_facebook_detr_resnet_50_panoptic_sem_seg_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((100, 8, 16, 280), torch.float32), ((100, 8, 16, 280), torch.float32)],
        {"model_names": ["pt_detr_facebook_detr_resnet_50_panoptic_sem_seg_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((100, 8, 8, 1080), torch.float32), ((100, 8, 8, 1080), torch.float32)],
        {"model_names": ["pt_detr_facebook_detr_resnet_50_panoptic_sem_seg_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((100, 8, 4, 4320), torch.float32), ((100, 8, 4, 4320), torch.float32)],
        {"model_names": ["pt_detr_facebook_detr_resnet_50_panoptic_sem_seg_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (
        Multiply1,
        [((100, 8, 2, 17120), torch.float32), ((100, 8, 2, 17120), torch.float32)],
        {"model_names": ["pt_detr_facebook_detr_resnet_50_panoptic_sem_seg_hf"], "pcc": 0.99},
    ),
    (
        Multiply1,
    ...
    (Multiply0, [((1, 12, 256, 256), torch.float32)], {"model_names": ["pt_gpt_gpt2_text_gen_hf"], "pcc": 0.99}),
    (Multiply0, [((1, 1, 1, 256), torch.float32)], {"model_names": ["pt_gpt_gpt2_text_gen_hf"], "pcc": 0.99}),
    (
        Multiply1,
