...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        Squeeze1,
        [((1, 1, 512), torch.float32)],
        {"model_names": ["tf_resnet_resnet50_img_cls_keras"], "pcc": 0.99, "args": {"dim": "-3"}},
    ),
    (
        Squeeze2,
    ...
    (
        ...
        {
            "model_names": ["pd_resnet_34_img_cls_paddlemodels", "pd_resnet_18_img_cls_paddlemodels"],
            "pcc": 0.99,
            "args": {"dim": "-2"},
        },
    ),
    ...
    (
        Squeeze5,
        [((1, 1, 1, 1024), torch.float32)],
        {"model_names": ["tf_resnet_resnet50_img_cls_keras"], "pcc": 0.99, "args": {"dim": "-4"}},
    ),
    (
        Squeeze2,
    ...
    (
        ...
        {
            "model_names": ["pt_resnet_resnet18_img_cls_torchvision", "pt_resnet_resnet34_img_cls_torchvision"],
            "pcc": 0.99,
            "default_df_override": "Float16_b",
            "args": {"dim": "-2"},
        },
