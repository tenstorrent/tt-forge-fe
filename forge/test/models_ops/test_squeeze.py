...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {"model_names": ["pt_nbeats_seasionality_basis_clm_hf"], "pcc": 0.99, "args": {"dim": "-4"}},
    ),
    (
        Squeeze2,
        [((1, 1024, 1), torch.float32)],
        {"model_names": ["pt_nbeats_seasionality_basis_clm_hf"], "pcc": 0.99, "args": {"dim": "-3"}},
    ),
    (
        Squeeze0,
        [((1, 1024, 1), torch.float32)],
    ...
    (
        ...
        {"model_names": ["pt_swin_swin_v2_s_img_cls_torchvision"], "pcc": 0.99, "args": {"dim": "-2"}},
    ),
    (
        Squeeze0,
        [((1, 768, 1), torch.float32)],
        {"model_names": ["pt_swin_swin_v2_s_img_cls_torchvision"], "pcc": 0.99, "args": {"dim": "-1"}},
    ),
    (
        Squeeze1,
