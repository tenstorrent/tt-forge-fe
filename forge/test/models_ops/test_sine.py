...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Sine0, [((1, 7, 256), torch.float32)], {"model_names": ["pt_gemma_google_gemma_2b_text_gen_hf"], "pcc": 0.99}),
    (
        Sine0,
    ...
    (Sine0, [((1, 12, 64), torch.float32)], {"model_names": ["pt_phi4_microsoft_phi_4_token_cls_hf"], "pcc": 0.99}),
    (
        Sine0,
...
def test_module(forge_module_and_shapes_dtypes, forge_property_recorder):
    ...
    forge_property_recorder.record_forge_op_name("Sine")
