...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {
            "model_names": ["pt_gptneo_eleutherai_gpt_neo_1_3b_clm_hf", "pt_codegen_salesforce_codegen_350m_nl_clm_hf"],
            "pcc": 0.99,
            "args": {"dim": "-1"},
        },
    ),
    ...
    (
        ...
        {"model_names": ["pt_qwen1_5_qwen_qwen1_5_0_5b_chat_clm_hf"], "pcc": 0.99, "args": {"dim": "-1"}},
    ),
    (
        Softmax1,
