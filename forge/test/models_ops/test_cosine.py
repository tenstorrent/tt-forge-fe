...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Cosine0, [((1, 35, 64), torch.float32)], {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99}),
    (Cosine0, [((1, 588, 128), torch.float32)], {"model_names": ["pt_deepseek_1_3b_instruct_qa_hf"], "pcc": 0.99}),
    (
        Cosine0,
    ...
    (Cosine0, [((1, 29, 128), torch.float32)], {"model_names": ["pt_qwen_v2_1_5b_clm_hf"], "pcc": 0.99}),
    (
        Cosine0,
    ...
    (Cosine0, [((1, 35, 128), torch.float32)], {"model_names": ["pt_qwen_coder_1_5b_clm_hf"], "pcc": 0.99}),
    (Cosine0, [((1, 29, 64), torch.float32)], {"model_names": ["pt_qwen1_5_0_5b_chat_clm_hf"], "pcc": 0.99}),
    (Cosine0, [((1, 39, 64), torch.float32)], {"model_names": ["pt_qwen_v2_0_5b_instruct_clm_hf"], "pcc": 0.99}),
    (Cosine0, [((1, 334, 32), torch.float32)], {"model_names": ["pt_fuyu_adept_fuyu_8b_qa_hf"], "pcc": 0.99}),
    (Cosine0, [((1, 596, 128), torch.float32)], {"model_names": ["pt_llava_1_5_7b_cond_gen_hf"], "pcc": 0.99}),
    (
        Cosine0,
    ...
    (Cosine0, [((1, 256, 96), torch.float32)], {"model_names": ["pt_phi3_5_mini_instruct_clm_hf"], "pcc": 0.99}),
    (
        Cosine0,
    ...
    (Cosine0, [((1, 1063, 128), torch.float32)], {"model_names": ["pt_deepseek_7b_instruct_qa_hf"], "pcc": 0.99}),
    (
        Cosine0,
    ...
    (Cosine0, [((1, 512, 256), torch.float32)], {"model_names": ["pt_gemma_google_gemma_2b_text_gen_hf"], "pcc": 0.99}),
    (
        Cosine0,
    ...
    (Cosine0, [((1, 5, 128), torch.float32)], {"model_names": ["pt_phi4_microsoft_phi_4_seq_cls_hf"], "pcc": 0.99}),
