...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Cosine0, [((1, 256, 32), torch.float32)], {"model_names": ["pt_phi1_microsoft_phi_1_clm_hf"], "pcc": 0.99}),
    (Cosine0, [((1, 5, 32), torch.float32)], {"model_names": ["pt_phi_1_5_microsoft_phi_1_5_seq_cls_hf"], "pcc": 0.99}),
    (
        Cosine0,
    ...
    (Cosine0, [((1, 29, 64), torch.float32)], {"model_names": ["pt_qwen_v2_qwen_qwen2_5_0_5b_clm_hf"], "pcc": 0.99}),
    (Cosine0, [((1, 12, 32), torch.float32)], {"model_names": ["pt_phi1_microsoft_phi_1_token_cls_hf"], "pcc": 0.99}),
]
