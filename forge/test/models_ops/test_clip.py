...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {"model_names": ["pt_qwen_v2_qwen_qwen2_5_math_7b_clm_hf"], "pcc": 0.99, "args": {"min": "0.0", "max": "1.0"}},
    ),
    (
        Clip1,
    ...
    (
        ...
        {"model_names": ["pt_bloom_bigscience_bloom_1b1_clm_hf"], "pcc": 0.99, "args": {"min": "0.0", "max": "1.0"}},
    ),
]
