...
class Embedding42(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("embedding42_const_1", shape=(18000, 768), dtype=torch.float32)
...
class Embedding47(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("embedding47_const_1", shape=(21128, 128), dtype=torch.float32)

    def forward(self, embedding_input_0):
        embedding_output_1 = forge.op.Embedding("", embedding_input_0, self.get_constant("embedding47_const_1"))
        return embedding_output_1
...
class Embedding57(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("embedding57_const_1", shape=(21128, 768), dtype=torch.float32)

    def forward(self, embedding_input_0):
        embedding_output_1 = forge.op.Embedding("", embedding_input_0, self.get_constant("embedding57_const_1"))
        return embedding_output_1
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        Embedding36,
        [((1, 256), torch.int64)],
        {"model_names": ["pt_llama3_meta_llama_llama_3_2_1b_instruct_clm_hf"], "pcc": 0.99, "max_int": 128255},
    ),
    (
        Embedding37,
        [((1, 256), torch.int64)],
    ...
    (
        Embedding42,
        [((1, 9), torch.int64)],
        {"model_names": ["pd_ernie_1_0_seq_cls_padlenlp", "pd_ernie_1_0_qa_padlenlp"], "pcc": 0.99, "max_int": 17999},
    ),
    (
        Embedding43,
        [((1, 9), torch.int64)],
        {"model_names": ["pd_ernie_1_0_seq_cls_padlenlp", "pd_ernie_1_0_qa_padlenlp"], "pcc": 0.99, "max_int": 512},
    ),
    (
        Embedding4,
        [((1, 9), torch.int64)],
    ...
    (
        ...
        [((1, 9), torch.int64)],
        {
            "model_names": ["pd_bert_chinese_roberta_base_mlm_padlenlp", "pd_bert_bert_base_uncased_qa_padlenlp"],
            "pcc": 0.99,
            "max_int": 511,
        },
    ),
    ...
    (
        Embedding8,
        [((1, 9), torch.int64)],
        {"model_names": ["pd_bert_bert_base_uncased_qa_padlenlp"], "pcc": 0.99, "max_int": 30521},
    ),
    (
        Embedding17,
        [((1, 8), torch.int64)],
    ...
    (
        Embedding13,
        [((1, 256), torch.int64)],
        {"model_names": ["pt_phi1_microsoft_phi_1_seq_cls_hf"], "pcc": 0.99, "max_int": 51199},
    ),
    (
        Embedding54,
        [((1, 35), torch.int64)],
