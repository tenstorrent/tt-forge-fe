...
forge_modules_and_shapes_dtypes_list = [
    (Advindex0, [((448, 1024), torch.float32), ((1, 2), torch.float32)]),
    (Advindex0, [((448, 512), torch.float32), ((1, 2), torch.float32)]),
    (Advindex0, [((448, 1280), torch.float32), ((1, 2), torch.float32)]),
    (Advindex0, [((448, 768), torch.float32), ((1, 2), torch.float32)]),
    (Advindex0, [((448, 384), torch.float32), ((1, 2), torch.float32)]),
    (Advindex1, [((1, 2), torch.float32)]),
    (Advindex0, [((32, 2), torch.float32), ((1,), torch.float32)]),
    (Advindex1, [((1, 1, 1024, 72), torch.float32)]),
]
