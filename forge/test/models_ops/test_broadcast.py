...
forge_modules_and_shapes_dtypes_list = [
    (Broadcast0, [((1, 1, 1, 128), torch.float32)]),
    (Broadcast1, [((1, 1, 1, 128), torch.float32)]),
    (Broadcast2, [((1, 12, 1, 128), torch.float32)]),
    (Broadcast0, [((1, 1, 1, 384), torch.float32)]),
    (Broadcast1, [((1, 1, 1, 384), torch.float32)]),
    (Broadcast3, [((1, 12, 1, 384), torch.float32)]),
]
