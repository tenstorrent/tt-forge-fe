...
forge_modules_and_shapes_dtypes_list = [
    ...
    pytest.param(
        ...
        marks=[
            pytest.mark.xfail(
                reason="RuntimeError: Cannot access data pointer of Tensor that doesn't have storage Exception raised from throw_data_ptr_access_error at ../c10/core/TensorImpl.cpp:604 (most recent call first): frame #0: c10::Error::Error(c10::SourceLocation, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >) + 0x55 (0x7f30d7c64985 in /opt/ttforge-toolchain/venv/lib/python3.10/site-packages/torch/lib/libc10.so)"
            )
        ],
    ),
    pytest.param(
        ...
        marks=[
            pytest.mark.xfail(
                reason="RuntimeError: Cannot access data pointer of Tensor that doesn't have storage Exception raised from throw_data_ptr_access_error at ../c10/core/TensorImpl.cpp:604 (most recent call first): frame #0: c10::Error::Error(c10::SourceLocation, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >) + 0x55 (0x7f34b8664985 in /opt/ttforge-toolchain/venv/lib/python3.10/site-packages/torch/lib/libc10.so)"
            )
        ],
    ),
    pytest.param(
        ...
        marks=[
            pytest.mark.xfail(
                reason="RuntimeError: Cannot access data pointer of Tensor that doesn't have storage Exception raised from throw_data_ptr_access_error at ../c10/core/TensorImpl.cpp:604 (most recent call first): frame #0: c10::Error::Error(c10::SourceLocation, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >) + 0x55 (0x7fc20f064985 in /opt/ttforge-toolchain/venv/lib/python3.10/site-packages/torch/lib/libc10.so)"
            )
        ],
    ),
    (
