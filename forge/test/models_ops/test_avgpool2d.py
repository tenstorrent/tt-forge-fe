...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        [((1, 1024, 7, 7), torch.float32)],
        {
            "model_names": ["pd_mobilenetv1_basic_img_cls_paddlemodels", "pd_densenet_121_img_cls_paddlemodels"],
            "pcc": 0.99,
            "args": {
                "kernel_size": "[7, 7]",
                "stride": "[7, 7]",
    ...
    (
        ...
        [((1, 1536, 8, 8), torch.bfloat16)],
        {
            "model_names": ["pt_inception_inceptionv4_img_cls_osmr"],
            "pcc": 0.99,
            "default_df_override": "Float16_b",
            "args": {
                "kernel_size": "[8, 8]",
    ...
    (
        ...
        {
            "model_names": ["onnx_alexnet_base_img_cls_torchhub"],
            "pcc": 0.99,
            "args": {
                "kernel_size": "[1, 1]",
                "stride": "[1, 1]",
    ...
    (
        ...
        {
            "model_names": ["onnx_densenet_densenet121_img_cls_torchvision"],
            "pcc": 0.99,
            "args": {
                "kernel_size": "[2, 2]",
                "stride": "[2, 2]",
