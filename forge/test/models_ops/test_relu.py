...
forge_modules_and_shapes_dtypes_list = [
    (
        ...
        {
            "model_names": [
                "onnx_autoencoder_linear_img_enc_github",
    ...
    (
        ...
        {
            "model_names": ["onnx_dla_dla102x2_visual_bb_torchvision", "onnx_resnext_resnext101_64x4d_img_cls_osmr"],
            "pcc": 0.99,
        },
    ),
    (
    ...
    (Relu0, [((1, 32, 26, 26), torch.float32)], {"model_names": ["onnx_mnist_base_img_cls_github"], "pcc": 0.99}),
    (Relu0, [((1, 64, 24, 24), torch.float32)], {"model_names": ["onnx_mnist_base_img_cls_github"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (
        ...
        {"model_names": ["pd_alexnet_base_img_cls_paddlemodels", "onnx_alexnet_base_img_cls_torchhub"], "pcc": 0.99},
    ),
    (
        Relu0,
    ...
    (Relu0, [((1, 30, 56, 56), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w30_img_cls_osmr"], "pcc": 0.99}),
    (Relu0, [((1, 120, 14, 14), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w30_img_cls_osmr"], "pcc": 0.99}),
    (Relu0, [((1, 30, 28, 28), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w30_img_cls_osmr"], "pcc": 0.99}),
    (Relu0, [((1, 240, 7, 7), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w30_img_cls_osmr"], "pcc": 0.99}),
    (Relu0, [((1, 30, 14, 14), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w30_img_cls_osmr"], "pcc": 0.99}),
    (Relu0, [((1, 60, 14, 14), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w30_img_cls_osmr"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (Relu0, [((1, 1, 2048), torch.float32)], {"model_names": ["onnx_t5_t5_small_text_gen_hf"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (
        ...
        {
            "model_names": ["pt_regnet_regnet_x_16gf_img_cls_torchvision", "pt_dla_dla102x2_visual_bb_torchvision"],
            "pcc": 0.99,
            "default_df_override": "Float16_b",
        },
    ),
    ...
    (
        ...
        {"model_names": ["pt_vgg_vgg19_bn_obj_det_timm"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Relu0,
        [((1, 16, 224, 320), torch.bfloat16)],
        {"model_names": ["pt_yolo_v6_yolov6n_obj_det_torchhub"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Relu0,
        [((1, 32, 112, 160), torch.bfloat16)],
        {"model_names": ["pt_yolo_v6_yolov6n_obj_det_torchhub"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Relu0,
    ...
    (Relu0, [((1, 44, 56, 56), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w44_img_cls_osmr"], "pcc": 0.99}),
    (Relu0, [((1, 176, 14, 14), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w44_img_cls_osmr"], "pcc": 0.99}),
    (Relu0, [((1, 44, 28, 28), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w44_img_cls_osmr"], "pcc": 0.99}),
    (Relu0, [((1, 352, 7, 7), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w44_img_cls_osmr"], "pcc": 0.99}),
    (Relu0, [((1, 44, 14, 14), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w44_img_cls_osmr"], "pcc": 0.99}),
    (Relu0, [((1, 88, 14, 14), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w44_img_cls_osmr"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (
        ...
        {"model_names": ["onnx_ssd300_resnet50_base_img_cls_torchhub"], "pcc": 0.99},
    ),
    (
        Relu0,
    ...
    (Relu0, [((1, 1024), torch.float32)], {"model_names": ["pd_googlenet_base_img_cls_paddlemodels"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (
        Relu0,
        [((1, 768), torch.float32)],
        {"model_names": ["pt_distilbert_distilbert_base_uncased_finetuned_sst_2_english_seq_cls_hf"], "pcc": 0.99},
    ),
    (
        Relu0,
    ...
    (
        ...
        {
            "model_names": ["pt_regnet_regnet_y_064_img_cls_hf", "pt_regnet_regnet_y_800mf_img_cls_torchvision"],
            "pcc": 0.99,
            "default_df_override": "Float16_b",
        },
    ),
    ...
    (Relu0, [((1, 48, 56, 56), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w48_img_cls_osmr"], "pcc": 0.99}),
    (
        Relu0,
        [((1, 96, 28, 28), torch.float32)],
        {
            "model_names": ["onnx_hrnet_hrnetv2_w48_img_cls_osmr", "onnx_googlenet_googlenet_img_cls_torchvision"],
            "pcc": 0.99,
        },
    ),
    (Relu0, [((1, 48, 28, 28), torch.float32)], {"model_names": ["onnx_hrnet_hrnetv2_w48_img_cls_osmr"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (
        ...
        {"model_names": ["pt_autoencoder_conv_img_enc_github"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Relu0,
        [((1, 168, 112, 112), torch.bfloat16)],
        {"model_names": ["pt_regnet_regnet_y_080_img_cls_hf"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Relu0,
        [((1, 42, 1, 1), torch.bfloat16)],
        {"model_names": ["pt_regnet_regnet_y_080_img_cls_hf"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    ...
    (Relu0, [((1, 32, 256, 256), torch.float32)], {"model_names": ["onnx_unet_base_img_seg_torchhub"], "pcc": 0.99}),
    (Relu0, [((1, 64, 128, 128), torch.float32)], {"model_names": ["onnx_unet_base_img_seg_torchhub"], "pcc": 0.99}),
    (Relu0, [((1, 128, 64, 64), torch.float32)], {"model_names": ["onnx_unet_base_img_seg_torchhub"], "pcc": 0.99}),
    (Relu0, [((1, 256, 32, 32), torch.float32)], {"model_names": ["onnx_unet_base_img_seg_torchhub"], "pcc": 0.99}),
    (Relu0, [((1, 512, 16, 16), torch.float32)], {"model_names": ["onnx_unet_base_img_seg_torchhub"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (Relu0, [((256, 4096), torch.float32)], {"model_names": ["pt_opt_facebook_opt_350m_clm_hf"], "pcc": 0.99}),
    (
        Relu0,
        [((1, 120, 56, 56), torch.bfloat16)],
        {
    ...
    (
        Relu0,
        [((1, 64, 75, 75), torch.bfloat16)],
        {"model_names": ["pt_ssd300_resnet50_base_img_cls_torchhub"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Relu0,
        [((1, 128, 38, 38), torch.bfloat16)],
        {"model_names": ["pt_ssd300_resnet50_base_img_cls_torchhub"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Relu0,
    ...
    (
        Relu0,
        [((1, 32, 224, 320), torch.bfloat16)],
        {"model_names": ["pt_yolo_v6_yolov6s_obj_det_torchhub"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Relu0,
    ...
    (
        ...
        {"model_names": ["onnx_googlenet_googlenet_img_cls_torchvision"], "pcc": 0.99},
    ),
    (
        Relu0,
