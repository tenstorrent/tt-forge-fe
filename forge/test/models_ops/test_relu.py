...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Relu0, [((1, 1, 3072), torch.float32)], {"model_names": ["pt_t5_t5_base_text_gen_hf"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (
        ...
        {"model_names": ["pd_ernie_1_0_qa_padlenlp", "pd_ernie_1_0_seq_cls_padlenlp"], "pcc": 0.99},
    ),
    ...
    (Relu0, [((1024, 2048), torch.float32)], {"model_names": ["pt_nbeats_seasionality_basis_clm_hf"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (Relu0, [((1, 64, 14, 20), torch.bfloat16)], {"model_names": ["pt_yolo_v6_yolov6n_obj_det_torchhub"], "pcc": 0.99}),
    (
        Relu0,
        [((1, 64, 28, 40), torch.bfloat16)],
        {"model_names": ["pt_yolo_v6_yolov6n_obj_det_torchhub", "pt_yolo_v6_yolov6s_obj_det_torchhub"], "pcc": 0.99},
    ),
    (Relu0, [((1, 32, 28, 40), torch.bfloat16)], {"model_names": ["pt_yolo_v6_yolov6n_obj_det_torchhub"], "pcc": 0.99}),
    (Relu0, [((1, 32, 56, 80), torch.bfloat16)], {"model_names": ["pt_yolo_v6_yolov6n_obj_det_torchhub"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (Relu0, [((1, 128, 74, 74), torch.bfloat16)], {"model_names": ["pt_xception_xception_img_cls_timm"], "pcc": 0.99}),
    (Relu0, [((1, 256, 74, 74), torch.bfloat16)], {"model_names": ["pt_xception_xception_img_cls_timm"], "pcc": 0.99}),
    (Relu0, [((1, 256, 37, 37), torch.bfloat16)], {"model_names": ["pt_xception_xception_img_cls_timm"], "pcc": 0.99}),
    (Relu0, [((1, 728, 37, 37), torch.bfloat16)], {"model_names": ["pt_xception_xception_img_cls_timm"], "pcc": 0.99}),
    ...
    (
        ...
        {"model_names": ["pd_densenet_121_img_cls_paddlemodels", "onnx_vovnet_vovnet27s_obj_det_osmr"], "pcc": 0.99},
    ),
    (
        Relu0,
    ...
    (
        ...
        {
            "model_names": ["pd_densenet_121_img_cls_paddlemodels", "onnx_dla_dla46_c_visual_bb_torchvision"],
            "pcc": 0.99,
        },
    ),
    ...
    (Relu0, [((1, 4, 14, 14), torch.bfloat16)], {"model_names": ["pt_autoencoder_conv_img_enc_github"], "pcc": 0.99}),
    (
        Relu0,
        [((1, 768), torch.float32)],
    ...
    (Relu0, [((1, 32, 256, 256), torch.bfloat16)], {"model_names": ["pt_unet_base_img_seg_torchhub"], "pcc": 0.99}),
    (Relu0, [((1, 64, 128, 128), torch.bfloat16)], {"model_names": ["pt_unet_base_img_seg_torchhub"], "pcc": 0.99}),
    (Relu0, [((1, 128, 64, 64), torch.bfloat16)], {"model_names": ["pt_unet_base_img_seg_torchhub"], "pcc": 0.99}),
    (Relu0, [((1, 256, 32, 32), torch.bfloat16)], {"model_names": ["pt_unet_base_img_seg_torchhub"], "pcc": 0.99}),
    (Relu0, [((1, 512, 16, 16), torch.bfloat16)], {"model_names": ["pt_unet_base_img_seg_torchhub"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (Relu0, [((1, 32, 26, 26), torch.bfloat16)], {"model_names": ["pt_mnist_base_img_cls_github"], "pcc": 0.99}),
    (Relu0, [((1, 64, 24, 24), torch.bfloat16)], {"model_names": ["pt_mnist_base_img_cls_github"], "pcc": 0.99}),
    (Relu0, [((1, 128), torch.bfloat16)], {"model_names": ["pt_mnist_base_img_cls_github"], "pcc": 0.99}),
    ...
    (Relu0, [((1024, 512), torch.float32)], {"model_names": ["pt_nbeats_generic_basis_clm_hf"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (Relu0, [((1, 4096, 1, 1), torch.bfloat16)], {"model_names": ["pt_vgg_vgg19_bn_obj_det_timm"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (Relu0, [((1, 112, 7, 7), torch.bfloat16)], {"model_names": ["pt_vovnet_vovnet27s_img_cls_osmr"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (Relu0, [((1, 96, 28, 40), torch.bfloat16)], {"model_names": ["pt_yolo_v6_yolov6m_obj_det_torchhub"], "pcc": 0.99}),
    (Relu0, [((1, 96, 56, 80), torch.bfloat16)], {"model_names": ["pt_yolo_v6_yolov6m_obj_det_torchhub"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (Relu0, [((1, 1, 2048), torch.float32)], {"model_names": ["pt_t5_t5_small_text_gen_hf"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (Relu0, [((1, 100, 192), torch.bfloat16)], {"model_names": ["pt_yolos_hustvl_yolos_tiny_obj_det_hf"], "pcc": 0.99}),
    ...
    (Relu0, [((1, 334, 16384), torch.float32)], {"model_names": ["pt_fuyu_adept_fuyu_8b_qa_hf"], "pcc": 0.99}),
    (
        Relu0,
    ...
    (
        ...
        {"model_names": ["onnx_dla_dla46_c_visual_bb_torchvision"], "pcc": 0.99},
    ),
    (
        Relu0,
    ...
    (Relu0, [((1024, 256), torch.float32)], {"model_names": ["pt_nbeats_trend_basis_clm_hf"], "pcc": 0.99}),
    ...
    (Relu0, [((1, 1, 4096), torch.float32)], {"model_names": ["pt_t5_t5_large_text_gen_hf"], "pcc": 0.99}),
]
