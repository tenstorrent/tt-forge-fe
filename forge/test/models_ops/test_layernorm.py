...
class Layernorm41(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("layernorm41_const_1", shape=(96,), dtype=torch.float32)
        self.add_constant("layernorm41_const_2", shape=(96,), dtype=torch.float32)
...
class Layernorm42(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("layernorm42_const_1", shape=(192,), dtype=torch.float32)
        self.add_constant("layernorm42_const_2", shape=(192,), dtype=torch.float32)
...
class Layernorm43(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("layernorm43_const_1", shape=(384,), dtype=torch.float32)
        self.add_constant("layernorm43_const_2", shape=(384,), dtype=torch.float32)
...
class Layernorm44(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("layernorm44_const_1", shape=(768,), dtype=torch.float32)
        self.add_constant("layernorm44_const_2", shape=(768,), dtype=torch.float32)
