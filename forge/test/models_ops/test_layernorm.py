...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Layernorm2, [((1, 128, 768), torch.float32)], {"model_name": ["pt_roberta_xlm_roberta_base_mlm_hf"], "pcc": 0.99}),
    (
        Layernorm3,
    ...
    (Layernorm2, [((256, 768), torch.float32)], {"model_name": ["pt_opt_facebook_opt_125m_clm_hf"], "pcc": 0.99}),
]
...
def test_module(forge_module_and_shapes_dtypes, record_forge_property):
    record_forge_property("framework_op_name", "Layernorm")
