...
class Layernorm0(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("layernorm0_const_1", shape=(384,), dtype=torch.float32)
        self.add_constant("layernorm0_const_2", shape=(384,), dtype=torch.float32)
...
class Layernorm29(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("layernorm29_const_1", shape=(768,), dtype=torch.float32)
        self.add_constant("layernorm29_const_2", shape=(768,), dtype=torch.float32)
...
class Layernorm30(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("layernorm30_const_1", shape=(96,), dtype=torch.float32)
        self.add_constant("layernorm30_const_2", shape=(96,), dtype=torch.float32)

    def forward(self, layernorm_input_0):
        layernorm_output_1 = forge.op.Layernorm(
            "",
            layernorm_input_0,
            self.get_constant("layernorm30_const_1"),
            self.get_constant("layernorm30_const_2"),
            dim=-1,
            epsilon=1e-05,
        )
        return layernorm_output_1
...
class Layernorm31(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("layernorm31_const_1", shape=(192,), dtype=torch.float32)
        self.add_constant("layernorm31_const_2", shape=(192,), dtype=torch.float32)

    def forward(self, layernorm_input_0):
        layernorm_output_1 = forge.op.Layernorm(
            "",
            layernorm_input_0,
            self.get_constant("layernorm31_const_1"),
            self.get_constant("layernorm31_const_2"),
            dim=-1,
            epsilon=1e-05,
        )
        return layernorm_output_1
...
class Layernorm33(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("layernorm33_const_1", shape=(768,), dtype=torch.float32)
        self.add_constant("layernorm33_const_2", shape=(768,), dtype=torch.float32)
...
class Layernorm39(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("layernorm39_const_1", shape=(32,), dtype=torch.float32)
        self.add_constant("layernorm39_const_2", shape=(32,), dtype=torch.float32)
...
class Layernorm40(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("layernorm40_const_1", shape=(160,), dtype=torch.float32)
        self.add_constant("layernorm40_const_2", shape=(160,), dtype=torch.float32)
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {"model_names": ["pt_albert_xlarge_v1_mlm_hf"], "pcc": 0.99, "args": {"dim": "-1", "epsilon": "0.0"}},
    ),
    (
        Layernorm7,
