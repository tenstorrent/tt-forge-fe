...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {"model_names": ["pt_qwen_v2_qwen_qwen2_5_1_5b_instruct_clm_hf"], "pcc": 0.99, "args": {"dim": "2"}},
    ),
    (
        Unsqueeze0,
        [((408,), torch.bfloat16)],
    ...
    (
        ...
        [((352,), torch.float32)],
        {
            "model_names": ["pd_densenet_121_img_cls_paddlemodels", "onnx_efficientnet_efficientnet_b2_img_cls_timm"],
            "pcc": 0.99,
            "args": {"dim": "1"},
        },
    ),
    ...
    (
        Unsqueeze0,
        [((136,), torch.float32)],
        {"model_names": ["onnx_efficientnet_efficientnet_b3_img_cls_timm"], "pcc": 0.99, "args": {"dim": "1"}},
    ),
    (
        Unsqueeze0,
        [((136, 1), torch.float32)],
    ...
    (
        ...
        {"model_names": ["pt_falcon3_tiiuae_falcon3_1b_base_clm_hf"], "pcc": 0.99, "args": {"dim": "2"}},
    ),
    (
        Unsqueeze0,
