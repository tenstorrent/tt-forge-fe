...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {"model_names": ["pt_llama3_meta_llama_llama_3_2_1b_instruct_clm_hf"], "pcc": 0.99, "args": {"dim": "2"}},
    ),
    (
        Unsqueeze0,
        [((1, 256), torch.float32)],
    ...
    (
        Unsqueeze0,
        [((34,), torch.float32)],
        {"model_names": ["onnx_efficientnet_efficientnet_b3a_img_cls_timm"], "pcc": 0.99, "args": {"dim": "1"}},
    ),
    (
        Unsqueeze0,
        [((34, 1), torch.float32)],
