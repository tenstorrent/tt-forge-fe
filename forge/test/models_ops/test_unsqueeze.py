...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        [((4096,), torch.float32)],
        {
            "model_names": ["pt_mamba_state_spaces_mamba_1_4b_hf_clm_hf", "pt_vgg_vgg19_bn_obj_det_timm"],
            "pcc": 0.99,
            "args": {"dim": "1"},
        },
    ),
    ...
    (
        Unsqueeze0,
        [((42,), torch.float32)],
        {"model_names": ["pt_regnet_facebook_regnet_y_080_img_cls_hf"], "pcc": 0.99, "args": {"dim": "1"}},
    ),
    (
        Unsqueeze0,
        [((42, 1), torch.float32)],
