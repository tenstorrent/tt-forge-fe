...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {"model_names": ["pt_qwen_v2_qwen_qwen2_5_math_7b_clm_hf"], "pcc": 0.99, "args": {"dim": "2"}},
    ),
    (
        Unsqueeze0,
        [((1, 38), torch.int64)],
    ...
    (
        Unsqueeze2,
        [((1, 1, 150), torch.int64)],
        {"model_names": ["pt_nanogpt_financialsupport_nanogpt_text_gen_hf"], "pcc": 0.99, "args": {"dim": "2"}},
    ),
    (
        Unsqueeze1,
    ...
    (
        ...
        [((44,), torch.float32)],
        {
            "model_names": ["onnx_efficientnet_efficientnet_b5_img_cls_timm", "onnx_hrnet_hrnetv2_w44_img_cls_osmr"],
            "pcc": 0.99,
            "args": {"dim": "1"},
        },
    ),
    ...
    (
        ...
        {"model_names": ["pt_llama3_meta_llama_llama_3_2_1b_instruct_clm_hf"], "pcc": 0.99, "args": {"dim": "1"}},
    ),
    (
        Unsqueeze1,
    ...
    (
        Unsqueeze2,
        [((1, 1, 32), torch.int64)],
        {"model_names": ["pt_bloom_bigscience_bloom_1b1_clm_hf"], "pcc": 0.99, "args": {"dim": "2"}},
    ),
    (
        Unsqueeze0,
