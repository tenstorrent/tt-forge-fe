...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {
            "model_names": ["onnx_segformer_nvidia_mit_b2_img_cls_hf", "onnx_vovnet_vovnet27s_obj_det_osmr"],
            "pcc": 0.99,
            "args": {"dim0": "-2", "dim1": "-1"},
        },
    ),
    ...
    (
        ...
        {
            "model_names": ["pt_llama3_meta_llama_llama_3_1_8b_instruct_clm_hf"],
            "pcc": 0.99,
            "args": {"dim0": "-2", "dim1": "-1"},
        },
    ),
    ...
    (
        ...
        {
            "model_names": ["pt_ministral_mistralai_ministral_8b_instruct_2410_clm_hf", "pt_fuyu_adept_fuyu_8b_qa_hf"],
            "pcc": 0.99,
            "args": {"dim0": "-2", "dim1": "-1"},
        },
    ),
    ...
    (
        ...
        [((1, 32, 256, 96), torch.float32)],
        {
            "model_names": ["pt_phi3_5_microsoft_phi_3_5_mini_instruct_clm_hf"],
            "pcc": 0.99,
            "args": {"dim0": "-2", "dim1": "-1"},
        },
    ),
    ...
    (
        ...
        [((3584, 3584), torch.float32)],
        {
            "model_names": [
                ...
                "pt_qwen_v2_qwen_qwen2_5_7b_instruct_clm_hf",
                "pt_qwen_v2_qwen_qwen2_5_math_7b_clm_hf",
    ...
    (
        Transpose0,
        [((1, 38, 28, 128), torch.float32)],
        {"model_names": ["pt_qwen_v2_qwen_qwen2_5_math_7b_clm_hf"], "pcc": 0.99, "args": {"dim0": "-3", "dim1": "-2"}},
    ),
    (
        Transpose1,
        [((1, 64, 38), torch.float32)],
        {"model_names": ["pt_qwen_v2_qwen_qwen2_5_math_7b_clm_hf"], "pcc": 0.99, "args": {"dim0": "-2", "dim1": "-1"}},
    ),
    (
        Transpose0,
        [((1, 38, 4, 128), torch.float32)],
        {"model_names": ["pt_qwen_v2_qwen_qwen2_5_math_7b_clm_hf"], "pcc": 0.99, "args": {"dim0": "-3", "dim1": "-2"}},
    ),
    (
        Transpose1,
        [((28, 38, 128), torch.float32)],
        {"model_names": ["pt_qwen_v2_qwen_qwen2_5_math_7b_clm_hf"], "pcc": 0.99, "args": {"dim0": "-2", "dim1": "-1"}},
    ),
    (
        Transpose0,
    ...
    (
        ...
        {
            "model_names": ["pt_nbeats_trend_basis_clm_hf", "pt_swin_swin_v2_b_img_cls_torchvision"],
            "pcc": 0.99,
            "args": {"dim0": "-2", "dim1": "-1"},
        },
    ),
    ...
    (
        ...
        {
            "model_names": ["pt_swin_swin_v2_b_img_cls_torchvision", "pt_falcon3_tiiuae_falcon3_1b_base_clm_hf"],
            "pcc": 0.99,
            "args": {"dim0": "-2", "dim1": "-1"},
        },
    ),
    ...
    (
        ...
        {
            "model_names": ["pt_yolo_world_default_obj_det_github", "pt_mlp_mixer_base_img_cls_github"],
            "pcc": 0.99,
            "default_df_override": "Float16_b",
            "args": {"dim0": "-2", "dim1": "-1"},
        },
    ...
    (
        ...
        {
            "model_names": ["pt_phi1_microsoft_phi_1_clm_hf", "pt_opt_facebook_opt_1_3b_clm_hf"],
            "pcc": 0.99,
            "args": {"dim0": "-3", "dim1": "-2"},
        },
    ),
    ...
    pytest.param(
        ...
        marks=[
            pytest.mark.xfail(
                reason="RuntimeError: TT_THROW @ /proj_sw/user_dev/pchandrasekaran/Forge2/tt-forge-fe/third_party/tt-mlir/third_party/tt-metal/src/tt-metal/tt_metal/impl/allocator/bank_manager.cpp:141: tt::exception info: Out of Memory: Not enough space to allocate 4294967296 B DRAM buffer across 12 banks, where each bank needs to store 357916672 B"
            )
        ],
    ),
    (
