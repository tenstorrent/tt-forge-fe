...
class Concatenate31(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("concatenate31_const_1", shape=(1, 5880, 1), dtype=torch.bfloat16)

    def forward(self, concatenate_input_0, concatenate_input_2):
        concatenate_output_1 = forge.op.Concatenate(
            "", concatenate_input_0, self.get_constant("concatenate31_const_1"), concatenate_input_2, axis=-1
        )
        return concatenate_output_1
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {"model_names": ["pt_phi_1_5_microsoft_phi_1_5_seq_cls_hf"], "pcc": 0.99, "args": {"axis": "-1"}},
    ),
    (
        Concatenate6,
    ...
    (
        ...
        {"model_names": ["pt_yolo_v5_yolov5n_img_cls_torchhub_480x480"], "pcc": 0.99, "args": {"axis": "-2"}},
    ),
    (
        Concatenate2,
        [
    ...
    (
        ...
        {"model_names": ["pt_phi2_microsoft_phi_2_pytdml_seq_cls_hf"], "pcc": 0.99, "args": {"axis": "-1"}},
    ),
    (
        Concatenate6,
    ...
    (
        ...
        {"model_names": ["pt_swin_swin_v2_t_img_cls_torchvision"], "pcc": 0.99, "args": {"axis": "-3"}},
    ),
    (
        Concatenate7,
        [((1, 64, 60, 96), torch.float32), ((1, 64, 4, 96), torch.float32)],
        {"model_names": ["pt_swin_swin_v2_t_img_cls_torchvision"], "pcc": 0.99, "args": {"axis": "-2"}},
    ),
    (
        Concatenate0,
    ...
    (
        ...
        {"model_names": ["pt_swin_swin_v2_t_img_cls_torchvision"], "pcc": 0.99, "args": {"axis": "-1"}},
    ),
    (
        Concatenate0,
    ...
    (
        ...
        {"model_names": ["pt_codegen_salesforce_codegen_350m_nl_clm_hf"], "pcc": 0.99, "args": {"axis": "-2"}},
    ),
    (
        Concatenate6,
    ...
    (
        ...
        {
            "model_names": ["pt_dla_dla60_visual_bb_torchvision"],
            "pcc": 0.99,
            "default_df_override": "Float16_b",
            "args": {"axis": "-3"},
        },
    ...
    (
        ...
        {"model_names": ["pt_phi1_microsoft_phi_1_token_cls_hf"], "pcc": 0.99, "args": {"axis": "-1"}},
    ),
    (
        Concatenate6,
