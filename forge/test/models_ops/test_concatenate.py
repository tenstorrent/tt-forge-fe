...
class Concatenate0(ForgeModule):
    ...
    def forward(self, concatenate_input_1):
        concatenate_output_1 = forge.op.Concatenate(
            "", self.get_parameter("concatenate0.weight_0"), concatenate_input_1, axis=-2
        )
...
class Concatenate43(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("concatenate43_const_1", shape=(1, 3025, 258), dtype=torch.bfloat16)

    def forward(self, concatenate_input_0):
        concatenate_output_1 = forge.op.Concatenate(
            "", concatenate_input_0, self.get_constant("concatenate43_const_1"), axis=-1
        )
        return concatenate_output_1
...
class Concatenate44(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("concatenate44_const_1", shape=(1, 50176, 258), dtype=torch.bfloat16)

    def forward(self, concatenate_input_0):
        concatenate_output_1 = forge.op.Concatenate(
            "", concatenate_input_0, self.get_constant("concatenate44_const_1"), axis=-1
        )
        return concatenate_output_1
...
class Concatenate49(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("concatenate49_const_1", shape=(1, 5880, 1), dtype=torch.bfloat16)

    def forward(self, concatenate_input_0, concatenate_input_2):
        concatenate_output_1 = forge.op.Concatenate(
            "", concatenate_input_0, self.get_constant("concatenate49_const_1"), concatenate_input_2, axis=-1
        )
        return concatenate_output_1
...
class Concatenate50(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "concatenate50.weight_0",
            forge.Parameter(*(1, 1, 384), requires_grad=True, dev_data_format=forge.DataFormat.Float32),
        )

    def forward(self, concatenate_input_1):
        concatenate_output_1 = forge.op.Concatenate(
            "", self.get_parameter("concatenate50.weight_0"), concatenate_input_1, axis=-2
        )
        return concatenate_output_1
...
class Concatenate51(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "concatenate51.weight_0",
            forge.Parameter(*(1, 1, 768), requires_grad=True, dev_data_format=forge.DataFormat.Float32),
        )

    def forward(self, concatenate_input_1):
        concatenate_output_1 = forge.op.Concatenate(
            "", self.get_parameter("concatenate51.weight_0"), concatenate_input_1, axis=-2
        )
        return concatenate_output_1
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        Concatenate1,
        [((1, 24, 128, 64), torch.float32), ((1, 24, 128, 64), torch.float32)],
        {
            "model_names": [
                "pt_llama3_meta_llama_llama_3_2_3b_clm_hf",
                "pt_llama3_meta_llama_llama_3_2_3b_instruct_clm_hf",
    ...
    (
        Concatenate1,
        [((1, 38, 64), torch.float32), ((1, 38, 64), torch.float32)],
        {"model_names": ["pt_qwen_v2_qwen_qwen2_5_math_7b_clm_hf"], "pcc": 0.99, "args": {"axis": "-1"}},
    ),
    (
        Concatenate1,
        [((1, 28, 38, 64), torch.float32), ((1, 28, 38, 64), torch.float32)],
        {"model_names": ["pt_qwen_v2_qwen_qwen2_5_math_7b_clm_hf"], "pcc": 0.99, "args": {"axis": "-1"}},
    ),
    (
        Concatenate1,
        [((1, 4, 38, 64), torch.float32), ((1, 4, 38, 64), torch.float32)],
        {"model_names": ["pt_qwen_v2_qwen_qwen2_5_math_7b_clm_hf"], "pcc": 0.99, "args": {"axis": "-1"}},
    ),
    (
        Concatenate1,
    ...
    (
        ...
        {
            "model_names": ["pt_yolov10_yolov10n_obj_det_github", "pt_yolov9_default_obj_det_github"],
            "pcc": 0.99,
            "default_df_override": "Float16_b",
            "args": {"axis": "-3"},
        },
    ...
    (
        ...
        {
            "model_names": ["pt_yolox_yolox_s_obj_det_torchhub", "pt_yolov9_default_obj_det_github"],
            "pcc": 0.99,
            "default_df_override": "Float16_b",
            "args": {"axis": "-3"},
        },
    ...
    (
        Concatenate1,
        [((1, 32, 128, 32), torch.float32), ((1, 32, 128, 32), torch.float32)],
        {
            "model_names": [
    ...
    (
        Concatenate1,
        [((1, 8, 128, 32), torch.float32), ((1, 8, 128, 32), torch.float32)],
        {
            "model_names": [
                "onnx_llama3_meta_llama_llama_3_2_1b_clm_hf",
                "onnx_llama3_meta_llama_llama_3_2_1b_instruct_clm_hf",
    ...
    (
        ...
        {"model_names": ["pt_phi1_microsoft_phi_1_clm_hf"], "pcc": 0.99, "args": {"axis": "-1"}},
    ),
    (
        Concatenate7,
    ...
    (
        ...
        {
            "model_names": ["pt_yolov9_default_obj_det_github", "pt_yolox_yolox_darknet_obj_det_torchhub"],
            "pcc": 0.99,
            "default_df_override": "Float16_b",
            "args": {"axis": "-3"},
        },
    ...
    (
        Concatenate1,
        [((1, 128, 32), torch.float32), ((1, 128, 32), torch.float32)],
        {"model_names": ["pt_llama3_meta_llama_llama_3_2_1b_instruct_clm_hf"], "pcc": 0.99, "args": {"axis": "-1"}},
    ),
    (
        Concatenate8,
