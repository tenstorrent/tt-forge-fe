...
class Concatenate47(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("concatenate47_const_1", shape=(1, 50176, 258), dtype=torch.bfloat16)

    def forward(self, concatenate_input_0):
        concatenate_output_1 = forge.op.Concatenate(
            "", concatenate_input_0, self.get_constant("concatenate47_const_1"), axis=-1
        )
        return concatenate_output_1
