...
class Less0(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less0_const_1", shape=(1, 256, 10, 32), dtype=torch.bfloat16)
...
class Less1(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less1_const_1", shape=(1, 256, 20, 64), dtype=torch.bfloat16)
...
class Less2(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less2_const_1", shape=(1, 128, 20, 64), dtype=torch.bfloat16)
...
class Less3(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less3_const_1", shape=(1, 128, 40, 128), dtype=torch.bfloat16)
...
class Less4(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less4_const_1", shape=(1, 64, 40, 128), dtype=torch.bfloat16)
...
class Less5(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less5_const_1", shape=(1, 64, 80, 256), dtype=torch.bfloat16)
...
class Less6(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less6_const_1", shape=(1, 32, 80, 256), dtype=torch.bfloat16)
...
class Less7(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less7_const_1", shape=(1, 32, 160, 512), dtype=torch.bfloat16)
...
class Less8(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less8_const_1", shape=(1, 16, 160, 512), dtype=torch.bfloat16)
...
class Less9(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less9_const_1", shape=(1, 16, 320, 1024), dtype=torch.bfloat16)
...
class Less10(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less10_const_1", shape=(1, 256, 6, 20), dtype=torch.bfloat16)
...
class Less11(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less11_const_1", shape=(1, 256, 12, 40), dtype=torch.bfloat16)
...
class Less12(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less12_const_1", shape=(1, 128, 12, 40), dtype=torch.bfloat16)
...
class Less13(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less13_const_1", shape=(1, 128, 24, 80), dtype=torch.bfloat16)
...
class Less14(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less14_const_1", shape=(1, 64, 24, 80), dtype=torch.bfloat16)
...
class Less15(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less15_const_1", shape=(1, 64, 48, 160), dtype=torch.bfloat16)
...
class Less16(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less16_const_1", shape=(1, 32, 48, 160), dtype=torch.bfloat16)
...
class Less17(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less17_const_1", shape=(1, 32, 96, 320), dtype=torch.bfloat16)
...
class Less18(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less18_const_1", shape=(1, 16, 96, 320), dtype=torch.bfloat16)
...
class Less19(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("less19_const_1", shape=(1, 16, 192, 640), dtype=torch.bfloat16)
