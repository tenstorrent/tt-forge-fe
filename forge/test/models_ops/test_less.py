...
forge_modules_and_shapes_dtypes_list = [
    (Less0, [((1, 256, 10, 32), torch.float32)]),
    (Less1, [((1, 256, 20, 64), torch.float32)]),
    (Less2, [((1, 128, 20, 64), torch.float32)]),
    (Less3, [((1, 128, 40, 128), torch.float32)]),
    (Less4, [((1, 64, 40, 128), torch.float32)]),
    (Less5, [((1, 64, 80, 256), torch.float32)]),
    (Less6, [((1, 32, 80, 256), torch.float32)]),
    (Less7, [((1, 32, 160, 512), torch.float32)]),
    (Less8, [((1, 16, 160, 512), torch.float32)]),
    (Less9, [((1, 16, 320, 1024), torch.float32)]),
    (Less10, [((1, 256, 6, 20), torch.float32)]),
    (Less11, [((1, 256, 12, 40), torch.float32)]),
    (Less12, [((1, 128, 12, 40), torch.float32)]),
    (Less13, [((1, 128, 24, 80), torch.float32)]),
    (Less14, [((1, 64, 24, 80), torch.float32)]),
    (Less15, [((1, 64, 48, 160), torch.float32)]),
    (Less16, [((1, 32, 48, 160), torch.float32)]),
    (Less17, [((1, 32, 96, 320), torch.float32)]),
    (Less18, [((1, 16, 96, 320), torch.float32)]),
    (Less19, [((1, 16, 192, 640), torch.float32)]),
]
