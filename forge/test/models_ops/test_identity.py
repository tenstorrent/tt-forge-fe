...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Identity0, [((1, 14, 128), torch.float32)], {"model_names": ["pt_albert_squad2_qa_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 14, 35, 35), torch.float32)], {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (
        ...
        {
            "model_names": ["pt_swin_swin_b_img_cls_torchvision", "pt_mlp_mixer_mixer_l32_224_img_cls_timm"],
            "pcc": 0.99,
            "default_df_override": "Float16_b",
        },
    ),
    ...
    (Identity0, [((1, 12, 29, 29), torch.float32)], {"model_names": ["pt_qwen_v2_1_5b_clm_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 16, 6, 6), torch.float32)], {"model_names": ["pt_qwen1_5_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (
        ...
        {"model_names": ["pt_squeezebert_squeezebert_mnli_seq_cls_hf"], "pcc": 0.99},
    ),
    (
        Identity0,
    ...
    (Identity0, [((1, 32, 1536), torch.float32)], {"model_names": ["pt_bloom_default_clm_hf"], "pcc": 0.99}),
    (Identity0, [((1, 5, 768), torch.float32)], {"model_names": ["pt_gptneo_gpt_neo_125m_seq_cls_hf"], "pcc": 0.99}),
    (Identity0, [((1, 12, 5, 5), torch.float32)], {"model_names": ["pt_gptneo_gpt_neo_125m_seq_cls_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (
        ...
        {"model_names": ["pt_xglm_xglm_1_7b_clm_hf", "pt_xglm_xglm_564m_clm_hf"], "pcc": 0.99},
    ),
    (Identity0, [((1, 256, 8192), torch.float32)], {"model_names": ["pt_xglm_xglm_1_7b_clm_hf"], "pcc": 0.99}),
    (
        Identity0,
        [((1, 512, 1, 1), torch.bfloat16)],
        {"model_names": ["pt_dla_dla34_in1k_img_cls_timm"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Identity0,
    ...
    (Identity0, [((1, 9, 128), torch.float32)], {"model_names": ["pt_albert_imdb_seq_cls_hf"], "pcc": 0.99}),
    (Identity0, [((256, 1024), torch.float32)], {"model_names": ["pt_opt_facebook_opt_350m_clm_hf"], "pcc": 0.99}),
    (Identity0, [((1, 12, 35, 35), torch.float32)], {"model_names": ["pt_qwen_coder_1_5b_clm_hf"], "pcc": 0.99}),
    (Identity0, [((1, 1, 1024), torch.float32)], {"model_names": ["pt_stereo_small_music_generation_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 1, 4096), torch.float32)], {"model_names": ["pt_stereo_small_music_generation_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 16, 29, 29), torch.float32)], {"model_names": ["pt_qwen1_5_0_5b_chat_clm_hf"], "pcc": 0.99}),
    (Identity0, [((1, 14, 39, 39), torch.float32)], {"model_names": ["pt_qwen_v2_0_5b_instruct_clm_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 16, 577, 577), torch.float32)], {"model_names": ["pt_llava_1_5_7b_cond_gen_hf"], "pcc": 0.99}),
    (Identity0, [((1, 32, 596, 596), torch.float32)], {"model_names": ["pt_llava_1_5_7b_cond_gen_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 1, 2048), torch.float32)], {"model_names": ["pt_stereo_large_music_generation_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 1, 8192), torch.float32)], {"model_names": ["pt_stereo_large_music_generation_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 20, 256, 256), torch.float32)], {"model_names": ["pt_gptneo_gpt_neo_2_7b_clm_hf"], "pcc": 0.99}),
    (Identity0, [((1, 5, 2560), torch.float32)], {"model_names": ["pt_gptneo_gpt_neo_2_7b_seq_cls_hf"], "pcc": 0.99}),
    (Identity0, [((1, 20, 5, 5), torch.float32)], {"model_names": ["pt_gptneo_gpt_neo_2_7b_seq_cls_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 40, 5, 5), torch.float32)], {"model_names": ["pt_phi4_microsoft_phi_4_seq_cls_hf"], "pcc": 0.99}),
    (Identity0, [((1, 5, 5120), torch.float32)], {"model_names": ["pt_phi4_microsoft_phi_4_seq_cls_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 32, 128, 128), torch.float32)], {"model_names": ["pt_qwen_v3_4b_clm_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 513, 4096), torch.float32)], {"model_names": ["pt_t5_t5_large_text_gen_hf"], "pcc": 0.99}),
    (
        Identity0,
