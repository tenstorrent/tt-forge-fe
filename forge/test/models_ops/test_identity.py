...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Identity0, [((1, 128, 2048), torch.float32)], {"model_names": ["pt_albert_xlarge_v1_mlm_hf"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 7, 2048), torch.float32)], {"model_names": ["pt_phi1_microsoft_phi_1_clm_hf"], "pcc": 0.99}),
    (Identity0, [((1, 32, 7, 7), torch.float32)], {"model_names": ["pt_phi1_microsoft_phi_1_clm_hf"], "pcc": 0.99}),
    (
        Identity0,
