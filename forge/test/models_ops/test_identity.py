...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {"model_name": ["pt_t5_google_flan_t5_base_text_gen_hf", "pt_t5_t5_small_text_gen_hf"], "pcc": 0.99},
    ),
    (
        Identity0,
    ...
    (Identity0, [((1, 512, 1, 1), torch.float32)], {"model_name": ["pt_dla_dla34_in1k_img_cls_timm"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 64, 12, 12), torch.float32)], {"model_name": ["pt_mnist_base_img_cls_github"], "pcc": 0.99}),
    (Identity0, [((1, 128), torch.float32)], {"model_name": ["pt_mnist_base_img_cls_github"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((64, 49, 128), torch.float32)], {"model_name": ["pt_swin_swin_b_img_cls_torchvision"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((16, 49, 256), torch.float32)], {"model_name": ["pt_swin_swin_b_img_cls_torchvision"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((4, 49, 512), torch.float32)], {"model_name": ["pt_swin_swin_b_img_cls_torchvision"], "pcc": 0.99}),
    (
        Identity0,
    ...
    (Identity0, [((1, 49, 1024), torch.float32)], {"model_name": ["pt_swin_swin_b_img_cls_torchvision"], "pcc": 0.99}),
    (
        Identity0,
...
def test_module(forge_module_and_shapes_dtypes, forge_property_recorder):
    forge_property_recorder("tags.op_name", "Identity")
