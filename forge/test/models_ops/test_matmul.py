...
class Matmul6(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul6_const_1", shape=(1, 1, 7), dtype=torch.float32)

    def forward(self, matmul_input_0):
        matmul_output_1 = forge.op.Matmul("", matmul_input_0, self.get_constant("matmul6_const_1"))
        return matmul_output_1
...
class Matmul7(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul7_const_1", shape=(1, 1, 29), dtype=torch.float32)
...
class Matmul8(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "matmul8.weight_1", forge.Parameter(*(64, 64), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Matmul29(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul29_const_1", shape=(1, 1, 588), dtype=torch.float32)
...
class Matmul30(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul30_const_1", shape=(12, 24), dtype=torch.float32)
...
class Matmul31(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul31_const_1", shape=(12, 72), dtype=torch.float32)
...
class Matmul33(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul33_const_1", shape=(1, 1, 39), dtype=torch.float32)
...
class Matmul82(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul82_const_0", shape=(80, 512), dtype=torch.bfloat16)

    def forward(self, matmul_input_1):
        matmul_output_1 = forge.op.Matmul("", self.get_constant("matmul82_const_0"), matmul_input_1)
        return matmul_output_1
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Matmul24, [((256, 768), torch.float32)], {"model_names": ["pt_gpt_gpt2_text_gen_hf"], "pcc": 0.99}),
    (Matmul25, [((256, 768), torch.float32)], {"model_names": ["pt_gpt_gpt2_text_gen_hf"], "pcc": 0.99}),
    (Matmul26, [((256, 3072), torch.float32)], {"model_names": ["pt_gpt_gpt2_text_gen_hf"], "pcc": 0.99}),
    (
        Matmul2,
        [((1, 256, 768), torch.float32), ((768, 50257), torch.float32)],
        {"model_names": ["pt_gpt_gpt2_text_gen_hf", "pt_gptneo_eleutherai_gpt_neo_125m_clm_hf"], "pcc": 0.99},
    ),
    (
        Matmul2,
    ...
    (Matmul30, [((1024, 12), torch.float32)], {"model_names": ["pt_nbeats_seasionality_basis_clm_hf"], "pcc": 0.99}),
    (Matmul31, [((1024, 12), torch.float32)], {"model_names": ["pt_nbeats_seasionality_basis_clm_hf"], "pcc": 0.99}),
    (
        Matmul2,
    ...
    (Matmul7, [((1, 64, 1), torch.float32)], {"model_names": ["pt_qwen_v2_qwen_qwen2_5_1_5b_clm_hf"], "pcc": 0.99}),
    (
        Matmul2,
    ...
    (
        ...
        {"model_names": ["onnx_resnet_50_img_cls_hf"], "pcc": 0.99},
    ),
    (
        Matmul34,
        [((5, 256), torch.float32)],
    ...
    (
        ...
        {
            "model_names": ["pd_googlenet_base_img_cls_paddlemodels", "pd_densenet_121_img_cls_paddlemodels"],
            "pcc": 0.99,
        },
    ),
    ...
    (Matmul24, [((1, 11, 768), torch.float32)], {"model_names": ["pd_roberta_rbt4_ch_clm_padlenlp"], "pcc": 0.99}),
    (
        Matmul2,
    ...
    (Matmul49, [((1, 32, 1), torch.float32)], {"model_names": ["pt_qwen1_5_qwen_qwen1_5_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Matmul2,
    ...
    (Matmul24, [((10, 768), torch.float32)], {"model_names": ["pd_bert_bert_base_japanese_mlm_padlenlp"], "pcc": 0.99}),
    (
        Matmul2,
    ...
    (
        ...
        {"model_names": ["pt_alexnet_base_img_cls_osmr"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Matmul2,
    ...
    (
        ...
        {"model_names": ["onnx_efficientnet_efficientnet_b3_img_cls_timm"], "pcc": 0.99},
    ),
    (
        Matmul54,
    ...
    (
        ...
        {"model_names": ["pt_albert_large_v2_mlm_hf"], "pcc": 0.99},
    ),
    (
        Matmul2,
    ...
    (
        ...
        {
            "model_names": ["pt_llama3_meta_llama_llama_3_2_1b_clm_hf", "pt_swin_swin_v2_b_img_cls_torchvision"],
            "pcc": 0.99,
        },
    ),
    (
    ...
    (
        ...
        {"model_names": ["pt_swin_swin_v2_s_img_cls_torchvision"], "pcc": 0.99},
    ),
    (
        Matmul2,
    ...
    (
        Matmul2,
        [((1445, 192), torch.bfloat16), ((192, 192), torch.bfloat16)],
        {"model_names": ["pt_yolos_hustvl_yolos_tiny_obj_det_hf"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Matmul2,
        [((3, 1445, 64), torch.bfloat16), ((3, 64, 1445), torch.bfloat16)],
        {"model_names": ["pt_yolos_hustvl_yolos_tiny_obj_det_hf"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Matmul2,
        [((3, 1445, 1445), torch.bfloat16), ((3, 1445, 64), torch.bfloat16)],
        {"model_names": ["pt_yolos_hustvl_yolos_tiny_obj_det_hf"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Matmul2,
        [((1, 1445, 192), torch.bfloat16), ((192, 768), torch.bfloat16)],
        {"model_names": ["pt_yolos_hustvl_yolos_tiny_obj_det_hf"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Matmul2,
        [((1, 1445, 768), torch.bfloat16), ((768, 192), torch.bfloat16)],
        {"model_names": ["pt_yolos_hustvl_yolos_tiny_obj_det_hf"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Matmul2,
        [((100, 192), torch.bfloat16), ((192, 192), torch.bfloat16)],
        {"model_names": ["pt_yolos_hustvl_yolos_tiny_obj_det_hf"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Matmul2,
        [((1, 100, 192), torch.bfloat16), ((192, 192), torch.bfloat16)],
        {"model_names": ["pt_yolos_hustvl_yolos_tiny_obj_det_hf"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Matmul2,
        [((1, 100, 192), torch.bfloat16), ((192, 92), torch.bfloat16)],
        {"model_names": ["pt_yolos_hustvl_yolos_tiny_obj_det_hf"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Matmul2,
        [((1, 100, 192), torch.bfloat16), ((192, 4), torch.bfloat16)],
        {"model_names": ["pt_yolos_hustvl_yolos_tiny_obj_det_hf"], "pcc": 0.99, "default_df_override": "Float16_b"},
    ),
    (
        Matmul2,
    ...
    (Matmul86, [((1, 9216), torch.float32)], {"model_names": ["pd_alexnet_base_img_cls_paddlemodels"], "pcc": 0.99}),
    (Matmul87, [((1, 4096), torch.float32)], {"model_names": ["pd_alexnet_base_img_cls_paddlemodels"], "pcc": 0.99}),
    (Matmul88, [((1, 4096), torch.float32)], {"model_names": ["pd_alexnet_base_img_cls_paddlemodels"], "pcc": 0.99}),
    (
        Matmul2,
