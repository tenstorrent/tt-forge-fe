...
class Matmul1(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul1_const_1", shape=(1, 1, 588), dtype=torch.float32)
...
class Matmul2(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul2_const_1", shape=(1, 1, 39), dtype=torch.float32)
...
class Matmul3(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul3_const_1", shape=(1, 1, 596), dtype=torch.float32)
...
class Matmul4(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul4_const_1", shape=(1, 1, 10), dtype=torch.float32)
...
class Matmul5(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul5_const_1", shape=(1, 1, 6), dtype=torch.float32)
...
class Matmul6(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul6_const_1", shape=(1, 1, 334), dtype=torch.float32)
...
class Matmul7(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul7_const_1", shape=(1, 1, 7), dtype=torch.float32)
...
class Matmul8(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul8_const_1", shape=(1, 1, 207), dtype=torch.float32)
...
class Matmul9(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul9_const_1", shape=(1, 1, 107), dtype=torch.float32)
...
class Matmul13(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul13_const_1", shape=(1, 1, 4), dtype=torch.float32)
...
class Matmul14(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul14_const_1", shape=(1, 1, 256), dtype=torch.float32)
...
class Matmul15(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul15_const_1", shape=(1, 1, 32), dtype=torch.float32)
...
class Matmul16(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul16_const_1", shape=(1, 1, 128), dtype=torch.float32)
...
class Matmul17(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul17_const_1", shape=(1, 1, 12), dtype=torch.float32)
...
class Matmul18(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul18_const_1", shape=(1, 1, 11), dtype=torch.float32)
...
class Matmul19(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul19_const_1", shape=(1, 1, 5), dtype=torch.float32)
...
class Matmul20(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul20_const_1", shape=(1, 1, 13), dtype=torch.float32)
...
class Matmul21(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul21_const_1", shape=(1, 1, 29), dtype=torch.float32)
...
class Matmul22(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul22_const_1", shape=(1, 1, 35), dtype=torch.float32)
...
class Matmul23(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul23_const_1", shape=(12, 24), dtype=torch.float32)
...
class Matmul24(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul24_const_1", shape=(12, 72), dtype=torch.float32)
...
class Matmul25(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul25_const_1", shape=(4, 24), dtype=torch.float32)
...
class Matmul26(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul26_const_1", shape=(4, 72), dtype=torch.float32)
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {"model_name": ["pt_albert_xlarge_v1_token_cls_hf", "pt_albert_xlarge_v2_token_cls_hf"], "pcc": 0.99},
    ),
    (
        Matmul0,
    ...
    (Matmul6, [((1, 16, 1), torch.float32)], {"model_name": ["pt_fuyu_adept_fuyu_8b_qa_hf"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul7, [((1, 128, 1), torch.float32)], {"model_name": ["pt_gemma_google_gemma_2b_text_gen_hf"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul10, [((256, 768), torch.float32)], {"model_name": ["pt_gpt2_gpt2_text_gen_hf"], "pcc": 0.99}),
    (Matmul11, [((256, 768), torch.float32)], {"model_name": ["pt_gpt2_gpt2_text_gen_hf"], "pcc": 0.99}),
    (Matmul12, [((256, 3072), torch.float32)], {"model_name": ["pt_gpt2_gpt2_text_gen_hf"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul20, [((1, 64, 1), torch.float32)], {"model_name": ["pt_qwen_v2_qwen_qwen2_7b_token_cls_hf"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul23, [((1024, 12), torch.float32)], {"model_name": ["pt_nbeats_seasionality_basis_clm_hf"], "pcc": 0.99}),
    (Matmul24, [((1024, 12), torch.float32)], {"model_name": ["pt_nbeats_seasionality_basis_clm_hf"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul25, [((1024, 4), torch.float32)], {"model_name": ["pt_nbeats_trend_basis_clm_hf"], "pcc": 0.99}),
    (Matmul26, [((1024, 4), torch.float32)], {"model_name": ["pt_nbeats_trend_basis_clm_hf"], "pcc": 0.99}),
    (
        Matmul0,
