...
class Matmul4(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul4_const_1", shape=(1, 1, 6), dtype=torch.float32)
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Matmul1, [((256, 768), torch.float32)], {"model_name": ["pt_gpt2_gpt2_text_gen_hf"], "pcc": 0.99}),
    ...
    (Matmul4, [((1, 32, 1), torch.float32)], {"model_name": ["pt_qwen1_5_qwen_qwen1_5_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Matmul0,
...
def test_module(forge_module_and_shapes_dtypes, record_forge_property):
    record_forge_property("framework_op_name", "Matmul")
