...
forge_modules_and_shapes_dtypes_list = [
    ...
    pytest.param(
        (
            ...
            {"model_names": ["pt_efficientnet_hf_hub_timm_tf_efficientnetv2_s_in21k_img_cls_timm"], "pcc": 0.99},
        ),
        marks=[pytest.mark.xfail(reason="Data mismatch between framework output and compiled model output")],
    ),
    pytest.param(
    ...
    (Matmul24, [((128, 768), torch.float32)], {"model_names": ["onnx_bert_bert_base_uncased_mlm_hf"], "pcc": 0.99}),
    ...
    (Matmul24, [((14, 768), torch.float32)], {"model_names": ["pd_bert_bert_base_japanese_qa_padlenlp"], "pcc": 0.99}),
    (
        Matmul25,
    ...
    (
        ...
        {"model_names": ["pt_albert_large_v1_mlm_hf", "pt_albert_large_v2_mlm_hf"], "pcc": 0.99},
    ),
    (
        Matmul2,
    ...
    (
        ...
        {"model_names": ["pt_swin_swin_v2_b_img_cls_torchvision", "pt_nbeats_trend_basis_clm_hf"], "pcc": 0.99},
    ),
    (
        Matmul2,
    ...
    (
        ...
        {"model_names": ["pt_llama3_meta_llama_llama_3_1_8b_clm_hf"], "pcc": 0.99},
    ),
    (
        Matmul2,
        [((256, 4096), torch.float32), ((4096, 1024), torch.float32)],
        {"model_names": ["pt_llama3_meta_llama_llama_3_1_8b_clm_hf", "pt_opt_facebook_opt_350m_clm_hf"], "pcc": 0.99},
    ),
    (
        Matmul2,
