...
class Matmul24(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul24_const_0", shape=(1, 100, 256), dtype=torch.float32)

    def forward(self, matmul_input_1):
        matmul_output_1 = forge.op.Matmul("", self.get_constant("matmul24_const_0"), matmul_input_1)
        return matmul_output_1
...
class Matmul25(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul25_const_1", shape=(1, 1, 207), dtype=torch.float32)
...
class Matmul27(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul27_const_1", shape=(1, 1, 35), dtype=torch.float32)
...
class Matmul38(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul38_const_1", shape=(4, 24), dtype=torch.float32)
...
class Matmul39(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul39_const_1", shape=(4, 72), dtype=torch.float32)
...
class Matmul40(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul40_const_1", shape=(1, 1, 6), dtype=torch.float32)
...
class Matmul55(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul55_const_1", shape=(1, 1, 256), dtype=torch.float32)

    def forward(self, matmul_input_0):
        matmul_output_1 = forge.op.Matmul("", matmul_input_0, self.get_constant("matmul55_const_1"))
        return matmul_output_1
...
class Matmul56(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul56_const_1", shape=(1, 1, 29), dtype=torch.float32)

    def forward(self, matmul_input_0):
        matmul_output_1 = forge.op.Matmul("", matmul_input_0, self.get_constant("matmul56_const_1"))
        return matmul_output_1
...
class Matmul58(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul58_const_0", shape=(1, 48), dtype=torch.float32)

    def forward(self, matmul_input_1):
        matmul_output_1 = forge.op.Matmul("", self.get_constant("matmul58_const_0"), matmul_input_1)
        return matmul_output_1
...
class Matmul60(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul60_const_1", shape=(1, 1, 39), dtype=torch.float32)

    def forward(self, matmul_input_0):
        matmul_output_1 = forge.op.Matmul("", matmul_input_0, self.get_constant("matmul60_const_1"))
        return matmul_output_1
...
class Matmul80(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul80_const_1", shape=(1, 1, 522), dtype=torch.float32)
...
class Matmul81(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul81_const_1", shape=(1, 1, 7), dtype=torch.float32)
...
class Matmul89(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul89_const_1", shape=(1, 1, 588), dtype=torch.float32)
...
class Matmul94(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul94_const_1", shape=(12, 24), dtype=torch.float32)
...
class Matmul95(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("matmul95_const_1", shape=(12, 72), dtype=torch.float32)
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Matmul19, [((14, 768), torch.float32)], {"model_names": ["pd_bert_bert_base_japanese_qa_padlenlp"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul25, [((1, 128, 1), torch.float32)], {"model_names": ["pt_gemma_google_gemma_2_2b_it_qa_hf"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (
        ...
        {"model_names": ["pt_albert_large_v1_token_cls_hf", "pt_albert_large_v2_token_cls_hf"], "pcc": 0.99},
    ),
    (
        Matmul0,
    ...
    (Matmul38, [((1024, 4), torch.float32)], {"model_names": ["pt_nbeats_trend_basis_clm_hf"], "pcc": 0.99}),
    (Matmul39, [((1024, 4), torch.float32)], {"model_names": ["pt_nbeats_trend_basis_clm_hf"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul40, [((1, 32, 1), torch.float32)], {"model_names": ["pt_qwen1_5_qwen_qwen1_5_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul19, [((128, 768), torch.float32)], {"model_names": ["onnx_bert_bert_base_uncased_mlm_hf"], "pcc": 0.99}),
    (Matmul20, [((1, 128, 768), torch.float32)], {"model_names": ["onnx_bert_bert_base_uncased_mlm_hf"], "pcc": 0.99}),
    (Matmul21, [((1, 128, 3072), torch.float32)], {"model_names": ["onnx_bert_bert_base_uncased_mlm_hf"], "pcc": 0.99}),
    (Matmul19, [((1, 128, 768), torch.float32)], {"model_names": ["onnx_bert_bert_base_uncased_mlm_hf"], "pcc": 0.99}),
    (Matmul41, [((1, 128, 768), torch.float32)], {"model_names": ["onnx_bert_bert_base_uncased_mlm_hf"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul19, [((10, 768), torch.float32)], {"model_names": ["pd_bert_bert_base_japanese_mlm_padlenlp"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (
        ...
        {"model_names": ["pt_albert_xxlarge_v2_mlm_hf"], "pcc": 0.99},
    ),
    (
        Matmul0,
    ...
    (
        ...
        {
            "model_names": ["pt_codegen_salesforce_codegen_350m_nl_clm_hf", "pt_opt_facebook_opt_350m_clm_hf"],
            "pcc": 0.99,
        },
    ),
    (
    ...
    (Matmul69, [((1, 11, 128), torch.float32)], {"model_names": ["pd_albert_chinese_tiny_mlm_padlenlp"], "pcc": 0.99}),
    (Matmul70, [((11, 312), torch.float32)], {"model_names": ["pd_albert_chinese_tiny_mlm_padlenlp"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul71, [((1, 11, 312), torch.float32)], {"model_names": ["pd_albert_chinese_tiny_mlm_padlenlp"], "pcc": 0.99}),
    (Matmul72, [((1, 11, 1248), torch.float32)], {"model_names": ["pd_albert_chinese_tiny_mlm_padlenlp"], "pcc": 0.99}),
    (Matmul73, [((1, 11, 312), torch.float32)], {"model_names": ["pd_albert_chinese_tiny_mlm_padlenlp"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (
        ...
        {"model_names": ["pt_mobilenetv1_basic_img_cls_torchvision"], "pcc": 0.99},
    ),
    (
        Matmul0,
    ...
    (Matmul81, [((1, 16, 1), torch.float32)], {"model_names": ["pt_phi1_microsoft_phi_1_clm_hf"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul56, [((1, 64, 1), torch.float32)], {"model_names": ["pt_qwen_v2_qwen_qwen2_5_1_5b_clm_hf"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul84, [((1, 9216), torch.float32)], {"model_names": ["pd_alexnet_base_img_cls_paddlemodels"], "pcc": 0.99}),
    (Matmul85, [((1, 4096), torch.float32)], {"model_names": ["pd_alexnet_base_img_cls_paddlemodels"], "pcc": 0.99}),
    (Matmul86, [((1, 4096), torch.float32)], {"model_names": ["pd_alexnet_base_img_cls_paddlemodels"], "pcc": 0.99}),
    (Matmul87, [((1, 1152), torch.float32)], {"model_names": ["pd_googlenet_base_img_cls_paddlemodels"], "pcc": 0.99}),
    (
        Matmul88,
        [((1, 12, 120), torch.float32)],
    ...
    (
        ...
        {"model_names": ["pt_phi1_microsoft_phi_1_seq_cls_hf"], "pcc": 0.99},
    ),
    (
        Matmul0,
    ...
    (Matmul19, [((1, 11, 768), torch.float32)], {"model_names": ["pd_roberta_rbt4_ch_clm_padlenlp"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul19, [((256, 768), torch.float32)], {"model_names": ["pt_gpt_gpt2_text_gen_hf"], "pcc": 0.99}),
    (Matmul20, [((256, 768), torch.float32)], {"model_names": ["pt_gpt_gpt2_text_gen_hf"], "pcc": 0.99}),
    (Matmul21, [((256, 3072), torch.float32)], {"model_names": ["pt_gpt_gpt2_text_gen_hf"], "pcc": 0.99}),
    (
        Matmul0,
    ...
    (Matmul94, [((1024, 12), torch.float32)], {"model_names": ["pt_nbeats_seasionality_basis_clm_hf"], "pcc": 0.99}),
    (Matmul95, [((1024, 12), torch.float32)], {"model_names": ["pt_nbeats_seasionality_basis_clm_hf"], "pcc": 0.99}),
    (
        Matmul0,
