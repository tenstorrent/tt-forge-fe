...
forge_modules_and_shapes_dtypes_list = [
    (Abs0, [((2, 1, 1, 13), torch.float32)]),
    (Abs0, [((2, 1, 7, 7), torch.float32)]),
    (Abs0, [((1, 1, 256, 256), torch.float32)]),
    (Abs0, [((1, 12, 128, 128), torch.float32)]),
    (Abs0, [((1, 12, 384, 384), torch.float32)]),
    (Abs0, [((1, 1, 32, 32), torch.float32)]),
]
