...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Abs0, [((64, 3, 64, 32), torch.float32)], {"model_names": ["pt_swin_swin_v2_s_img_cls_torchvision"], "pcc": 0.99}),
    (Abs0, [((16, 6, 64, 32), torch.float32)], {"model_names": ["pt_swin_swin_v2_s_img_cls_torchvision"], "pcc": 0.99}),
    (Abs0, [((4, 12, 64, 32), torch.float32)], {"model_names": ["pt_swin_swin_v2_s_img_cls_torchvision"], "pcc": 0.99}),
    (Abs0, [((1, 24, 64, 32), torch.float32)], {"model_names": ["pt_swin_swin_v2_s_img_cls_torchvision"], "pcc": 0.99}),
]
