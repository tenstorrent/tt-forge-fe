...
class Subtract2(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract2_const_1", shape=(1,), dtype=torch.bfloat16)
...
class Subtract3(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract3_const_1", shape=(1, 256, 10, 32), dtype=torch.bfloat16)
...
class Subtract4(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract4_const_1", shape=(1, 256, 20, 64), dtype=torch.bfloat16)
...
class Subtract5(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract5_const_1", shape=(1, 128, 20, 64), dtype=torch.bfloat16)
...
class Subtract6(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract6_const_1", shape=(1, 128, 40, 128), dtype=torch.bfloat16)
...
class Subtract7(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract7_const_1", shape=(1, 64, 40, 128), dtype=torch.bfloat16)
...
class Subtract8(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract8_const_1", shape=(1, 64, 80, 256), dtype=torch.bfloat16)
...
class Subtract9(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract9_const_1", shape=(1, 32, 80, 256), dtype=torch.bfloat16)
...
class Subtract10(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract10_const_1", shape=(1, 32, 160, 512), dtype=torch.bfloat16)
...
class Subtract11(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract11_const_1", shape=(1, 16, 160, 512), dtype=torch.bfloat16)
...
class Subtract12(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract12_const_1", shape=(1, 16, 320, 1024), dtype=torch.bfloat16)
...
class Subtract13(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract13_const_1", shape=(1, 256, 6, 20), dtype=torch.bfloat16)
...
class Subtract14(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract14_const_1", shape=(1, 256, 12, 40), dtype=torch.bfloat16)
...
class Subtract15(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract15_const_1", shape=(1, 128, 12, 40), dtype=torch.bfloat16)
...
class Subtract16(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract16_const_1", shape=(1, 128, 24, 80), dtype=torch.bfloat16)
...
class Subtract17(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract17_const_1", shape=(1, 64, 24, 80), dtype=torch.bfloat16)
...
class Subtract18(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract18_const_1", shape=(1, 64, 48, 160), dtype=torch.bfloat16)
...
class Subtract19(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract19_const_1", shape=(1, 32, 48, 160), dtype=torch.bfloat16)
...
class Subtract20(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract20_const_1", shape=(1, 32, 96, 320), dtype=torch.bfloat16)
...
class Subtract21(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract21_const_1", shape=(1, 16, 96, 320), dtype=torch.bfloat16)
...
class Subtract22(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract22_const_1", shape=(1, 16, 192, 640), dtype=torch.bfloat16)
...
class Subtract23(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract23_const_0", shape=(1, 2, 8400), dtype=torch.bfloat16)

    def forward(self, subtract_input_1):
        subtract_output_1 = forge.op.Subtract("", self.get_constant("subtract23_const_0"), subtract_input_1)
        return subtract_output_1
...
class Subtract24(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract24_const_0", shape=(5880, 2), dtype=torch.bfloat16)

    def forward(self, subtract_input_1):
        subtract_output_1 = forge.op.Subtract("", self.get_constant("subtract24_const_0"), subtract_input_1)
        return subtract_output_1
...
class Subtract25(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract25_const_0", shape=(1,), dtype=torch.int32)

    def forward(self, subtract_input_1):
        subtract_output_1 = forge.op.Subtract("", self.get_constant("subtract25_const_0"), subtract_input_1)
        return subtract_output_1
...
class Subtract26(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract26_const_1", shape=(1,), dtype=torch.int64)
...
class Subtract27(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract27_const_0", shape=(1,), dtype=torch.bfloat16)
...
class Subtract28(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract28_const_0", shape=(1, 2, 8400), dtype=torch.float32)

    def forward(self, subtract_input_1):
        subtract_output_1 = forge.op.Subtract("", self.get_constant("subtract28_const_0"), subtract_input_1)
        return subtract_output_1
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Subtract25, [((1, 9), torch.int32)], {"model_names": ["pd_roberta_rbt4_ch_seq_cls_padlenlp"], "pcc": 0.99}),
    (
        Subtract1,
    ...
    (Subtract25, [((1, 11), torch.int32)], {"model_names": ["pd_roberta_rbt4_ch_clm_padlenlp"], "pcc": 0.99}),
    (
        Subtract26,
        [((1, 32), torch.int64)],
        {
