...
class Subtract1(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract1_const_1", shape=(1,), dtype=torch.float32)

    def forward(self, subtract_input_0):
        subtract_output_1 = forge.op.Subtract("", subtract_input_0, self.get_constant("subtract1_const_1"))
        return subtract_output_1
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Subtract3, [((1, 4), torch.int32)], {"model_name": ["pt_llama3_huggyllama_llama_7b_seq_cls_hf"], "pcc": 0.99}),
    (
        Subtract3,
...
def test_module(forge_module_and_shapes_dtypes, forge_property_recorder):
    forge_property_recorder("tags.op_name", "Subtract")
