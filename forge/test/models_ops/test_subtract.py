...
class Subtract3(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract3_const_1", shape=(1, 256, 10, 32), dtype=torch.float32)
...
class Subtract4(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract4_const_1", shape=(1, 256, 20, 64), dtype=torch.float32)
...
class Subtract5(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract5_const_1", shape=(1, 128, 20, 64), dtype=torch.float32)
...
class Subtract6(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract6_const_1", shape=(1, 128, 40, 128), dtype=torch.float32)
...
class Subtract7(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract7_const_1", shape=(1, 64, 40, 128), dtype=torch.float32)
...
class Subtract8(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract8_const_1", shape=(1, 64, 80, 256), dtype=torch.float32)
...
class Subtract9(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract9_const_1", shape=(1, 32, 80, 256), dtype=torch.float32)
...
class Subtract10(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract10_const_1", shape=(1, 32, 160, 512), dtype=torch.float32)
...
class Subtract11(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract11_const_1", shape=(1, 16, 160, 512), dtype=torch.float32)
...
class Subtract12(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract12_const_1", shape=(1, 16, 320, 1024), dtype=torch.float32)
...
class Subtract13(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract13_const_1", shape=(1,), dtype=torch.int64)
...
class Subtract14(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract14_const_0", shape=(5880, 2), dtype=torch.float32)

    def forward(self, subtract_input_1):
        subtract_output_1 = forge.op.Subtract("", self.get_constant("subtract14_const_0"), subtract_input_1)
        return subtract_output_1
...
class Subtract15(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract15_const_1", shape=(1,), dtype=torch.int32)
...
class Subtract26(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract26_const_0", shape=(1,), dtype=torch.int32)
...
class Subtract27(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract27_const_0", shape=(1, 2, 8400), dtype=torch.float32)
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Subtract13, [((1, 256), torch.int64)], {"model_names": ["pt_opt_facebook_opt_350m_clm_hf"], "pcc": 0.99}),
    (
        Subtract1,
    ...
    (Subtract26, [((1, 1, 7, 7), torch.int32)], {"model_names": ["pt_phi1_microsoft_phi_1_clm_hf"], "pcc": 0.99}),
    (Subtract1, [((1, 1, 7, 7), torch.float32)], {"model_names": ["pt_phi1_microsoft_phi_1_clm_hf"], "pcc": 0.99}),
    (
        Subtract0,
    ...
    (Subtract26, [((1, 11), torch.int32)], {"model_names": ["pd_roberta_rbt4_ch_clm_padlenlp"], "pcc": 0.99}),
    (
        Subtract1,
    ...
    (Subtract1, [((1, 1, 1, 256), torch.float32)], {"model_names": ["pt_gpt_gpt2_text_gen_hf"], "pcc": 0.99}),
]
