...
class Subtract2(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("subtract2_const_0", shape=(1,), dtype=torch.int32)
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Subtract2, [((1, 11), torch.int32)], {"model_names": ["pd_roberta_rbt4_ch_clm_padlenlp"], "pcc": 0.99}),
    (
        Subtract0,
    ...
    (Subtract3, [((1, 256), torch.int64)], {"model_names": ["pt_opt_facebook_opt_1_3b_clm_hf"], "pcc": 0.99}),
    (Subtract2, [((1, 1, 7, 7), torch.int32)], {"model_names": ["pt_phi_1_5_microsoft_phi_1_5_clm_hf"], "pcc": 0.99}),
    (Subtract0, [((1, 1, 7, 7), torch.float32)], {"model_names": ["pt_phi_1_5_microsoft_phi_1_5_clm_hf"], "pcc": 0.99}),
    (
        Subtract0,
    ...
    (Subtract5, [((1, 2, 8400), torch.float32)], {"model_names": ["onnx_yolov8_default_obj_det_github"], "pcc": 0.99}),
    (
        Subtract1,
