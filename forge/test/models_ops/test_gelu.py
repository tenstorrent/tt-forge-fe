...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {
            "model_names": ["pt_albert_base_v1_mlm_hf", "pt_albert_xlarge_v1_mlm_hf", "pt_albert_large_v1_mlm_hf"],
            "pcc": 0.99,
            "args": {"approximate": '"none"'},
        },
    ),
    (
        ...
        [((1, 128, 128), torch.float32)],
        {
            "model_names": ["pt_albert_base_v2_mlm_hf", "pt_albert_large_v2_mlm_hf", "pt_albert_xxlarge_v2_mlm_hf"],
            "pcc": 0.99,
            "args": {"approximate": '"tanh"'},
        },
    ),
    ...
    (
        ...
        {
            "model_names": ["pt_gptneo_eleutherai_gpt_neo_1_3b_clm_hf", "pt_phi1_microsoft_phi_1_seq_cls_hf"],
            "pcc": 0.99,
            "args": {"approximate": '"tanh"'},
        },
    ),
    ...
    (
        ...
        {"model_names": ["pt_whisper_openai_whisper_large_v3_clm_hf"], "pcc": 0.99, "args": {"approximate": '"none"'}},
    ),
    (
        Gelu0,
    ...
    (
        Gelu0,
        [((1, 1445, 768), torch.float32)],
        {"model_names": ["pt_yolos_hustvl_yolos_tiny_obj_det_hf"], "pcc": 0.99, "args": {"approximate": '"none"'}},
    ),
    (
        Gelu0,
    ...
    (
        ...
        {"model_names": ["pt_albert_xlarge_v1_mlm_hf"], "pcc": 0.99, "args": {"approximate": '"none"'}},
    ),
    (
        Gelu1,
    ...
    (
        ...
        {"model_names": ["pt_phi2_microsoft_phi_2_clm_hf"], "pcc": 0.99, "args": {"approximate": '"tanh"'}},
    ),
    (
        Gelu0,
    ...
    (
        ...
        {"model_names": ["pt_albert_xxlarge_v1_token_cls_hf"], "pcc": 0.99, "args": {"approximate": '"none"'}},
    ),
    (
        Gelu1,
        [((1, 128, 16384), torch.float32)],
    ...
    (
        ...
        {"model_names": ["pd_bert_chinese_roberta_base_mlm_padlenlp"], "pcc": 0.99, "args": {"approximate": '"none"'}},
    ),
    (
        Gelu0,
