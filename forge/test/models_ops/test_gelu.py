...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        [((1, 128, 128), torch.float32)],
        {
            "model_names": ["pt_albert_xlarge_v1_mlm_hf", "pt_albert_xxlarge_v1_mlm_hf", "pt_albert_base_v1_mlm_hf"],
            "pcc": 0.99,
            "args": {"approximate": '"none"'},
        },
    ),
    ...
    (
        ...
        {"model_names": ["pt_swin_swin_v2_s_img_cls_torchvision"], "pcc": 0.99, "args": {"approximate": '"none"'}},
    ),
    (
        Gelu0,
