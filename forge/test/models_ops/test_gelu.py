...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {
            "model_names": ["pt_albert_base_v2_mlm_hf", "pt_albert_xxlarge_v2_mlm_hf"],
            "pcc": 0.99,
            "args": {"approximate": '"tanh"'},
        },
    ),
    (
        ...
        [((1, 128, 128), torch.float32)],
        {
            "model_names": ["pt_albert_xxlarge_v1_mlm_hf", "pt_albert_large_v1_mlm_hf", "pt_albert_xlarge_v1_mlm_hf"],
            "pcc": 0.99,
            "args": {"approximate": '"none"'},
        },
    ),
    ...
    (
        Gelu1,
        [((1, 128, 16384), torch.float32)],
        {"model_names": ["pt_albert_xxlarge_v2_mlm_hf"], "pcc": 0.99, "args": {"approximate": '"tanh"'}},
    ),
    (
        Gelu0,
    ...
    (
        ...
        {"model_names": ["pt_phi_1_5_microsoft_phi_1_5_clm_hf"], "pcc": 0.99, "args": {"approximate": '"tanh"'}},
    ),
    (
        Gelu0,
    ...
    (
        ...
        {"model_names": ["pt_gptneo_eleutherai_gpt_neo_1_3b_clm_hf"], "pcc": 0.99, "args": {"approximate": '"tanh"'}},
    ),
    (
        Gelu0,
