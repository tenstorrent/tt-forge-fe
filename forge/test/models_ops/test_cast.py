...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        Cast2,
        [((1, 1, 7, 7), torch.bool)],
        {"model_names": ["pt_phi1_microsoft_phi_1_clm_hf"], "pcc": 0.99, "args": {"dtype": "torch.int32"}},
    ),
    (
        Cast0,
        [((1, 1, 7, 7), torch.bool)],
        {"model_names": ["pt_phi1_microsoft_phi_1_clm_hf"], "pcc": 0.99, "args": {"dtype": "torch.float32"}},
    ),
    (
        Cast0,
        [((1, 1, 1, 7), torch.int64)],
    ...
    (
        Cast1,
        [((1, 6, 3072), torch.bool)],
        {"model_names": ["pt_mamba_state_spaces_mamba_790m_hf_clm_hf"], "pcc": 0.99, "args": {"dtype": "torch.bool"}},
    ),
    (
        Cast1,
        [((1, 1, 7, 7), torch.float32)],
        {"model_names": ["pt_phi1_microsoft_phi_1_clm_hf"], "pcc": 0.99, "args": {"dtype": "torch.bool"}},
    ),
    (
        Cast1,
        [((1, 1, 7, 7), torch.int32)],
