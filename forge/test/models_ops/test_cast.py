...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Cast2, [((1, 128), torch.int64)], {"model_name": ["pt_distilbert_distilbert_base_uncased_mlm_hf"], "pcc": 0.99}),
    (
        Cast3,
        [((1, 128), torch.bool)],
        {
    ...
    (Cast2, [((1, 128), torch.int32)], {"model_name": ["pt_distilbert_distilbert_base_uncased_mlm_hf"], "pcc": 0.99}),
    (Cast4, [((1, 128), torch.int32)], {"model_name": ["pt_roberta_xlm_roberta_base_mlm_hf"], "pcc": 0.99}),
    (
        Cast1,
    ...
    (Cast0, [((1024, 768), torch.float32)], {"model_name": ["pt_gpt2_gpt2_text_gen_hf"], "pcc": 0.99}),
    (Cast0, [((2048, 768), torch.float32)], {"model_name": ["pt_gptneo_eleutherai_gpt_neo_125m_clm_hf"], "pcc": 0.99}),
    (Cast0, [((50272, 768), torch.float32)], {"model_name": ["pt_opt_facebook_opt_125m_clm_hf"], "pcc": 0.99}),
    (Cast0, [((2050, 768), torch.float32)], {"model_name": ["pt_opt_facebook_opt_125m_clm_hf"], "pcc": 0.99}),
    (Cast0, [((151936, 1024), torch.float32)], {"model_name": ["pt_qwen1_5_qwen_qwen1_5_0_5b_clm_hf"], "pcc": 0.99}),
    (Cast1, [((1, 6, 1024), torch.bfloat16)], {"model_name": ["pt_qwen1_5_qwen_qwen1_5_0_5b_clm_hf"], "pcc": 0.99}),
    (Cast0, [((250002, 768), torch.float32)], {"model_name": ["pt_roberta_xlm_roberta_base_mlm_hf"], "pcc": 0.99}),
    (Cast0, [((1, 768), torch.float32)], {"model_name": ["pt_roberta_xlm_roberta_base_mlm_hf"], "pcc": 0.99}),
    (Cast0, [((514, 768), torch.float32)], {"model_name": ["pt_roberta_xlm_roberta_base_mlm_hf"], "pcc": 0.99}),
    (
        Cast0,
        [((30528, 768), torch.float32)],
        {"model_name": ["pt_squeezebert_squeezebert_squeezebert_mnli_seq_cls_hf"], "pcc": 0.99},
    ),
    (Cast0, [((256008, 1024), torch.float32)], {"model_name": ["pt_xglm_facebook_xglm_564m_clm_hf"], "pcc": 0.99}),
]
...
def test_module(forge_module_and_shapes_dtypes, record_forge_property):
    record_forge_property("framework_op_name", "Cast")
