...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {
            "model_names": ["pd_ernie_1_0_seq_cls_padlenlp", "pt_albert_textattack_albert_base_v2_imdb_seq_cls_hf"],
            "pcc": 0.99,
            "args": {"dim": "-2", "start": "0", "stop": "1", "stride": "1"},
        },
    ),
    ...
    (
        ...
        {
            "model_names": ["pt_gptneo_eleutherai_gpt_neo_125m_clm_hf", "pt_gptneo_eleutherai_gpt_neo_1_3b_clm_hf"],
            "pcc": 0.99,
