...
forge_modules_and_shapes_dtypes_list = [
    (Max0, [((1, 32, 32, 32), torch.float32)]),
    (Max0, [((1, 32, 256, 256), torch.float32)]),
    (Max0, [((1, 16, 32, 32), torch.float32)]),
    (Max0, [((1, 12, 32, 32), torch.float32)]),
    (Max0, [((1, 12, 256, 256), torch.float32)]),
    (Max0, [((1, 16, 256, 256), torch.float32)]),
]
