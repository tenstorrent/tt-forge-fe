...
class Conv2Dtranspose0(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose0_const_1", shape=(64, 64, 2, 2), dtype=torch.float32)
...
class Conv2Dtranspose1(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose1_const_1", shape=(32, 32, 2, 2), dtype=torch.float32)
...
class Conv2Dtranspose2(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose2_const_1", shape=(128, 128, 2, 2), dtype=torch.float32)

    def forward(self, conv2dtranspose_input_0):
        conv2dtranspose_output_1 = forge.op.Conv2dTranspose(
            "",
            conv2dtranspose_input_0,
            self.get_constant("conv2dtranspose2_const_1"),
            stride=2,
            padding=0,
            dilation=1,
            groups=1,
...
class Conv2Dtranspose13(ForgeModule):
    def __init__(self, name):
        ...
        self.add_parameter(
            ...
            forge.Parameter(*(512, 512, 2, 2), requires_grad=True, dev_data_format=forge.DataFormat.Float32),
        )
...
class Conv2Dtranspose14(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose14_const_1", shape=(192, 192, 2, 2), dtype=torch.float32)
...
class Conv2Dtranspose15(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose15_const_1", shape=(96, 96, 2, 2), dtype=torch.float32)
