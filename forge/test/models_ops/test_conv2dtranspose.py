...
class Conv2Dtranspose6(ForgeModule):
    def __init__(self, name):
        ...
        self.add_parameter(
            ...
            forge.Parameter(*(256, 64, 2, 2), requires_grad=True, dev_data_format=forge.DataFormat.Float32),
        )
...
class Conv2Dtranspose13(ForgeModule):
    ...
    def forward(self, conv2dtranspose_input_0):
        conv2dtranspose_output_1 = forge.op.Conv2dTranspose(
            "",
            conv2dtranspose_input_0,
            self.get_parameter("conv2dtranspose13.weight_1"),
            stride=2,
            padding=0,
            dilation=1,
            groups=1,
...
class Conv2Dtranspose14(ForgeModule):
    ...
    def forward(self, conv2dtranspose_input_0):
        conv2dtranspose_output_1 = forge.op.Conv2dTranspose(
            "",
            conv2dtranspose_input_0,
            self.get_parameter("conv2dtranspose14.weight_1"),
            stride=2,
            padding=0,
            dilation=1,
            groups=1,
...
class Conv2Dtranspose15(ForgeModule):
    ...
    def forward(self, conv2dtranspose_input_0):
        conv2dtranspose_output_1 = forge.op.Conv2dTranspose(
            "",
            conv2dtranspose_input_0,
            self.get_parameter("conv2dtranspose15.weight_1"),
            stride=2,
            padding=0,
            dilation=1,
            groups=1,
...
class Conv2Dtranspose16(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose16_const_1", shape=(192, 192, 2, 2), dtype=torch.bfloat16)

    def forward(self, conv2dtranspose_input_0):
        conv2dtranspose_output_1 = forge.op.Conv2dTranspose(
            "",
            conv2dtranspose_input_0,
            self.get_constant("conv2dtranspose16_const_1"),
            stride=2,
            padding=0,
            dilation=1,
            groups=1,
...
class Conv2Dtranspose17(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose17_const_1", shape=(96, 96, 2, 2), dtype=torch.bfloat16)

    def forward(self, conv2dtranspose_input_0):
        conv2dtranspose_output_1 = forge.op.Conv2dTranspose(
            "",
            conv2dtranspose_input_0,
            self.get_constant("conv2dtranspose17_const_1"),
            stride=2,
            padding=0,
            dilation=1,
            groups=1,
...
class Conv2Dtranspose18(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose18_const_1", shape=(128, 128, 2, 2), dtype=torch.bfloat16)

    def forward(self, conv2dtranspose_input_0):
        conv2dtranspose_output_1 = forge.op.Conv2dTranspose(
            "",
            conv2dtranspose_input_0,
            self.get_constant("conv2dtranspose18_const_1"),
            stride=2,
            padding=0,
            dilation=1,
            groups=1,
...
class Conv2Dtranspose20(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose20_const_1", shape=(256, 256, 2, 2), dtype=torch.bfloat16)

    def forward(self, conv2dtranspose_input_0):
        conv2dtranspose_output_1 = forge.op.Conv2dTranspose(
            "",
            conv2dtranspose_input_0,
            self.get_constant("conv2dtranspose20_const_1"),
            stride=2,
            padding=0,
            dilation=1,
            groups=1,
...
class Conv2Dtranspose23(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "conv2dtranspose23.weight_1",
    ...
    def forward(self, conv2dtranspose_input_0):
        conv2dtranspose_output_1 = forge.op.Conv2dTranspose(
            "",
            conv2dtranspose_input_0,
            self.get_parameter("conv2dtranspose23.weight_1"),
            stride=2,
            padding=1,
            dilation=1,
            groups=256,
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (
        ...
        {
            "model_names": ["onnx_sam_facebook_sam_vit_base_img_seg_github", "onnx_unet_base_img_seg_torchhub"],
            "pcc": 0.99,
            "args": {
                "stride": "2",
                "padding": "0",
