...
class Conv2Dtranspose5(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose5_const_1", shape=(64, 64, 2, 2), dtype=torch.bfloat16)
...
class Conv2Dtranspose6(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose6_const_1", shape=(32, 32, 2, 2), dtype=torch.bfloat16)

    def forward(self, conv2dtranspose_input_0):
        conv2dtranspose_output_1 = forge.op.Conv2dTranspose(
            "",
            conv2dtranspose_input_0,
            self.get_constant("conv2dtranspose6_const_1"),
            stride=2,
            padding=0,
            dilation=1,
            groups=1,
...
class Conv2Dtranspose11(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose11_const_1", shape=(192, 192, 2, 2), dtype=torch.bfloat16)
...
class Conv2Dtranspose12(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose12_const_1", shape=(96, 96, 2, 2), dtype=torch.bfloat16)
...
class Conv2Dtranspose17(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose17_const_1", shape=(128, 128, 2, 2), dtype=torch.bfloat16)
...
class Conv2Dtranspose18(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose18_const_1", shape=(256, 256, 2, 2), dtype=torch.bfloat16)
