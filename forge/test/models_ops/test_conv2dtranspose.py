...
class Conv2Dtranspose15(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose15_const_1", shape=(192, 192, 2, 2), dtype=torch.bfloat16)
...
class Conv2Dtranspose16(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("conv2dtranspose16_const_1", shape=(96, 96, 2, 2), dtype=torch.bfloat16)
