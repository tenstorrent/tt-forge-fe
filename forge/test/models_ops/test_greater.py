...
class Greater1(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("greater1_const_1", shape=(1, 6, 2048), dtype=torch.float32)
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Greater0, [((1, 1, 7, 7), torch.float32)], {"model_names": ["pt_phi_1_5_microsoft_phi_1_5_clm_hf"], "pcc": 0.99}),
    (
        Greater1,
