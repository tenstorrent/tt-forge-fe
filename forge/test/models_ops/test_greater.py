...
class Greater11(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("greater11_const_1", shape=(1,), dtype=torch.bfloat16)
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Greater0, [((1, 1, 14, 14), torch.float32)], {"model_names": ["pt_albert_squad2_qa_hf"], "pcc": 0.99}),
    (
        Greater0,
    ...
    (Greater0, [((1, 1, 9, 9), torch.float32)], {"model_names": ["pt_albert_imdb_seq_cls_hf"], "pcc": 0.99}),
    (Greater0, [((1, 1, 39, 39), torch.float32)], {"model_names": ["pt_qwen_v2_0_5b_instruct_clm_hf"], "pcc": 0.99}),
    (
        Greater1,
