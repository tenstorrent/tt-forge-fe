...
@pytest.mark.parametrize(
    "input_shape, clamp_min, clamp_max",
    [
        ((64, 3, 64, 64), None, math.log(100.0)),
        ((11, 30, 11, 11), math.log(101.0), None),
        ((27, 16, 27, 27), -math.log(103.0), None),
        ((45, 2, 45, 45), None, 5.0),
        ((3, 21, 3, 3), None, math.log(50.0)),
        ((12, 6, 12, 12), -103.0, None),
    ],
)
@pytest.mark.push
def test_clamp(input_shape, clamp_min, clamp_max):
    ...
    compiled_model = forge.compile(
        onnx_model, inputs, verify_cfg=DepricatedVerifyConfig(verify_forge_codegen_vs_framework=True)
    )
