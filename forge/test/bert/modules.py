...
class ForgeBertMHA(ForgeModule):
...
class ForgeFeedForward(ForgeModule):
...
class ForgeFFNorm(ForgeModule):

    def __init__(self, name, parameters, config):
        super().__init__(name)
        self.parameters = parameters
        self.config = config
        self.ff = ForgeFeedForward("ff", parameters, config)
...
class ForgeBertEncoder(ForgeModule):

    def __init__(self, name, parameters, config):
        super().__init__(name)
        self.parameters = parameters
        self.config = config
        self.mha = ForgeBertMHA("mha", parameters, config)
        self.ff = ForgeFeedForward("ff", parameters, config)
...
class ForgePredictionHeadTransform(ForgeModule):
    def __init__(self, name, parameters, config):
        super().__init__(name)
        self.parameters = parameters
        self.config = config
...
class ForgePredictionHeadDecoder(ForgeModule):
    def __init__(self, name, parameters, config):
        super().__init__(name)
        self.parameters = parameters
        self.config = config
