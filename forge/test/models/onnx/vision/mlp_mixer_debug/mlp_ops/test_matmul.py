...
class Matmul0(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter("matmul0.weight_1", forge.Parameter(*(196, 384), requires_grad=True, dev_data_format=forge.DataFormat.Float32))
...
class Matmul1(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter("matmul1.weight_1", forge.Parameter(*(384, 196), requires_grad=True, dev_data_format=forge.DataFormat.Float32))
...
class Matmul2(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter("matmul2.weight_1", forge.Parameter(*(768, 3072), requires_grad=True, dev_data_format=forge.DataFormat.Float32))
...
class Matmul3(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter("matmul3.weight_1", forge.Parameter(*(3072, 768), requires_grad=True, dev_data_format=forge.DataFormat.Float32))
...
forge_modules_and_shapes_dtypes_list = [
    (Matmul0, [((1, 768, 196), torch.float32)], {'model_names': ['onnx_mlp_mixer_mixer_b16_224_goog_in21k_img_cls_timm'], 'pcc': 0.99}), 
    (Matmul1, [((1, 768, 384), torch.float32)], {'model_names': ['onnx_mlp_mixer_mixer_b16_224_goog_in21k_img_cls_timm'], 'pcc': 0.99}), 
    (Matmul2, [((1, 196, 768), torch.float32)], {'model_names': ['onnx_mlp_mixer_mixer_b16_224_goog_in21k_img_cls_timm'], 'pcc': 0.99}), 
    (Matmul3, [((1, 196, 3072), torch.float32)], {'model_names': ['onnx_mlp_mixer_mixer_b16_224_goog_in21k_img_cls_timm'], 'pcc': 0.99}), 
    (Matmul4, [((1, 768), torch.float32), ((768, 21843), torch.float32)], {'model_names': ['onnx_mlp_mixer_mixer_b16_224_goog_in21k_img_cls_timm'], 'pcc': 0.99}), 
]
