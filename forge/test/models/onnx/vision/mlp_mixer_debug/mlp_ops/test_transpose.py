...
forge_modules_and_shapes_dtypes_list = [
    (Transpose0, [((1, 768, 196), torch.float32)], {'model_names': ['onnx_mlp_mixer_mixer_b16_224_goog_in21k_img_cls_timm'], 'pcc': 0.99, 'args': {'dim0': '-2', 'dim1': '-1'}}), 
    (Transpose0, [((1, 196, 768), torch.float32)], {'model_names': ['onnx_mlp_mixer_mixer_b16_224_goog_in21k_img_cls_timm'], 'pcc': 0.99, 'args': {'dim0': '-2', 'dim1': '-1'}}), 
    (Transpose0, [((21843, 768), torch.float32)], {'model_names': ['onnx_mlp_mixer_mixer_b16_224_goog_in21k_img_cls_timm'], 'pcc': 0.99, 'args': {'dim0': '-2', 'dim1': '-1'}}), 
]
