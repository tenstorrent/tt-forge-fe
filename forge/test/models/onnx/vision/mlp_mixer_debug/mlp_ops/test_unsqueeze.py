...
forge_modules_and_shapes_dtypes_list = [
    (Unsqueeze0, [((768,), torch.float32)], {'model_names': ['onnx_mlp_mixer_mixer_b16_224_goog_in21k_img_cls_timm'], 'pcc': 0.99, 'args': {'dim': '1'}}), 
    (Unsqueeze0, [((768, 1), torch.float32)], {'model_names': ['onnx_mlp_mixer_mixer_b16_224_goog_in21k_img_cls_timm'], 'pcc': 0.99, 'args': {'dim': '1'}}), 
]
