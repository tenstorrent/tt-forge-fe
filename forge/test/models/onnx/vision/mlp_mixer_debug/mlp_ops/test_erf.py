...
forge_modules_and_shapes_dtypes_list = [
    (Erf0, [((1, 768, 384), torch.float32)], {'model_names': ['onnx_mlp_mixer_mixer_b16_224_goog_in21k_img_cls_timm'], 'pcc': 0.99}), 
    (Erf0, [((1, 196, 3072), torch.float32)], {'model_names': ['onnx_mlp_mixer_mixer_b16_224_goog_in21k_img_cls_timm'], 'pcc': 0.99}), 
]
