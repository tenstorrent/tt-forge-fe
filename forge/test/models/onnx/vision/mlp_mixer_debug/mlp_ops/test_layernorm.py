...
class Layernorm0(ForgeModule):
    ...
    def forward(self, layernorm_input_0):
        layernorm_output_1 = forge.op.Layernorm("", layernorm_input_0, self.get_constant("layernorm0_const_1"), self.get_constant("layernorm0_const_2"), dim=-1, epsilon=1e-06)
...
forge_modules_and_shapes_dtypes_list = [
    (Layernorm0, [((1, 196, 768), torch.float32)], {'model_names': ['onnx_mlp_mixer_mixer_b16_224_goog_in21k_img_cls_timm'], 'pcc': 0.99, 'args': {'dim': '-1', 'epsilon': '1e-06'}}), 
]
