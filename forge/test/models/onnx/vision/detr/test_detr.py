...
from test.models.onnx.vision.detr.utils.utils import preprocess_input_data
from test.models.utils import Framework, Source, Task, build_module_name


@pytest.mark.nightly
@pytest.mark.parametrize("variant", ["facebook/detr-resnet-50"])
@pytest.mark.skip(reason="Insufficient host DRAM to run this model (requires a bit more than 5 GB)")
...
@pytest.mark.nightly
@pytest.mark.xfail(reason="AssertionError: Only support upsample with integer scale factor")
