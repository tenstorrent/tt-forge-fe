...
def test_gliner_onnx(forge_property_recorder, variant, forge_tmp_path):
    ...
    compiled_model = forge.compile(
        onnx_model, sample_inputs=inputs, forge_property_handler=forge_property_recorder, module_name=module_name
    )
