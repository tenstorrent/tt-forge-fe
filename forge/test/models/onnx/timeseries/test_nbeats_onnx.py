...
@pytest.mark.nightly
@pytest.mark.parametrize("variant", [pytest.param("generic_basis", marks=pytest.mark.pr_models_regression)])
...
@pytest.mark.nightly
@pytest.mark.parametrize("variant", [pytest.param("trend_basis", marks=pytest.mark.pr_models_regression)])
