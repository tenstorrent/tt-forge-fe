...
forge_modules_and_shapes_dtypes_list = [
    (Cosine0, [((1, 6, 64), torch.float32)], {"model_name": ["pt_falcon", "pt_qwen_causal_lm"]}),
    (Cosine0, [((1, 334, 32), torch.float32)], {"model_name": ["pt_fuyu_8b"]}),
    (Cosine0, [((1, 7, 256), torch.float32)], {"model_name": ["pt_gemma_2b"]}),
    (
        Cosine0,
    ...
    (Cosine0, [((1, 128, 128), torch.float32)], {"model_name": ["pt_Mistral_7B_v0_1"]}),
    (Cosine0, [((1, 12, 32), torch.float32)], {"model_name": ["pt_phi_2_pytdml_token_cls", "pt_phi_2_token_cls"]}),
    (Cosine0, [((1, 256, 32), torch.float32)], {"model_name": ["pt_phi_2_causal_lm", "pt_phi_2_pytdml_causal_lm"]}),
    (Cosine0, [((1, 11, 32), torch.float32)], {"model_name": ["pt_phi_2_seq_cls", "pt_phi_2_pytdml_seq_cls"]}),
    (Cosine0, [((1, 29, 64), torch.float32)], {"model_name": ["pt_qwen_chat", "pt_Qwen_Qwen2_5_0_5B"]}),
    (
        Cosine0,
    ...
    (Cosine0, [((1, 35, 64), torch.float32)], {"model_name": ["pt_Qwen_Qwen2_5_Coder_0_5B"]}),
    (
        Cosine0,
    ...
    (Cosine0, [((1, 39, 64), torch.float32)], {"model_name": ["pt_Qwen_Qwen2_5_0_5B_Instruct"]}),
]
