...
class Add2(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("add2_const_1", shape=(1, 1, 101, 101), dtype=torch.float32)
...
class Add3(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("add3_const_1", shape=(1500, 768), dtype=torch.float32)
...
class Add4(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("add4_const_1", shape=(1500, 1500), dtype=torch.float32)
...
class Add5(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "add5.weight_1", forge.Parameter(*(3072,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Add6(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("add6_const_1", shape=(101, 1500), dtype=torch.float32)
...
forge_modules_and_shapes_dtypes_list = [
    (
        Add0,
        [((1, 101, 768), torch.float32), ((1, 101, 768), torch.float32)],
