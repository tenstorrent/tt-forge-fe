        ...
        transformer=dict(
            ...
            decoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(type="MultiheadAttention", embed_dims=_dim_, num_heads=4, dropout=0.1),
                        dict(type="CustomMSDeformableAttention", embed_dims=_dim_, num_levels=1, im2col_step=192),
                    ],
                    feedforward_channels=_ffn_dim_,
                    ffn_dropout=0.1,
                    operation_order=("self_attn", "norm", "cross_attn", "norm", "ffn", "norm"),
