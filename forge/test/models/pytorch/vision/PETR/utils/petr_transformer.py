...
class PETRTransformer(BaseModule):
    ...
    def __init__(self, encoder=None, decoder=None, init_cfg=None, cross=False):
        ...
        # logger.info("self.decoder={}",self.decoder)
        # logger.info("self.decoder.__class__={}",self.decoder.__class__)
...
class PETRMultiheadAttention(BaseModule):
    ...
    def __init__(self,
        ...
        # logger.info("Initializing nn.MultiheadAttention with the following arguments:")
        # logger.info(f"embed_dims: {embed_dims}")
        # logger.info(f"num_heads: {num_heads}")
        # logger.info(f"attn_drop: {attn_drop}")
    ...
    def forward(self,
        ...
        **kwargs allow passing a more general data flow when combining
        ...
        # logger.info("inside class PETRMultiheadAttention(BaseModule):")
        # logger.info("slice sn11 changes ")
        ...
        # logger.info("Calling self.attn with the following arguments:")
        # logger.info(f"query shape: {query.shape}")
        # logger.info(f"key shape: {key.shape}")
        # logger.info(f"value shape: {value.shape}")
        # logger.info(f"attn_mask shape: {attn_mask.shape if attn_mask is not None else None}")
        # logger.info(f"key_padding_mask shape: {key_padding_mask.shape if key_padding_mask is not None else None}")
       
        # logger.info(f"query : {query}")
        # logger.info(f"key : {key}")
        # logger.info(f"value : {value}")
        # logger.info(f"key_padding_mask : {key_padding_mask}")
        ...
        # logger.info("tensor saved !")
        # key_padding_mask = None
        
        # logger.info(f"key_padding_mask after setting none: {key_padding_mask}")
...
class PETRTransformerDecoder(TransformerLayerSequence):
    ...
    def forward(self, query, *args, **kwargs):
        ...
        if not self.return_intermediate:
            # logger.info("inside if not self.return_intermediate:")
        ...
        # logger.info("inside PETRTransformerDecoder fwd ")
        # logger.info("self.layers={}",self.layers)
        # logger.info("self.layers.__class__={}",self.layers.__class__)
        
        for layer in self.layers:
            query = layer(query, *args, **kwargs)
            if self.return_intermediate:
                # logger.info("inside if self.return_intermediate:")
                if self.post_norm is not None:
                    # logger.info("if self.post_norm is not None:")
                    
                    intermediate.append(self.post_norm(query))
                    # intermediate.append(query) # mr 
                    
                else:
                    intermediate.append(query)
            # logger.info("break applied")
            # logger.info("i={}",idx) # mr 
            # break
