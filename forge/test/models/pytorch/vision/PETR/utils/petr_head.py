...
class PETRHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        # logger.info("self.transformer={}",self.transformer)
        # logger.info("self.transformer.__class__={}",self.transformer.__class__)
    ...
    def position_embeding(self, img_feats, img_metas, masks=None):
        ...
        # logger.info("suspect - 1 ")
        # logger.info("coords.shape={}",coords.shape)
        # logger.info("coords={}",coords)
        # torch.save(coords,"coords.pt")
        # logger.info("coords tensor saved !")
        ...
        # logger.info("suspect - 2 ")
        # logger.info("coords3d.shape={}",coords3d.shape)
        # torch.save(coords3d,"coords3d.pt")
        # logger.info("coords3d tensor saved !")
        # logger.info("coords3d={}",coords3d)
        # logger.info("self.position_range[0]={}",self.position_range[0])
        # logger.info("self.position_range[1]={}",self.position_range[1])
        # logger.info("self.position_range[2]={}",self.position_range[2])
        # logger.info("self.position_range[3]={}",self.position_range[3])
        # logger.info("self.position_range[4]={}",self.position_range[4])
        # logger.info("self.position_range[4]={}",self.position_range[5])
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        if self.with_position:
            # logger.info("inside if self.with_position:")
            ...
            # logger.info("inside else of self.with_position:")
            if self.with_multiview:
        ...
        for lvl in range(outs_dec.shape[0]):
            ...
            # logger.info("suspect - 3 ")
            # logger.info("reference.shape={}",reference.shape)
            # logger.info("tmp.shape={}",tmp.shape)
            
            # logger.info("3rd fix applied")
        ...
        # logger.info("suspect - 4 ")
        # logger.info("all_bbox_preds.shape={}",all_bbox_preds.shape)
        # logger.info("self.pc_range[0]={}",self.pc_range[0])
        # logger.info("self.pc_range[1]={}",self.pc_range[1])
        # logger.info("self.pc_range[2]={}",self.pc_range[2])
        # logger.info("self.pc_range[3]={}",self.pc_range[3])
        # logger.info("self.pc_range[4]={}",self.pc_range[4])
        # logger.info("self.pc_range[4]={}",self.pc_range[5])
