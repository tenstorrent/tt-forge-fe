...
from common_imports import BACKBONES, NECKS, BaseModule, Linear, auto_fp16, force_fp32
from detr_head import DETRHead, FocalLoss, L1Loss
from neck import FPN
from nms_freecoder import NMSFreeCoder
from PIL import Image
from registry import BBOX_CODERS, MMCV_MODELS, Registry, build_bbox_coder
...
_ = FocalLoss, L1Loss, BBOX_CODERS, NMSFreeCoder, PerceptionTransformer, ResNet, FPN
...
class BEVFormer(MVXTwoStageDetector):
    ...
    def forward_test(self, img_metas, img=None, **kwargs):
        ...
        # new_prev_bev, bbox_results = self.simple_test(                                   #$ original
        #     img_metas[0], img[0], prev_bev=self.prev_frame_info['prev_bev'], **kwargs)
        outs = self.simple_test(img_metas[0], img[0], prev_bev=self.prev_frame_info["prev_bev"], **kwargs)
    ...
    def simple_test(self, img_metas, img=None, prev_bev=None, rescale=False):
        ...
        # return img_feats
        bbox_list = [dict() for i in range(len(img_metas))]
        outs = self.simple_test_pts(img_feats, img_metas, prev_bev, rescale=rescale)
        return outs
