...
class Add1(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "add1.weight_1", forge.Parameter(*(1024,), requires_grad=True, dev_data_format=forge.DataFormat.Float16_b)
        )
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Add1, [((1024,), torch.bfloat16)], {"model_names": ["sanity"], "pcc": 0.99, "default_df_override": "Float16_b"}),
    (
        Add0,
