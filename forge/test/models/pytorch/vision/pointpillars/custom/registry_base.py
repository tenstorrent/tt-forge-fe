...
# from custom.registry_utils import build_from_cfg
...
from typing import Any, Dict, Generator, List, Optional, Tuple, Type, Union
from custom.default_scope import DefaultScope, ManagerMixin

# from custom.base import MVXFasterRCNN
# from custom.visualiser import Det3DLocalVisualizer
    ...
    def get(self, key: str) -> Optional[Type]:
        ...
        if scope is None or scope == self._scope:
            ...
            if real_key in self._module_dict:
                obj_cls = self._module_dict[real_key]      # <function pseudo_collate at 0x7f8441d06e60>
            elif scope is None:
...
def build_from_cfg(
    ...
    from custom.HardVFE import HardVFE, PointPillarsScatter
    from custom.base import SECOND, Anchor3DHead, AlignedAnchor3DRangeGenerator, DeltaXYZWLHRBBoxCoder, FocalLoss, SmoothL1Loss, CrossEntropyLoss, FPN, ReLU
    from custom.loops import TestLoop
    from custom.nuscenes_dataset import NuScenesDataset, LoadPointsFromFile, LoadPointsFromMultiSweeps, MultiScaleFlipAug3D, GlobalRotScaleTrans, PointsRangeFilter
    from custom.sampler import DefaultSampler
    from custom.metric import NuScenesMetric
