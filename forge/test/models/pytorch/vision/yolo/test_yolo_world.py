...
@pytest.mark.nightly
def test_yolov_world(record_forge_property):
    ...
    framework_model = load_yolo_model("yolo-world","https://github.com/ultralytics/assets/releases/download/v8.2.0/yolov8s-world.pt")
