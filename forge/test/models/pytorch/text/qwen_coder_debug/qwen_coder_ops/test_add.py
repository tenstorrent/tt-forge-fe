...
class Add1(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "add1.weight_1", forge.Parameter(*(896,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Add3(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "add3.weight_1", forge.Parameter(*(128,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Add4(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("add4_const_0", shape=(35, 35), dtype=torch.float32)

    def forward(self, add_input_1):
        add_output_1 = forge.op.Add("", self.get_constant("add4_const_0"), add_input_1)
        return add_output_1
...
forge_modules_and_shapes_dtypes_list = [
    (Add0, [((1, 35, 1), torch.float32)], {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99}),
    (Add1, [((1, 35, 896), torch.float32)], {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Add2,
        [((1, 14, 35, 64), torch.float32), ((1, 14, 35, 64), torch.float32)],
        {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99},
    ),
    (Add3, [((1, 35, 128), torch.float32)], {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Add2,
    ...
    (Add4, [((1, 1, 35, 35), torch.float32)], {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Add2,
        [((1, 14, 35, 35), torch.float32), ((1, 1, 35, 35), torch.float32)],
        {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99},
    ),
    (
        Add2,
