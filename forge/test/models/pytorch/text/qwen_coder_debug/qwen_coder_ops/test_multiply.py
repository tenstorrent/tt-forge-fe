...
class Multiply1(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "multiply1.weight_0", forge.Parameter(*(896,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )

    def forward(self, multiply_input_1):
        multiply_output_1 = forge.op.Multiply("", self.get_parameter("multiply1.weight_0"), multiply_input_1)
        return multiply_output_1
...
class Multiply3(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("multiply3_const_0", shape=(1, 1, 35, 35), dtype=torch.float32)
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Multiply1, [((1, 35, 896), torch.float32)], {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Multiply0,
        [((1, 14, 35, 64), torch.float32), ((1, 1, 35, 64), torch.float32)],
        {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99},
    ),
    (Multiply2, [((1, 14, 35, 32), torch.float32)], {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Multiply0,
        [((1, 2, 35, 64), torch.float32), ((1, 1, 35, 64), torch.float32)],
        {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99},
    ),
    (Multiply2, [((1, 2, 35, 32), torch.float32)], {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99}),
    (Multiply2, [((1, 14, 35, 35), torch.float32)], {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Multiply0,
        [((1, 1, 35, 35), torch.float32), ((1, 1, 35, 35), torch.float32)],
        {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99},
    ),
    (Multiply3, [((1, 1, 35, 35), torch.float32)], {"model_names": ["pt_qwen_coder_0_5b_clm_hf"], "pcc": 0.99}),
    (
        Multiply0,
