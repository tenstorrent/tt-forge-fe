...
def test_phi_1_5_causal_lm(forge_property_recorder, variant):
...
@pytest.mark.nightly
@pytest.mark.parametrize("variant", variants)
def test_phi_1_5_token_classification(forge_property_recorder, variant):
...
@pytest.mark.nightly
@pytest.mark.parametrize("variant", variants)
def test_phi_1_5_sequence_classification(forge_property_recorder, variant):
