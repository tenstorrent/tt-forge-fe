...
def test_phi_4_causal_lm(record_forge_property, variant):
...
@pytest.mark.xfail(reason="[optimization_graph_passes]:Trying to access element outside of dimensions: 3")
@pytest.mark.parametrize("variant", variants)
def test_phi_4_token_classification(record_forge_property, variant):
...
@pytest.mark.xfail(reason="[optimization_graph_passes]:Trying to access element outside of dimensions: 3")
@pytest.mark.parametrize("variant", variants)
def test_phi_4_sequence_classification(record_forge_property, variant):
