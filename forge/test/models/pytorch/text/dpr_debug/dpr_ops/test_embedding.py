...
forge_modules_and_shapes_dtypes_list = [
    (
        Embedding0,
        [((1, 128), torch.int64)],
        {"model_names": ["pt_dpr_facebook_dpr_reader_single_nq_base_qa_hf_reader"], "pcc": 0.99, "max_int": 30521},
    ),
    (
        Embedding1,
        [((1, 128), torch.int64)],
        {"model_names": ["pt_dpr_facebook_dpr_reader_single_nq_base_qa_hf_reader"], "pcc": 0.99, "max_int": 1},
    ),
    (
        Embedding2,
        [((1, 128), torch.int64)],
        {"model_names": ["pt_dpr_facebook_dpr_reader_single_nq_base_qa_hf_reader"], "pcc": 0.99, "max_int": 511},
    ),
]
