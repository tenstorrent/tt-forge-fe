...
class Add1(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("add1_const_1", shape=(1, 1, 513, 513), dtype=torch.float32)
...
class Add3(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("add3_const_1", shape=(1, 1, 1, 61), dtype=torch.float32)
...
class Add4(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("add4_const_1", shape=(1, 6, 513, 61), dtype=torch.float32)

    def forward(self, add_input_0):
        add_output_1 = forge.op.Add("", add_input_0, self.get_constant("add4_const_1"))
        return add_output_1
...
forge_modules_and_shapes_dtypes_list = [
    (Add0, [((1, 513, 1), torch.float32)], {"model_names": ["pt_t5_google_flan_t5_small_text_gen_hf"], "pcc": 0.99}),
    (
        Add1,
    ...
    (
        Add2,
        [((1, 6, 513, 513), torch.float32), ((1, 6, 513, 513), torch.float32)],
        {"model_names": ["pt_t5_google_flan_t5_small_text_gen_hf"], "pcc": 0.99},
    ),
    (
        Add2,
    ...
    (Add0, [((1, 61, 1), torch.float32)], {"model_names": ["pt_t5_google_flan_t5_small_text_gen_hf"], "pcc": 0.99}),
    (Add3, [((1, 6, 61, 61), torch.float32)], {"model_names": ["pt_t5_google_flan_t5_small_text_gen_hf"], "pcc": 0.99}),
    (
        Add2,
