...
forge_modules_and_shapes_dtypes_list = [
    (Sqrt0, [((1, 513, 1), torch.float32)], {"model_names": ["pt_t5_google_flan_t5_small_text_gen_hf"], "pcc": 0.99}),
    (Sqrt0, [((1, 61, 1), torch.float32)], {"model_names": ["pt_t5_google_flan_t5_small_text_gen_hf"], "pcc": 0.99}),
]
