...
class Add2(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_constant("add2_const_0", shape=(128, 128), dtype=torch.float32)

    def forward(self, add_input_1):
        add_output_1 = forge.op.Add("", self.get_constant("add2_const_0"), add_input_1)
        return add_output_1
...
class Add3(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "add3.weight_1", forge.Parameter(*(8192,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
class Add4(ForgeModule):
    def __init__(self, name):
        super().__init__(name)
        self.add_parameter(
            "add4.weight_1", forge.Parameter(*(2,), requires_grad=True, dev_data_format=forge.DataFormat.Float32)
        )
...
forge_modules_and_shapes_dtypes_list = [
    ...
    (Add1, [((1, 128, 2048), torch.float32)], {"model_names": ["pt_albert_xlarge_v2_token_cls_hf"], "pcc": 0.99}),
    (
        Add0,
        [((1, 1, 128, 128), torch.float32), ((1, 1, 128, 128), torch.float32)],
        {"model_names": ["pt_albert_xlarge_v2_token_cls_hf"], "pcc": 0.99},
    ),
    (Add2, [((1, 1, 128, 128), torch.float32)], {"model_names": ["pt_albert_xlarge_v2_token_cls_hf"], "pcc": 0.99}),
    (
        Add0,
    ...
    (Add3, [((1, 128, 8192), torch.float32)], {"model_names": ["pt_albert_xlarge_v2_token_cls_hf"], "pcc": 0.99}),
    (Add4, [((1, 128, 2), torch.float32)], {"model_names": ["pt_albert_xlarge_v2_token_cls_hf"], "pcc": 0.99}),
]
