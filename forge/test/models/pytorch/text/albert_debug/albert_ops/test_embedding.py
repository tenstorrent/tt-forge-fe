...
forge_modules_and_shapes_dtypes_list = [
    (
        Embedding0,
        [((1, 128), torch.int64)],
        {"model_names": ["pt_albert_xlarge_v2_token_cls_hf"], "pcc": 0.99, "max_int": 29999},
    ),
    (
        Embedding1,
        [((1, 128), torch.int64)],
        {"model_names": ["pt_albert_xlarge_v2_token_cls_hf"], "pcc": 0.99, "max_int": 1},
    ),
    (
        Embedding2,
        [((1, 128), torch.int64)],
        {"model_names": ["pt_albert_xlarge_v2_token_cls_hf"], "pcc": 0.99, "max_int": 511},
    ),
]
