...
forge_modules_and_shapes_dtypes_list = [
    (
        Repeatinterleave0,
        [((1, 128), torch.int64)],
        {"model_names": ["pt_albert_xlarge_v2_token_cls_hf"], "pcc": 0.99, "args": {"repeats": "1", "dim": "0"}},
    ),
    (
        Repeatinterleave0,
    ...
    (
        Repeatinterleave1,
        [((1, 1, 1, 128), torch.int64)],
        {"model_names": ["pt_albert_xlarge_v2_token_cls_hf"], "pcc": 0.99, "args": {"repeats": "1", "dim": "1"}},
    ),
    (
        Repeatinterleave2,
        [((1, 1, 1, 128), torch.int64)],
        {"model_names": ["pt_albert_xlarge_v2_token_cls_hf"], "pcc": 0.99, "args": {"repeats": "128", "dim": "2"}},
    ),
]
