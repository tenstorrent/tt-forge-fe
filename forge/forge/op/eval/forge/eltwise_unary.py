...
def lower(type, attr, lc, ops, outputs):
    ...
    if type == "relu":
        ...
        if bool(int(os.environ.get("FORGE_ENABLE_TINY_TILE", "0"))) and dim == 2:
        ...
        lc.op("exp", ops, [], {"approximate_mode": "true" if "FORGE_EXP_APPROX" in os.environ else "false"})

    elif type == "reciprocal":
        lc.op("reciprocal", ops, [], {"approximate_mode": "true" if "FORGE_EXP_APPROX" in os.environ else "false"})
