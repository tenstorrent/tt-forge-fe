...
class ForgeOp:
    def __init__(
        ...
        self.cpp_op = OpAbs(self.named_attrs)

        logger.info(self.cpp_op.type())
        # logger.info(self.cpp_op.attr("Nepostojeci"))
...
class Op:
    def __init__(
        ...
        t = op_type_mapping[self.op_type]
        self.cpp_op = CppOp(op_type_mapping[self.op_type], self.named_attrs)
