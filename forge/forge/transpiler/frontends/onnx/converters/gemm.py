...
import onnx
from ....ir.operations.arithmetic import AddNode, MulNode, MatMulNode
from ....ir.operations.shape import TransposeNode
from ....ir.operations.other import FullNode, IdentityNode
from .base import OnnxOpConverter
from .validation import validate_constant_input, handle_validation_error
from .utils import torch_dtype_to_onnx_dtype
