...
def _create_avgpool1d_model(opset_version, input_shape, kernel_shape,
                             stride=1, padding=0, ceil_mode=False, count_include_pad=False,
                             auto_pad='NOTSET', dtype=onnx.TensorProto.FLOAT):
...
def _create_avgpool2d_model(opset_version, input_shape, kernel_shape,
                             stride=1, padding=0, ceil_mode=False, count_include_pad=False,
                             auto_pad='NOTSET', dtype=onnx.TensorProto.FLOAT):
...
def _create_avgpool3d_model(opset_version, input_shape, kernel_shape,
                             stride=1, padding=0, ceil_mode=False, count_include_pad=False,
                             auto_pad='NOTSET', dtype=onnx.TensorProto.FLOAT):
...
class TestAveragePool1d:
    ...
    def test_avgpool1d_ceil_mode(self, opset_version, input_shape, kernel_shape, stride, ceil_mode):
        ...
        if opset_version == 7:
            pytest.skip(f"ceil_mode attribute is not supported in AveragePool opset {opset_version}. "
    ...
    def test_avgpool1d_count_include_pad(self, opset_version, input_shape, kernel_shape,
    ...
    def test_avgpool1d_edge_cases(self, opset_version):
        ...
        for input_shape, kernel_shape, stride, padding, description in test_cases:
            ...
            assert all(comparison['matches'].values()), \
                f"{description}: Output values don't match"
...
class TestAveragePool2d:
    ...
    @pytest.mark.parametrize("padding", [1, 2, (1, 1), (2, 2)])
    @pytest.mark.parametrize("count_include_pad", [True, False])
    def test_avgpool2d_count_include_pad(self, opset_version, input_shape, kernel_shape,
                                        padding, count_include_pad):
    ...
    def test_avgpool2d_count_include_pad_with_padding(self, opset_version):
        ...
        for count_include_pad in [True, False]:
            ...
            input_data = {
                'input_0': np.random.randn(1, 1, 8, 8).astype(np.float32)
            }
...
class TestAveragePool3d:
    ...
    @pytest.mark.parametrize("count_include_pad", [True, False])
    def test_avgpool3d_count_include_pad(self, opset_version, input_shape, kernel_shape,
                                        padding, count_include_pad):
