...
class TestConv:
    ...
    @staticmethod
    def _create_conv_model(opset_version, input_shape, weight_shape, kernel_shape=None,
                          stride=1, padding=0, dilation=1, groups=1, auto_pad='NOTSET',
                          bias=True, dtype=onnx.TensorProto.FLOAT):
        """
        ...
        if auto_pad == 'VALID':
            # No padding
            output_spatial = []
            for i, (in_size, k_size, s, d) in enumerate(zip(spatial_dims, kernel_shape, 
                                                           attrs['strides'], attrs['dilations'])):
                effective_kernel = (k_size - 1) * d + 1
    ...
    @pytest.mark.parametrize("input_shape, weight_shape, kernel_shape", [
    ...
    def test_conv2d_basic(self, opset_version, input_shape, weight_shape, kernel_shape,
        ...
        # Use slightly relaxed tolerance for opset 22 due to numerical differences
        ...
        assert tir_output.shape == onnx_output.shape, \
            f"Shape mismatch: TIR {tir_output.shape} vs ONNX {onnx_output.shape}"
        assert tir_output.dtype == onnx_output.dtype, \
    ...
    def test_conv2d_auto_pad(self, opset_version, input_shape, weight_shape, kernel_shape,
                            auto_pad, stride):
    ...
    @pytest.mark.parametrize("opset_version", [1, 11, 22])
    @pytest.mark.parametrize("input_shape, weight_shape, kernel_shape, groups", [
    ...
    def test_conv2d_groups(self, opset_version, input_shape, weight_shape, kernel_shape,
    ...
    def test_conv1d_basic(self, opset_version, input_shape, weight_shape, kernel_shape,
                         stride, padding, dilation):
    ...
    def test_conv1d_auto_pad(self, opset_version, input_shape, weight_shape, kernel_shape,
                            auto_pad, stride):
    ...
    def test_conv1d_groups(self, opset_version, input_shape, weight_shape, kernel_shape,
                          groups, stride, padding):
    ...
    @pytest.mark.parametrize("input_shape, weight_shape, kernel_shape, stride, padding", [
        # Large stride cases
    ...
    def test_conv2d_edge_cases(self, opset_version, input_shape, weight_shape, kernel_shape,
                              stride, padding):
    ...
    @pytest.mark.parametrize("opset_version", [11, 22])
    @pytest.mark.parametrize("input_shape, weight_shape, kernel_shape, dilation", [
    ...
    def test_conv2d_dilation(self, opset_version, input_shape, weight_shape, kernel_shape,
    ...
    @pytest.mark.parametrize("opset_version", [11, 22])
    @pytest.mark.parametrize("input_shape, weight_shape, kernel_shape, stride, padding, dilation, groups, bias", [
        # Basic Conv3d cases
    ...
    def test_conv3d_basic(self, opset_version, input_shape, weight_shape, kernel_shape,
    ...
    @pytest.mark.parametrize("opset_version", [11, 22])
    @pytest.mark.parametrize("input_shape, weight_shape, kernel_shape, auto_pad", [
        # SAME_UPPER
    ...
    def test_conv3d_auto_pad(self, opset_version, input_shape, weight_shape, kernel_shape,
                            auto_pad, stride):
    ...
    def test_conv3d_groups(self, opset_version, input_shape, weight_shape, kernel_shape,
                          groups, stride, padding):
