...
def _create_dropout_model_v1_v6(opset_version, input_shape, ratio=0.5, is_test=0, seed=0,
...
def _create_dropout_model_v7_v10(opset_version, input_shape, ratio=0.5, seed=0,
                                  dtype=onnx.TensorProto.FLOAT):
    """
...
def _create_dropout_model_v12_plus(opset_version, input_shape, ratio=None, training_mode=None,
                                    seed=0, dtype=onnx.TensorProto.FLOAT):
    """
...
class TestDropoutV1V6:
    ...
    def test_dropout_v1_v6_basic(self, opset_version, input_shape, ratio, is_test):
        ...
        pytest.skip(f"ONNX Runtime doesn't support Dropout opset {opset_version}. "
    ...
    def test_dropout_different_shapes(self, opset_version):
        ...
        for input_shape in test_shapes:
            ...
            assert len(shape_errors) == 0, \
                f"Shape {input_shape}: Shape/execution errors: {shape_errors}"
