...
def compile_onnx_for_forge(
    ...
    json_graphs = extract_graphs(partitioned_mod, forge_params, input_names, weight_names, graph_hash="")
...
def compile_tflite_for_forge(
    ...
    json_graphs = extract_graphs(partitioned_mod, forge_params, input_names, [], graph_hash="")
...
def compile_jax_for_forge(jaxmodel, *inputs, graph_name, compiler_cfg, verify_cfg=None, forge_property_handler=None):
    ...
    json_graphs = extract_graphs(
        partitioned_mod, forge_params, flattened_input_names, weight_names, param_name_lookup, graph_hash=""
    )
