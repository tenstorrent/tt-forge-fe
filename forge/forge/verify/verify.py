...
def verify(
    ...
    if forge_property_handler is not None:
        forge_property_handler.record_execution_stage(execution_stage=ExecutionStage.FAILED_TTNN_BINARY_EXECUTION)
    co_out = compiled_model(*inputs)
    if forge_property_handler is not None:
        forge_property_handler.record_execution_stage(execution_stage=ExecutionStage.FAILED_VERIFICATION)
    ...
    if forge_property_handler is not None:
        forge_property_handler.record_execution_stage(execution_stage=ExecutionStage.PASSED)
