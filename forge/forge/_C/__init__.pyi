...
class ForgeGraphModule:
    def __init__(self, name: str, forward_graph: graph.Graph) -> None: ...
    def set_graph(self, arg0: GraphType, arg1: graph.Graph) -> None: ...

class GraphType:
    __members__: ClassVar[dict] = ...  # read-only
    Backward: ClassVar[GraphType] = ...
    Forward: ClassVar[GraphType] = ...
    Optimizer: ClassVar[GraphType] = ...
    __entries: ClassVar[dict] = ...
    def __init__(self, value: int) -> None: ...
    def __eq__(self, other: object) -> bool: ...
    def __hash__(self) -> int: ...
...
def compress_sparse_tensor_and_strip_info(arg0: list[SparseCOO], arg1: int, arg2: int) -> SparseFORGE: ...
...
def run_mlir_compiler(arg0: ForgeGraphModule) -> runtime.Binary: ...
