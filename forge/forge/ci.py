...
def enabled():
    return "FORGE_CI_DIR" in os.environ


def capture_tensors():
    return enabled() and os.environ.get("FORGE_CI_CAPTURE_TENSORS", "0") != "0"
...
def get_netlist_dir():
    ...
    base_dir = os.environ.get("FORGE_CI_DIR")
