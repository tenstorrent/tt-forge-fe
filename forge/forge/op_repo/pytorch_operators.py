...
_OPERATORS = [
    ...
    OperatorDefinition("arccos", "torch.arccos", 1),
    OperatorDefinition("acosh", "torch.acosh", 1),
    OperatorDefinition("arccosh", "torch.arccosh", 1),
    OperatorDefinition("angle", "torch.angle", 1),
    OperatorDefinition("asin", "torch.asin", 1),
    OperatorDefinition("arcsin", "torch.arcsin", 1),
    OperatorDefinition("asinh", "torch.asinh", 1),
    OperatorDefinition("arcsinh", "torch.arcsinh", 1),
    OperatorDefinition("atan", "torch.atan", 1),
    OperatorDefinition("arctan", "torch.arctan", 1),
    OperatorDefinition("atanh", "torch.atanh", 1),
    OperatorDefinition("arctanh", "torch.arctanh", 1),
