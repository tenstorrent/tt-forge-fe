...
# Are we actively tracing a graph, allows forwarding through forge modules without creating ops with unique names
g_tracing = False
...
def create_queue(mp_context = None) -> queue.Queue:
    ...
    """
    if "FORGE_FORCE_SEQUENTIAL" not in os.environ and os.environ.get("FORGE_FORCE_THREADS", "0") == "0":
