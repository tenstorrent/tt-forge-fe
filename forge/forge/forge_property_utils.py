...
class ModelArch(BaseEnum):
    ...
    PHI1 = ("phi1", "Phi 1")
    PHI15 = ("phi1.5", "Phi-1.5")
    PHI1_5 = ("phi_1_5", "Phi-1.5")
    PHI2 = ("phi2", "Phi 2")
    PHI3 = ("phi3", "Phi 3")
    PHI35 = ("phi3_5", "Phi-3.5")
    ...
    HIPPYNN = ("hippynn", "hippyn")
    MOBILENETV1 = ("mobilenetv1", "MobileNetV1")
    MOBILENET_V1 = ("mobilenet_v1", "MobileNetV1")
    ...
    SSDLITE320MOBILENETV3 = ("ssdlite320_mobilenetv3", "SSD Lite MobileNetV2")
    VGG = ("vgg", "VGG")
