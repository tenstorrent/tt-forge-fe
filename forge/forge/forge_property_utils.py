...
class Task(BaseEnum):
    NLP_TEXT_CLS = ("nlp_text_cls", "NLP Text Classification")
    NLP_TOKEN_CLS = ("nlp_token_cls", "NLP Token Classification")
    ...
    NLP_SENTENCE_SIM = ("nlp_sentence_sim", "NLP Sentence Similarity")
    NLP_TEXT_GEN = ("nlp_text_gen", "NLP Text Generation")
    NLP_FEAT_EXT = ("nlp_feat_ext", "NLP Feature Extraction")
    NLP_FILL_MASK = ("nlp_fill_mask", "NLP Fill-Mask")
    AUDIO_TTA = ("audio_tta", "Audio Text-to-Audio")
    AUDIO_ASR = ("audio_asr", "Audio Automatic Speech Recognition")
    AUDIO_TTS = ("audio_tts", "Audio Text-to-Speech")
    CV_IMAGE_CLS = ("cv_image_cls", "CV Image Classification")
    CV_IMAGE_SEG = ("cv_image_seg", "CV Image Segmentation")
    CV_OBJECT_DET = ("cv_object_det", "CV Object Detection")
    CV_DEPTH_EST = ("cv_depth_est", "CV Depth Estimation")
    CV_MASK_GEN = ("cv_mask_gen", "CV Mask Generation")
    CV_ZS_IMG_CLS = ("cv_zs_img_cls", "CV Zero-Shot Image Classification")
    CV_TTV = ("cv_ttv", "CV Text-to-Video")
    CV_TTI = ("cv_tti", "CV Text-to-Image")
    CV_ITT = ("cv_itt", "CV Image-To-Text")
    CV_IT3D = ("cv_it3d", "CV Image-to-3D")
    MM_IMAGE_TTT = ("mm_image_ttt", "MM Image-to-Text")
    TAB_TSF = ("tab_tsf", "Tabular Time Series Forecasting")
