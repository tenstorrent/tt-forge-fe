    ...
    const std::vector<tt::graphlib::NodeContext> &inputs) const
{
    switch (type_)  // clang-format off
    {
        ...
        case OpType::Maximum: return maximum::decompose_initial(old_op_type, *this, dc, inputs);
        case OpType::Minimum: return minimum::decompose_initial(old_op_type, *this, dc, inputs);
        ...
        case OpType::NotEqual: return not_equal::decompose_initial(old_op_type, *this, dc, inputs);
        ...
        case OpType::Remainder: return remainder::decompose_initial(old_op_type, *this, dc, inputs);
        ...
        case OpType::Unsqueeze: return unsqueeze::decompose_initial(old_op_type, *this, dc, inputs);
    ...
    const std::vector<tt::graphlib::NodeContext> &inputs) const
{
    switch (type_)  // clang-format off
    {
        ...
        case OpType::Maximum: return maximum::decompose_post_optimize(old_op_type, *this, dc, inputs);
        case OpType::Minimum: return minimum::decompose_post_optimize(old_op_type, *this, dc, inputs);
        case OpType::Multiply: return;
        ...
        case OpType::NotEqual: return not_equal::decompose_post_optimize(old_op_type, *this, dc, inputs);
        ...
        case OpType::Transpose: return;
        case OpType::Unsqueeze: return unsqueeze::decompose_post_optimize(old_op_type, *this, dc, inputs);
    ...
    const std::vector<tt::graphlib::NodeContext> &inputs) const
{
    switch (type_)  // clang-format off
    {
        ...
        case OpType::Maximum: return maximum::decompose_post_autograd(old_op_type, *this, dc, inputs);
        case OpType::Minimum: return minimum::decompose_post_autograd(old_op_type, *this, dc, inputs);
        ...
        case OpType::NotEqual: return not_equal::decompose_post_autograd(old_op_type, *this, dc, inputs);
        ...
        case OpType::Squeeze: return squeeze::decompose_post_autograd(old_op_type, *this, dc, inputs);
        ...
        case OpType::Transpose: return;
        case OpType::Unsqueeze: return unsqueeze::decompose_post_autograd(old_op_type, *this, dc, inputs);
    ...
    const graphlib::OpType &old_op_type, const std::vector<std::vector<std::uint32_t>> &inputs) const
{
    switch (type_)  // clang-format off
    {
        ...
        case OpType::Maximum: return maximum::initial_flops_estimate(old_op_type, *this, inputs);
        case OpType::Minimum: return minimum::initial_flops_estimate(old_op_type, *this, inputs);
        ...
        case OpType::NotEqual: return not_equal::initial_flops_estimate(old_op_type, *this, inputs);
        ...
        case OpType::Unsqueeze: return unsqueeze::initial_flops_estimate(old_op_type, *this, inputs);
