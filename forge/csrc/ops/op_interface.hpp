...
DECLARE_OP_INTERFACE(dram_queue);
...
DECLARE_OP_INTERFACE(ethernet_data_copy);
...
DECLARE_OP_INTERFACE(grouped_reduce_avg);
...
DECLARE_OP_INTERFACE(max_pool_3d);
...
DECLARE_OP_INTERFACE(resize_3d);
