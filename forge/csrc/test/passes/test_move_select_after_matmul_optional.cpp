...
struct MoveSelectAfterMatmulOptional : testing::Test
{
    ...
    MoveSelectAfterMatmulOptional()
    {
        ...
        auto vslice_0 = add_node<graphlib::PyOpNode>(
            *graph,
            "vslice_1",
            "vslice",
            {
        ...
        auto vstack_0 = add_node<graphlib::PyOpNode>(
            *graph,
            "vstack_0",
            "vstack",
            {
...
{
    setenv("FORGE_MANUAL_SPLICE_DECOMP_TH", "158", 1 /* overwrite */);
    ...
    unsetenv("FORGE_MANUAL_SPLICE_DECOMP_TH");
}
...
TEST_F(MoveSelectAfterMatmulOptional, test_move_select_after_matmul_3)
{
    ...
    std::vector<graphlib::OpType::Attr> new_vstack_attr = {
        64,
    };
