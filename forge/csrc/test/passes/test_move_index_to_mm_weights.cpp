...
struct Gpt2Split : testing::Test
{
    ...
    Gpt2Split()
    {
        ...
        // Graph definition
        auto weight =
            create_input(*graph, "weight", graphlib::Shape::create({768, 2304}), graphlib::InputNodeType::Parameter);
...
struct Fuyu8bSplit : testing::Test
{
    ...
    Fuyu8bSplit()
    {
        ...
        // Graph definition
        auto weight =
            create_input(*graph, "weight", graphlib::Shape::create({12288, 4096}), graphlib::InputNodeType::Parameter);
        auto bias = create_input(*graph, "bias", graphlib::Shape::create({12288}), graphlib::InputNodeType::Parameter);
        auto in_1 =
            create_input(*graph, "in_1", graphlib::Shape::create({1, 32, 4096}), graphlib::InputNodeType::Activation);
        auto in_2 =
            create_input(*graph, "in_2", graphlib::Shape::create({1, 416, 4096}), graphlib::InputNodeType::Activation);
