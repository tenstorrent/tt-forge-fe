...
struct UpdateReshapeNamedAttrsTest : testing::Test
{
    ...
    UpdateReshapeNamedAttrsTest()
    {
        ...
        auto reshape_node = add_node<graphlib::PyOpNode>(
            *graph, "reshape", graphlib::OpType("reshape", {{"shape", std::vector{1, 1, 512 * 160}}}), {input_node});
...
struct EraseInverseOpsSqueezeAndUnsqueeze : testing::Test
{
    ...
    EraseInverseOpsSqueezeAndUnsqueeze()
    {
        ...
        auto cast_1_node = add_node<graphlib::PyOpNode>(
            *graph, "cast", graphlib::OpType("cast", {{"dtype", static_cast<int>(DataFormat::Float32)}}), {mask_node});
        auto unsqueeze_node = add_node<graphlib::PyOpNode>(
            *graph, "unsqueeze", graphlib::OpType("unsqueeze", {{"dim", 0}}), {weights_node});
        ...
        squeeze_node =
            add_node<graphlib::PyOpNode>(*graph, "squeeze", graphlib::OpType("squeeze", {{"dim", 0}}), {maximum_node});
