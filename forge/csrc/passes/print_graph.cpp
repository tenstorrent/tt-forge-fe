...
{
    auto stage_to_print = env_as_optional<std::string>("FORGE_PRINT_GRAPH_AT");
...
{
    auto print_bw_graph = env_as_optional<std::string>("FORGE_PRINT_GRAPH_VIZ_FORMAT_DIR");
...
{
    auto stage_to_print = env_as_optional<std::string>("FORGE_PRINT_GRAPH_VIZ_FORMAT_AT");
    if (not stage_to_print or ((stage_to_print != stage) and (stage_to_print != "ALL")))
        return;
    std::cout << "Graph at: " << stage << std::endl;
...
{
    auto regular_print = env_as_optional<std::string>("FORGE_PRINT_GRAPH_AT");
    auto graph_viz_format = env_as_optional<std::string>("FORGE_PRINT_GRAPH_VIZ_FORMAT_AT");
