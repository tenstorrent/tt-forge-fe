...
PYBUDA_CSRC_LDFLAGS = -Wl,-z,origin -Wl,-rpath,\$$ORIGIN/../python_env/lib/$(PYTHON_VERSION)/site-packages/torch/lib -Wl,-rpath,\$$ORIGIN/../budabackend/build/lib -lstdc++fs -lboost_serialization -ltorch -ltorch_cpu -lc10 -ltorch_python -lnet2pipe_tile_maps
