...
<table border="2">
	...
	<tbody>
		<tr>
			<td rowspan="14">1</td>
			<td rowspan="14">[FORGE][lower_to_mlir] RuntimeError Found Unsupported operations while lowering from TTForge to TTIR in forward graph Unsupported Ops: conv2d_transpose</td>
			<td rowspan="14">14</td>
			<td>1</td>
