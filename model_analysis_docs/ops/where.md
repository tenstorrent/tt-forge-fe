...
<table border="2">
	...
	<tbody>
		<tr>
			<td rowspan="22">1</td>
			<td rowspan="22">[TT_METAL][TT-Metal vs Forge Output Data mismatch] ValueError Data mismatch -> AutomaticValueChecker (compare_with_golden): framework_model , compiled_model</td>
			<td rowspan="22">92</td>
			<td>6</td>
