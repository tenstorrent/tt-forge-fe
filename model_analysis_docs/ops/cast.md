...
<table border="2">
	...
	<tbody>
		<tr>
			<td rowspan="25">1</td>
			<td rowspan="25">[UNKNOWN] The failure does not match any known compiler component exception rules. Please review the failure log to identify the component</td>
			<td rowspan="25">45</td>
			<td>6</td>
		...
		<tr>
			<td>2</td>
			<td><ul><li>pt_roberta_xlm_roberta_base_mlm_hf</li><li>pt_distilbert_distilbert_base_uncased_mlm_hf</li></ul></td>
