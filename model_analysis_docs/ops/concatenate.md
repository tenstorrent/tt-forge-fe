...
<table border="2">
	...
	<tbody>
		<tr>
			<td rowspan="620">1</td>
			<td rowspan="620">[UNKNOWN] The failure does not match any known compiler component exception rules. Please review the failure log to identify the component</td>
			<td rowspan="620">1107</td>
			<td>7</td>
			<td><ul><li>pt_dla_dla60_visual_bb_torchvision</li><li>pt_dla_dla60x_visual_bb_torchvision</li><li>pt_mobilnetv2_google_deeplabv3_mobilenet_v2_1_0_513_img_cls_hf</li><li>pt_dla_dla102x_visual_bb_torchvision</li><li>pt_dla_dla102_visual_bb_torchvision</li><li>pt_dla_dla169_visual_bb_torchvision</li><li>pt_dla_dla102x2_visual_bb_torchvision</li></ul></td>
		...
		<tr>
			<td>3</td>
			<td><ul><li>pt_densenet_densenet169_img_cls_torchvision</li><li>pt_densenet_densenet121_img_cls_torchvision</li><li>pt_densenet_densenet201_img_cls_torchvision</li></ul></td>
		...
		<tr>
			<td>2</td>
			<td><ul><li>pt_dla_dla46x_c_visual_bb_torchvision</li><li>pt_dla_dla46_c_visual_bb_torchvision</li></ul></td>
