...
<table border="2">
	...
	<tbody>
		<tr>
			<td rowspan="119">1</td>
			<td rowspan="119">[UNKNOWN] The failure does not match any known compiler component exception rules. Please review the failure log to identify the component</td>
			<td rowspan="119">254</td>
			<td>20</td>
