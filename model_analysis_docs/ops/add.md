...
<table border="2">
	...
	<tbody>
		<tr>
			<td rowspan="93">1</td>
			<td rowspan="93">[TT_METAL][TT-Metal vs Forge Output Data mismatch] ValueError Data mismatch -> AutomaticValueChecker (compare_with_golden): framework_model , compiled_model</td>
			<td rowspan="93">439</td>
			<td>9</td>
