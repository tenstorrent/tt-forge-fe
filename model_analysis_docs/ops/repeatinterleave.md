...
<table border="2">
	...
	<tbody>
		<tr>
			<td rowspan="83">1</td>
			<td rowspan="83">[UNKNOWN] The failure does not match any known compiler component exception rules. Please review the failure log to identify the component</td>
			<td rowspan="83">285</td>
			<td>29</td>
		...
		<tr>
			<td>4</td>
			<td><ul><li>pt_perceiverio_deepmind_vision_perceiver_fourier_img_cls_hf</li><li>pt_llava_llava_hf_llava_1_5_7b_hf_cond_gen_hf</li><li>pt_perceiverio_deepmind_vision_perceiver_conv_img_cls_hf</li><li>pt_perceiverio_deepmind_vision_perceiver_learned_img_cls_hf</li></ul></td>
